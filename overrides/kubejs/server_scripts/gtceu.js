...
ServerEvents.recipes((event) => {
    ...
    //event.shapeless("gtlcecore:cfg_copy", "minecraft:writable_book")
    event.shapeless("gtlcecore:advanced_multi_smelter", "gtceu:multi_smelter")
    event.shapeless("gtlcecore:suprachronal_assembly_line_module", "gtlcecore:suprachronal_assembly_line")
    event.shapeless("gtlcecore:suprachronal_assembly_line", "gtlcecore:suprachronal_assembly_line_module")
    ...
    event.shaped(Registries.getItemStack("gtlcecore:primitive_robot_arm", 64), [
        "AAA",
        "BEB",
        "CDE"
    ], {
        ...
        B: "gtceu:bronze_gear",
        C: "gtlcecore:precision_steam_mechanism",
    ...
    event.shaped("gtmthings:creative_laser_hatch", [
        ...
        B: "gtlcecore:chaotic_energy_core",
        C: "gtmthings:max_4194304a_wireless_laser_target_hatch"
    })

    event.shaped("gtlcecore:large_steam_input_hatch", [
        "ACA",
        "BDB",
        "ACA"
    ], {
        A: "gtlcecore:precision_steam_mechanism",
        B: "gtceu:stainless_steel_tiny_fluid_pipe",
        C: "gtceu:iron_rotor",
        D: "gtceu:steam_input_hatch"
    })

    event.shaped("gtlcecore:reactor_core", [
        "ACA",
        "CDC",
        "ACA"
    ], {
    ...
    event.shaped("minecraft:heart_of_the_sea", [
        ...
        C: "gtlcecore:glacio_spirit",
        D: "gtlcecore:pellet_antimatter"
    })

    event.shaped("gtlcecore:large_rock_crusher", [
        "ABA",
        "CDC",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:incubator", [
        "ABA",
        "CDC",
        "ABA"
    ], {
        ...
        D: "gtlcecore:greenhouse"
    })

    event.shaped("gtlcecore:block_conversion_room", [
        "ABA",
        "BDB",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:lava_furnace", [
        "ABA",
        "CDC",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:mega_alloy_blast_smelter", [
        "AFA",
        "CDC",
        "EBE"
    ], {
    ...
    event.shaped("gtceu:hv_solar_panel", [
        ...
        A: "gtlcecore:rutherfordium_neutronium_wafer",
        B: "gtceu:laminated_glass",
    ...
    event.shaped("gtlcecore:max_neutron_compressor", [
        "ECE",
        "DAD",
        "BCB"
    ], {
        ...
        C: "#gtceu:circuits/max",
        D: "gtlcecore:max_electric_piston",
        E: "gtlcecore:max_electric_pump"
    })

    event.shaped("gtlcecore:uhv_parallel_hatch", [
        "DCE",
        "CAC",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:uev_parallel_hatch", [
        "DCE",
        "CAC",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:uiv_parallel_hatch", [
        "DCE",
        "CAC",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:uxv_parallel_hatch", [
        "DCE",
        "CAC",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:opv_parallel_hatch", [
        "DCE",
        "CAC",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:max_parallel_hatch", [
        "DCE",
        "CAC",
        "BCB"
    ], {
        ...
        C: "gtlcecore:suprachronal_max",
        D: "gtlcecore:max_sensor",
        E: "gtlcecore:max_emitter"
    })

    event.shaped("gtlcecore:sterile_cleaning_maintenance_hatch", [
        "DED",
        "CAC",
        "DED"
    ], {
    ...
    event.shaped("gtlcecore:law_cleaning_maintenance_hatch", [
        "DED",
        "CAC",
        "DED"
    ], {
        ...
        D: "gtlcecore:law_filter_casing",
        E: "gtlcecore:sterile_cleaning_maintenance_hatch"
    })

    event.shaped("gtlcecore:cleaning_configuration_maintenance_hatch", [
        "DCD",
        "CAC",
        "DCD"
    ], {
        A: "gtlcecore:auto_configuration_maintenance_hatch",
        C: "#gtceu:circuits/luv",
        D: "gtceu:cleaning_maintenance_hatch"
    })

    event.shaped("gtlcecore:sterile_configuration_cleaning_maintenance_hatch", [
        "DCD",
        "BAB",
        "DCD"
    ], {
        ...
        C: "gtlcecore:cleaning_configuration_maintenance_hatch",
        D: "gtlcecore:sterile_cleaning_maintenance_hatch"
    })

    event.shaped("gtlcecore:law_configuration_cleaning_maintenance_hatch", [
        "DCD",
        "BAB",
        "DCD"
    ], {
        ...
        C: "gtlcecore:sterile_configuration_cleaning_maintenance_hatch",
        D: "gtlcecore:law_cleaning_maintenance_hatch"
    })

    event.shaped("gtlcecore:dragon_egg_copier", [
        "DED",
        "CAC",
        "DED"
    ], {
        ...
        D: "gtlcecore:dragon_strength_tritanium_casing",
        E: "gtceu:uxv_field_generator"
    })

    event.shaped("gtlcecore:blaze_blast_furnace", [
        "DCD",
        "CAC",
        "DCD"
    ], {
        ...
        D: "gtlcecore:blaze_blast_furnace_casing"
    })

    event.shaped("gtlcecore:large_cracker", [
        "DCD",
        "BAB",
        "DCD"
    ], {
    ...
    event.shaped("gtlcecore:large_greenhouse", [
        "DCD",
        "BAB",
        "DCD"
    ], {
        A: "gtlcecore:greenhouse",
        B: "gtceu:ev_sensor",
        C: "#gtceu:circuits/luv",
        D: "gtceu:ev_field_generator"
    })

    event.shaped("gtlcecore:law_filter_casing", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:cold_ice_freezer", [
        "BCB",
        "CAC",
        "BCB"
    ], {
        A: "gtceu:vacuum_freezer",
        B: "gtlcecore:cold_ice_casing",
        C: "gtceu:iv_emitter"
    })

    event.shaped("gtlcecore:gravitation_shockburst", [
        "BCB",
        "CAC",
        "BCB"
    ], {
        A: "gtlcecore:create_ultimate_battery",
        B: "gtlcecore:create_casing",
        C: "gtlcecore:suprachronal_mainframe_complex"
    })
    ...
    event.shaped(Registries.getItemStack("gtlcecore:multi_functional_casing", 2), [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:processing_plant", [
        "BCB",
        "DAD",
        "BEB"
    ], {
        A: "gtlcecore:multi_functional_casing",
    ...
    event.shaped("gtlcecore:steam_piston_hammer", [
        "BCB",
        "DAD",
        "BEB"
    ], {
    ...
    event.shaped("gtlcecore:steam_pressor", [
        "BCB",
        "DAD",
        "BEB"
    ], {
    ...
    event.shaped("gtlcecore:steam_foundry", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    // event.shaped("gtlcecore:assemble_plant", [
    //     "BCB",
    //     "DAF",
    //     "BEB"
    // ], {
    ...
    // event.shaped("gtlcecore:separated_plant", [
    //     "BCB",
    //     "DAF",
    //     "BEB"
    // ], {
    ...
    // event.shaped("gtlcecore:mixed_plant", [
    //     "BCB",
    //     "DAF",
    //     "BEB"
    // ], {
    ...
    event.shaped("gtlcecore:ev_rocket_engine", [
        "BCB",
        "DAD",
        "WEW"
    ], {
    ...
    event.shaped("gtlcecore:iv_rocket_engine", [
        "BCB",
        "DAD",
        "WEW"
    ], {
    ...
    event.shaped("gtlcecore:luv_rocket_engine", [
        "BCB",
        "DAD",
        "WEW"
    ], {
    ...
    event.shaped("gtlcecore:rocket_large_turbine", [
        "BCB",
        "DAD",
        "WPW"
    ], {
        A: "gtlcecore:ev_rocket_engine",
    ...
    event.shaped("gtlcecore:iv_naquadah_reactor", [
        "BCB",
        "DAD",
        "WCW"
    ], {
    ...
    event.shaped("gtlcecore:luv_naquadah_reactor", [
        "BCB",
        "DAD",
        "WCW"
    ], {
    ...
    event.shaped("gtlcecore:zpm_naquadah_reactor", [
        "BCB",
        "DAD",
        "WCW"
    ], {
    ...
    event.shaped("gtlcecore:large_steam_macerator", [
        "BCB",
        "DAD",
        "BCB"
    ], {
        ...
        D: "gtlcecore:precision_steam_mechanism"
    })

    event.shaped("gtlcecore:large_steam_centrifuge", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:large_steam_bath", [
        "ECE",
        "DAD",
        "BCB"
    ], {
        A: "gtlcecore:steam_bath",
        B: "gtceu:bronze_block",
        C: "gtlcecore:precision_steam_mechanism",
        D: "gtceu:stone_gear",
        E: "gtceu:steel_foil"
    ...
    event.shaped("gtlcecore:large_steam_circuit_assembler", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:large_steam_mixer", [
        "BCB",
        "DAD",
        "BCB"
    ], {
        A: "gtlcecore:steam_mixer",
        B: "gtceu:bronze_plate",
        C: "gtlcecore:precision_steam_mechanism",
        D: "gtceu:copper_huge_fluid_pipe"
    })

    event.shaped("gtlcecore:large_steam_thermal_centrifuge", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:large_steam_ore_washer", [
        "BCB",
        "DAD",
        "BCB"
    ], {
        A: "gtlcecore:steam_ore_washer",
        B: "gtceu:bronze_plate",
        C: "gtceu:double_bronze_plate",
        D: "gtlcecore:precision_steam_mechanism"
    })

    event.shaped("gtlcecore:steam_mixer", [
        "ABA",
        "BCB",
        "DBD"
    ], {
    ...
    event.shaped("gtlcecore:steam_bath", [
        "ABA",
        "BCB",
        "DBD"
    ], {
    ...
    event.shaped("gtlcecore:steam_ore_washer", [
        "ABA",
        "BCB",
        "DBD"
    ], {
    ...
    event.shaped("gtlcecore:weather_control", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:large_pyrolyse_oven", [
        "BCB",
        "DAD",
        "BCB"
    ], {
    ...
    event.shaped("gtlcecore:precision_steam_mechanism", [
        "ABA",
        "CDC",
        "EBE"
    ], {
    ...
    event.shaped("gtlcecore:steam_assembly_block", [
        "ABA",
        "BCB",
        "ABA"
    ], {
        A: "gtceu:bronze_normal_fluid_pipe",
        B: "gtlcecore:precision_steam_mechanism",
        C: "gtceu:bronze_frame"
    })

    event.shaped("gtlcecore:ev_lightning_rod", [
        "ABA",
        "BCB",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:iv_lightning_rod", [
        "ABA",
        "BCB",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:luv_lightning_rod", [
        "ABA",
        "BCB",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:lv_semi_fluid", [
        "ADA",
        "BEB",
        "CFC"
    ], {
    ...
    event.shaped("gtlcecore:mv_semi_fluid", [
        "ADA",
        "BEB",
        "CFC"
    ], {
    ...
    event.shaped("gtlcecore:hv_semi_fluid", [
        "ADA",
        "BEB",
        "CFC"
    ], {
    ...
    event.shaped("gtlcecore:large_semi_fluid_generator", [
        "ADA",
        "BEB",
        "CFC"
    ], {
    ...
    event.shaped("gtlcecore:gravity_hatch", [
        "CBC",
        "BAB",
        "DBD"
    ], {
    ...
    event.shaped("gtlcecore:desulfurizer", [
        "AEA",
        "CDC",
        "AEA",
    ], {
    ...
    event.smithing("gtlcecore:create_hpca_component", "gtlcecore:command_block_core", "gtlcecore:super_computation_component", "gtlcecore:suprachronal_mainframe_complex")
    event.smithing("gtlcecore:create_computation", "gtlcecore:command_block_core", "gtceu:high_performance_computation_array", "gtlcecore:suprachronal_mainframe_complex")
    // event.smithing("gtlcecore:space_fermium_helmet", "ad_astra:netherite_space_helmet", "gtlcecore:fermium_helmet", "ad_astra:oxygen_distributor")
    // event.smithing("gtlcecore:space_fermium_chestplate", "ad_astra:netherite_space_suit", "gtlcecore:fermium_chestplate", "ad_astra:oxygen_distributor")
    // event.smithing("gtlcecore:space_fermium_leggings", "ad_astra:netherite_space_pants", "gtlcecore:fermium_leggings", "ad_astra:oxygen_distributor")
    // event.smithing("gtlcecore:space_fermium_boots", "ad_astra:netherite_space_boots", "gtlcecore:fermium_boots", "ad_astra:oxygen_distributor")
    ...
    gtr.mixer("gtlcecore:vibrant_alloy_dust")
        .itemInputs("#forge:dusts/energetic_alloy", "#forge:dusts/ender_pearl")
        .itemOutputs("2x gtceu:vibrant_alloy_dust")
        .duration(260)
        .EUt(30)

    gtr.mixer("gtlcecore:energetic_alloy_dust")
        .itemInputs("2x #forge:dusts/gold", "#forge:dusts/redstone", "#forge:dusts/glowstone")
        .itemOutputs("4x gtceu:energetic_alloy_dust")
        .duration(140)
        .EUt(30)

    gtr.circuit_assembler("gtlcecore:basic_control_circuit")
        .notConsumable("gtceu:vacuum_tube")
        .itemInputs("gtceu:steel_plate", "minecraft:redstone")
        .itemOutputs("2x gtlcecore:basic_control_circuit")
        .inputFluids("gtceu:glue 20")
        .duration(40)
        .EUt(7)

    gtr.circuit_assembler("gtlcecore:advanced_control_circuit")
        .notConsumable("gtceu:basic_electronic_circuit")
        .itemInputs("gtlcecore:basic_control_circuit", "gtceu:iron_plate", "gtceu:red_alloy_dust")
        .itemOutputs("2x gtlcecore:advanced_control_circuit")
        .inputFluids("gtceu:glue 20")
        .duration(80)
        .EUt(16)

    gtr.circuit_assembler("gtlcecore:elite_control_circuit")
        .notConsumable("gtceu:good_electronic_circuit")
        .itemInputs("minecraft:paper", "2x gtlcecore:advanced_control_circuit", "gtceu:wrought_iron_plate", "gtceu:small_diamond_dust")
        .itemOutputs("2x gtlcecore:elite_control_circuit")
        .inputFluids("gtceu:glue 20")
        .duration(160)
        .EUt(30)

    gtr.circuit_assembler("gtlcecore:ultimate_control_circuit")
        .notConsumable("gtceu:advanced_integrated_circuit")
        .itemInputs("gtceu:resin_printed_circuit_board", "gtlcecore:elite_control_circuit", "gtceu:steel_plate", "gtceu:small_obsidian_dust", "2x gtceu:red_alloy_screw")
        .itemOutputs("gtlcecore:ultimate_control_circuit")
        .inputFluids("gtceu:glue 20")
        .duration(80)
        .EUt(120)

    gtr.circuit_assembler("gtlcecore:ultima_control_circuit")
        .itemInputs("gtceu:phenolic_printed_circuit_board", "4x gtlcecore:ultimate_control_circuit", "8x gtceu:red_alloy_foil")
        .itemOutputs("4x gtlcecore:ultima_control_circuit")
        .EUt(480)
        .duration(200)

    const machine_materialas = [
        ["uhv", "europium", "1966080", "uv", "128", "gtlcecore:nm_chip"],
        ["uev", "mithril", "7864320", "uhv", "256", "gtlcecore:nm_chip"],
        ["uiv", "neutronium", "31457280", "uev", "512", "gtlcecore:pm_chip"],
        ["uxv", "taranium", "125829120", "uiv", "1024", "gtlcecore:pm_chip"],
        ["opv", "crystalmatrix", "503316480", "uxv", "2048", "gtlcecore:fm_chip"],
        ["max", "cosmicneutronium", "503316480", "opv", "4096", "gtlcecore:fm_chip"]
    ]
    machine_materialas.forEach((machine_material) => {
        gtr.assembly_line("gtceu:" + machine_material[0] + "_energy_input_hatch")
            .itemInputs("gtceu:" + machine_material[0] + "_machine_hull",
                ...
                "2x gtlcecore:" + machine_material[0] + "_voltage_coil")
    ...
    gtr.assembly_line("gtlcecore:magic_manufacturer")
        ...
        .itemOutputs("gtlcecore:magic_manufacturer")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:magic_core"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:draconic_energy_core")
        .itemInputs("gtlcecore:wyvern_energy_core",
            "64x gtceu:uv_lapotronic_battery",
            "16x gtlcecore:awakened_core",
            "16x gtlcecore:dragon_stabilizer_core",
            "8x #gtceu:circuits/opv",
            "gtceu:uv_solar_panel",
            "64x gtlcecore:smd_capacitor_cosmic",
            "64x gtlcecore:smd_diode_cosmic",
            "64x gtlcecore:smd_resistor_cosmic",
            "64x gtlcecore:smd_transistor_cosmic",
            "64x gtlcecore:smd_inductor_cosmic",
        ...
        .itemOutputs("gtlcecore:draconic_energy_core")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(2400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:wyvern_energy_core"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.OpV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:super_computation")
        .itemInputs("16x gtceu:data_bank",
            ...
            "64x gtlcecore:optical_processing_core",
            "64x gtlcecore:high_precision_crystal_soc",
            "64x gtceu:enderite_quadruple_wire",
            "64x gtceu:normal_optical_pipe")
        .inputFluids("gtceu:mutated_living_solder 2880", "gtceu:vanadium_gallium 2880", "gtceu:pcb_coolant 16000", "gtlcecore:gelid_cryotheum 16000")
        .itemOutputs("gtlcecore:super_computation")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(600)
    ...
    gtr.assembly_line("gtlcecore:super_computation_component")
        .itemInputs("gtceu:hpca_advanced_computation_component",
            ...
            "gtceu:data_orb",
            "gtlcecore:high_precision_crystal_soc",
            "4x gtceu:normal_optical_pipe")
        .inputFluids("gtceu:soldering_alloy 576", "gtceu:vanadium_gallium 576", "gtceu:pcb_coolant 1000", "gtlcecore:gelid_cryotheum 1000")
        .itemOutputs("gtlcecore:super_computation_component")
    ...
    gtr.assembly_line("gtlcecore:large_chemical_plant")
        ...
        .itemOutputs("gtlcecore:large_chemical_plant")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:chemical_plant"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(64))

    gtr.assembly_line("gtlcecore:super_blast_smelter")
        .itemInputs("64x gtceu:tungsten_carbide_frame",
            "64x gtceu:mega_blast_furnace",
            "64x gtlcecore:mega_alloy_blast_smelter",
            "64x gtceu:uv_field_generator",
        ...
        .itemOutputs("gtlcecore:super_blast_smelter")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(1200)
    ...
    gtr.assembly_line("gtlcecore:super_cooler_component")
        ...
        .inputFluids("gtceu:soldering_alloy 576", "gtceu:vanadium_gallium 576", "gtceu:pcb_coolant 1000", "gtlcecore:gelid_cryotheum 1000")
        .itemOutputs("gtlcecore:super_cooler_component")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
    ...
    gtr.assembly_line("gtlcecore:sps_crafting")
        .itemInputs("8x gtceu:double_americium_plate",
            ...
            "gtlcecore:pellet_antimatter",
            "gtlcecore:rydberg_spinorial_assembly",
        ...
        .itemOutputs("gtlcecore:sps_crafting")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:pellet_antimatter"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:advanced_sps_crafting")
        .itemInputs("4x gtceu:uiv_emitter",
            "4x gtceu:uiv_sensor",
            "4x gtlcecore:rydberg_spinorial_assembly",
            "16x gtlcecore:pellet_antimatter",
        ...
        .itemOutputs("gtlcecore:advanced_sps_crafting")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:sps_crafting"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:mass_fabricator")
        ...
        .itemOutputs("gtlcecore:mass_fabricator")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:matter_fabricator"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:matter_fabricator")
        ...
        .itemOutputs("gtlcecore:matter_fabricator")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:large_recycler"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:assembler_module")
        .itemInputs("4x gtlcecore:advanced_assembly_line_unit",
            "4x gtceu:uv_emitter",
            "4x gtceu:uv_sensor",
        ...
        .itemOutputs("gtlcecore:assembler_module")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:advanced_assembly_line"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:resource_collection")
        .itemInputs("gtlcecore:large_void_miner",
            "gtlcecore:void_fluid_drilling_rig",
            "4x gtceu:uv_robot_arm",
            ...
            "8x gtceu:double_pikyonium_plate")
        .inputFluids("gtceu:soldering_alloy 2880", "gtceu:artherium_sn 2880")
        .itemOutputs("gtlcecore:resource_collection")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1200)
    ...
    gtr.assembly_line("gtlcecore:power_module")
        ...
        .itemOutputs("gtlcecore:power_module")
    ...
    gtr.assembly_line("gtlcecore:power_module_2")
        .itemInputs("gtlcecore:power_module", "2x gtceu:luv_field_generator", "4x gtceu:zpm_conveyor_module", "gtceu:uhv_electric_motor", "2x gtceu:small_neutronium_gear", "6x gtceu:double_fluxed_electrum_plate")
        .inputFluids("gtceu:indalloy_140 864", "gtceu:soldering_alloy 1152", "gtceu:berkelium 1152", "gtceu:lubricant 2304")
        .itemOutputs("gtlcecore:power_module_2")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:power_module"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.ZPM])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:power_module_3")
        .itemInputs("gtlcecore:power_module_2", "2x gtceu:zpm_field_generator", "4x gtceu:uv_conveyor_module", "gtceu:uev_electric_motor", "2x gtceu:small_quantanium_gear", "6x gtceu:double_titansteel_plate")
        .inputFluids("gtceu:indalloy_140 864", "gtceu:soldering_alloy 1152", "gtceu:californium 1152", "gtceu:lubricant 2304")
        .itemOutputs("gtlcecore:power_module_3")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:power_module_2"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:power_module_4")
        .itemInputs("gtlcecore:power_module_3", "2x gtceu:uv_field_generator", "4x gtceu:uhv_conveyor_module", "gtceu:uiv_electric_motor", "2x gtceu:small_infuscolium_gear", "6x gtceu:double_uruium_plate")
        .inputFluids("gtceu:indalloy_140 864", "gtceu:soldering_alloy 1152", "gtceu:fermium 1152", "gtceu:lubricant 2304")
        .itemOutputs("gtlcecore:power_module_4")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:power_module_3"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:power_module_5")
        .itemInputs("gtlcecore:power_module_4", "2x gtceu:uhv_field_generator", "4x gtceu:uev_conveyor_module", "gtceu:uxv_electric_motor", "gtceu:small_vibramantium_gear", "6x gtceu:double_celestialtungsten_plate")
        .inputFluids("gtceu:indalloy_140 864", "gtceu:soldering_alloy 1152", "gtceu:mendelevium 1152", "gtceu:lubricant 2304")
        .itemOutputs("gtlcecore:power_module_5")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:power_module_4"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:stellar_forge")
        .itemInputs("4x gtlcecore:stellar_containment_casing",
        ...
        .itemOutputs("gtlcecore:stellar_forge")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:stellar_containment_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:plasma_condenser")
        ...
        .itemOutputs("gtlcecore:plasma_condenser")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(300)
    ...
    gtr.assembly_line("gtlcecore:void_fluid_drilling_rig")
        ...
        .itemOutputs("gtlcecore:void_fluid_drilling_rig")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(600)
    ...
    gtr.assembly_line("gtlcecore:large_void_miner")
        ...
        .itemOutputs("gtlcecore:large_void_miner")
        .inputFluids("gtceu:soldering_alloy 5760", "gtceu:fall_king 5760", "gtceu:energetic_alloy 5760", "gtceu:tanmolyium 5760")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:void_miner"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.ZPM])
            .CWUt(64))

    gtr.assembly_line("gtlcecore:annihilate_generator")
        .itemInputs("gtlcecore:graviton_field_constraint_casing",
            "4x gtceu:uxv_emitter",
            "4x gtceu:uxv_sensor",
            "4x #gtceu:circuits/opv",
            "16x gtceu:uxv_field_generator",
            "4x gtlcecore:rydberg_spinorial_assembly",
            "16x gtlcecore:uxv_voltage_coil",
            "gtlcecore:insanely_max_battery",
            "8x gtceu:double_draconium_plate",
            "8x gtceu:double_legendarium_plate")
        .itemOutputs("gtlcecore:annihilate_generator")
        ...
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(1800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:annihilation_constrainer"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(4096))

    gtr.assembly_line("gtlcecore:suprachronal_mainframe_complex")
        .itemInputs("2x gtceu:eternity_frame",
            "gtlcecore:chaotic_core",
            ...
            "gtlcecore:bioware_mainframe",
            "gtlcecore:optical_mainframe",
            "gtlcecore:exotic_mainframe",
            "gtlcecore:cosmic_mainframe",
            "gtlcecore:supracausal_mainframe",
            "gtlcecore:eternity_catalyst",
            "16x gtlcecore:nuclear_star",
            "16x gtceu:eternity_foil",
            "4x gtceu:eternity_plate")
        .itemOutputs("gtlcecore:suprachronal_mainframe_complex")
        ...
        .duration(8000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:suprachronal_max"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
    ...
    gtr.assembly_line("gtlcecore:chemical_plant")
        ...
        .itemOutputs("gtlcecore:chemical_plant")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(600)
    ...
    gtr.assembly_line("gtlcecore:iridium_casing")
        ...
        .itemOutputs("2x gtlcecore:iridium_casing")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(200)
    ...
    gtr.assembly_line("gtlcecore:hyper_reactor")
        .itemInputs("64x gtceu:uhpic_chip",
            "64x gtlcecore:nm_chip",
            "4x #gtceu:circuits/uev",
        ...
        .itemOutputs("gtlcecore:hyper_reactor")
        .EUt(2000000)
        .duration(500)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:large_naquadah_reactor"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:advanced_hyper_reactor")
        .itemInputs("64x gtlcecore:nm_chip",
            "64x gtlcecore:pm_chip",
            "4x #gtceu:circuits/uxv",
            ...
            "gtlcecore:transcendent_max_battery")
        .inputFluids("gtceu:tairitsu 2304", "gtceu:soldering_alloy 1296", "gtceu:indalloy_140 1296", "gtceu:super_mutated_living_solder 864")
        .itemOutputs("gtlcecore:advanced_hyper_reactor")
        .EUt(32000000)
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:hyper_reactor"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:really_max_battery")
        .itemInputs("16x gtceu:double_neutronium_plate",
            "16x #gtceu:circuits/uev",
            "gtceu:max_battery",
            "8x gtlcecore:bioware_processing_core",
            "64x gtlcecore:nm_wafer",
            "64x gtlcecore:nm_wafer",
            "64x gtlcecore:smd_diode_bioware",
            "64x gtlcecore:smd_capacitor_bioware",
            "64x gtlcecore:smd_resistor_bioware",
            "64x gtlcecore:smd_transistor_bioware",
            "64x gtlcecore:smd_inductor_bioware",
        ...
        .itemOutputs("gtlcecore:really_max_battery")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(2400)
    ...
    gtr.assembly_line("gtlcecore:transcendent_max_battery")
        .itemInputs("16x gtceu:double_quantanium_plate",
            "16x #gtceu:circuits/uiv",
            "gtlcecore:really_max_battery",
            "8x gtlcecore:optical_processing_core",
            "64x gtlcecore:nm_wafer",
            "64x gtlcecore:nm_wafer",
            "64x gtlcecore:smd_diode_optical",
            "64x gtlcecore:smd_capacitor_optical",
            "64x gtlcecore:smd_resistor_optical",
            "64x gtlcecore:smd_transistor_optical",
            "64x gtlcecore:smd_inductor_optical",
        ...
        .itemOutputs("gtlcecore:transcendent_max_battery")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:really_max_battery"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(576))

    gtr.assembly_line("gtlcecore:extremely_max_battery")
        .itemInputs("16x gtceu:double_adamantium_plate",
            "16x #gtceu:circuits/uxv",
            "gtlcecore:transcendent_max_battery",
            "8x gtlcecore:exotic_processing_core",
            "64x gtlcecore:pm_wafer",
            "64x gtlcecore:pm_wafer",
            "64x gtlcecore:smd_diode_exotic",
            "64x gtlcecore:smd_capacitor_exotic",
            "64x gtlcecore:smd_resistor_exotic",
            "64x gtlcecore:smd_transistor_exotic",
            "64x gtlcecore:smd_inductor_exotic",
        ...
        .itemOutputs("gtlcecore:extremely_max_battery")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(3200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:transcendent_max_battery"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(1152))

    gtr.assembly_line("gtlcecore:insanely_max_battery")
        .itemInputs("16x gtceu:double_vibranium_plate",
            "16x #gtceu:circuits/opv",
            "gtlcecore:extremely_max_battery",
            "8x gtlcecore:cosmic_processing_core",
            "64x gtlcecore:pm_wafer",
            "64x gtlcecore:pm_wafer",
            "64x gtlcecore:smd_diode_cosmic",
            "64x gtlcecore:smd_capacitor_cosmic",
        ...
        .itemOutputs("gtlcecore:insanely_max_battery")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(3600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:extremely_max_battery"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(2304))

    gtr.assembly_line("gtlcecore:mega_max_battery")
        .itemInputs("16x gtceu:double_draconium_plate",
            "16x #gtceu:circuits/max",
            "gtlcecore:insanely_max_battery",
            "8x gtlcecore:supracausal_processing_core",
            "64x gtlcecore:fm_wafer",
            "64x gtlcecore:fm_wafer",
            "64x gtlcecore:smd_diode_supracausal",
            "64x gtlcecore:smd_capacitor_supracausal",
            "64x gtlcecore:smd_resistor_supracausal",
            "64x gtlcecore:smd_transistor_supracausal",
            "64x gtlcecore:smd_inductor_supracausal",
        ...
        .itemOutputs("gtlcecore:mega_max_battery")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(4000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:insanely_max_battery"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.OpV])
            .CWUt(4608))

    gtr.assembly_line("gtlcecore:advanced_assembly_line")
        ...
        .itemOutputs("gtlcecore:advanced_assembly_line")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)
    ...
    gtr.assembly_line("gtlcecore:space_probe_surface_reception")
        .itemInputs("12x gtceu:double_adamantine_plate",
            ...
            "8x gtlcecore:lepton_trap_crystal",
            "4x gtlcecore:scintillator",
        ...
        .itemOutputs("gtlcecore:space_probe_surface_reception")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:resource_collection"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:eye_of_harmony")
        .itemInputs("16x gtlcecore:dimension_injection_casing",
            "16x gtlcecore:spacetime_compression_field_generator",
            "16x gtlcecore:dimensional_stability_casing",
            "64x gtceu:uv_world_accelerator",
            "64x gtlcecore:resource_collection",
            "64x gtceu:high_performance_computation_array",
            "32x gtlcecore:ctc_computational_unit",
            "32x gtlcecore:stabilized_wormhole_generator",
            "16x #gtceu:circuits/max",
            "16x gtceu:cosmicneutronium_nanoswarm",
            "64x gtceu:opv_emitter",
            "64x gtceu:opv_sensor",
            "64x gtceu:opv_robot_arm",
            "64x gtlcecore:time_dilation_containment_unit",
            "4x gtlcecore:insanely_max_battery",
        ...
        .itemOutputs("gtlcecore:eye_of_harmony")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(2400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:recursively_folded_negative_space"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(8192))

    gtr.assembly_line("gtlcecore:dimensionally_transcendent_plasma_forge")
        .itemInputs("16x gtceu:black_titanium_frame",
            "8x gtlcecore:dimensional_bridge_casing",
            "16x gtlcecore:super_blast_smelter",
        ...
        .itemOutputs("gtlcecore:dimensionally_transcendent_plasma_forge")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(4000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:stellar_forge"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(4096))

    gtr.assembly_line("gtlcecore:dimensionally_transcendent_mixer")
        .itemInputs("16x gtceu:black_titanium_frame",
            "64x gtceu:luv_mixer",
            "48x gtceu:zpm_mixer",
            "32x gtceu:uv_mixer",
        ...
        .itemOutputs("gtlcecore:dimensionally_transcendent_mixer")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(2000)
    ...
    gtr.assembly_line("gtlcecore:precision_assembler")
        ...
        .itemOutputs("gtlcecore:precision_assembler")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(1000)
    ...
    gtr.assembly_line("gtlcecore:decay_hastener")
        ...
        .itemOutputs("gtlcecore:decay_hastener")
    ...
    gtr.assembly_line("gtlcecore:time_dilation_containment_unit")
        ...
        .itemOutputs("gtlcecore:time_dilation_containment_unit")
        .EUt(8000000)
        .duration(100)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:empty_laser_cooling_container"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(64))

    gtr.assembly_line("gtlcecore:extremely_durable_plasma_cell")
        .itemInputs("48x gtceu:neutronium_plate", "4x gtceu:heavy_quark_degenerate_matter_large_fluid_pipe", "2x gtceu:uxv_electric_pump", "2x gtceu:uxv_field_generator", "gtceu:infuscolium_nanoswarm", "2x gtceu:quantumchromodynamically_confined_matter_frame", "4x gtlcecore:force_field_glass", "8x gtceu:fusion_coil", "2x #gtceu:circuits/uiv", "4x gtceu:double_adamantine_plate", "4x gtceu:double_celestialtungsten_plate")
        .inputFluids("gtceu:super_mutated_living_solder 2304", "gtceu:dalisenite 2304", "gtceu:echoite 2592", "gtceu:taranium 1584")
        .itemOutputs("gtlcecore:extremely_durable_plasma_cell")
        .EUt(15000000)
        .duration(150)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:plasma_containment_cell"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:dimension_injection_casing")
        ...
        .itemOutputs("2x gtlcecore:dimension_injection_casing")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:spacetime_assembly_line_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:spacetime_compression_field_generator")
        .itemInputs("gtlcecore:dimensionally_transcendent_casing", "gtlcecore:containment_field_generator", "4x gtlcecore:dyson_deployment_casing", "gtceu:opv_field_generator", "gtlcecore:microwormhole_generator", "4x gtceu:orichalcum_nanoswarm", "2x gtceu:infinity_rod", "gtceu:double_starmetal_plate", "gtceu:double_quantumchromodynamically_confined_matter_plate", "4x gtceu:double_titan_precision_steel_plate")
        ...
        .itemOutputs("gtlcecore:spacetime_compression_field_generator")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:time_dilation_containment_unit"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.OpV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:dimensional_bridge_casing")
        .itemInputs("gtlcecore:dimensionally_transcendent_casing", "gtceu:uv_quantum_chest", "gtceu:uv_quantum_tank", "2x gtceu:enderite_single_wire", "2x #gtceu:circuits/uv", "gtceu:uhv_field_generator")
        .itemOutputs("gtlcecore:dimensional_bridge_casing")
        ...
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:dimension_injection_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:manifold_oscillatory_power_cell")
        .itemInputs("32x gtceu:titansteel_single_wire", "32x gtceu:magnetic_neodymium_rod", "16x gtceu:vibranium_plate", "8x gtceu:fine_legendarium_wire", "4x gtlcecore:amorphous_matter", "16x gtceu:double_red_alloy_plate", "2x gtceu:degenerate_rhenium_plate", "4x gtceu:double_quantum_plate")
        .inputFluids("gtceu:super_mutated_living_solder 144", "gtceu:taranium 72", "gtceu:naquadria 144", "gtceu:tritanium 288")
        .itemOutputs("gtlcecore:manifold_oscillatory_power_cell")
        .EUt(33550000)
        .duration(1800)
    ...
    gtr.assembly_line("gtlcecore:hyperdimensional_drone")
        .itemInputs("2x gtlcecore:max_robot_arm", "2x gtlcecore:max_conveyor_module", "2x gtlcecore:max_emitter", "2x gtlcecore:max_sensor", "gtlcecore:max_field_generator", "gtlcecore:chaotic_core", "gtlcecore:draconic_energy_core", "gtlcecore:spacetime_catalyst", "gtlcecore:ctc_guidance_unit", "gtceu:black_dwarf_mtter_nanoswarm", "64x gtlcecore:dyson_swarm_module", "64x gtlcecore:dyson_swarm_module", "64x gtlcecore:dyson_swarm_module", "64x gtlcecore:dyson_swarm_module", "16x gtceu:double_transcendentmetal_plate", "16x gtceu:double_hypogen_plate")
        ...
        .itemOutputs("gtlcecore:hyperdimensional_drone")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(4800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:space_drone_mk6"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(8192))

    gtr.assembly_line("gtlcecore:leptonic_charge")
        ...
        .itemOutputs("gtlcecore:leptonic_charge")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:naquadria_charge"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(64))

    gtr.assembly_line("gtlcecore:quantum_chromodynamic_charge")
        .itemInputs("2x gtceu:double_infuscolium_plate", "2x gtceu:heavy_quark_degenerate_matter_plate", "gtlcecore:time_dilation_containment_unit", "gtlcecore:leptonic_charge", "gtceu:double_superheavy_l_alloy_plate", "gtceu:double_superheavy_h_alloy_plate")
        .inputFluids("gtceu:draconium 72", "gtceu:gluons 1296", "gtceu:legendarium 144", "gtceu:starmetal 144")
        .itemOutputs("gtlcecore:quantum_chromodynamic_charge")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:leptonic_charge"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:circuit_assembly_line")
        .itemInputs("4x gtlcecore:machine_casing_circuit_assembly_line",
            "4x #gtceu:circuits/uv",
        ...
        .itemOutputs("gtlcecore:circuit_assembly_line")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(800)
    ...
    gtr.assembly_line("gtlcecore:bioware_processing_core")
        .itemInputs("gtlcecore:bioware_printed_circuit_board",
            "8x gtlcecore:smd_capacitor_bioware",
            "8x gtlcecore:smd_diode_bioware",
            "8x gtlcecore:smd_resistor_bioware",
            "8x gtlcecore:smd_transistor_bioware",
            "8x gtlcecore:smd_inductor_bioware",
            "2x gtceu:polyetheretherketone_foil",
            "8x gtlcecore:biological_cells",
            "8x gtlcecore:bioware_chip",
        ...
        .itemOutputs("8x gtlcecore:bioware_processing_core")
        .EUt(368640)
        .duration(320)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:bioware_chip"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(64))

    gtr.assembly_line("gtlcecore:optical_processing_core")
        .itemInputs("gtlcecore:optical_printed_circuit_board",
            "8x gtlcecore:smd_capacitor_optical",
            "8x gtlcecore:smd_diode_optical",
            "8x gtlcecore:smd_resistor_optical",
            "8x gtlcecore:smd_transistor_optical",
            "8x gtlcecore:smd_inductor_optical",
            "2x gtceu:polyetheretherketone_foil",
            "2x gtlcecore:non_linear_optical_lens",
            "16x gtceu:normal_optical_pipe",
            "8x gtlcecore:optical_soc",
            "4x gtlcecore:solar_light_splitter",
            "gtlcecore:low_frequency_laser",
            "gtlcecore:medium_frequency_laser",
            "gtlcecore:high_frequency_laser",
            "gtlcecore:bose_einstein_cooling_container",
        ...
        .itemOutputs("8x gtlcecore:optical_processing_core")
        .EUt(1474560)
        .duration(320)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:optical_soc"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:exotic_processing_core")
        .itemInputs("gtlcecore:exotic_printed_circuit_board",
            "16x gtlcecore:smd_capacitor_exotic",
            "16x gtlcecore:smd_diode_exotic",
            "16x gtlcecore:smd_resistor_exotic",
            "16x gtlcecore:smd_transistor_exotic",
            "16x gtlcecore:smd_inductor_exotic",
            "8x gtceu:trinium_titanium_foil",
            "4x gtlcecore:high_precision_crystal_soc",
            "gtlcecore:rydberg_spinorial_assembly",
            "gtlcecore:x_ray_laser",
            "4x gtlcecore:non_linear_optical_lens",
            "8x gtceu:kevlar_foil",
            "4x gtceu:degenerate_rhenium_plate")
        .inputFluids("gtceu:mutated_living_solder 576", "gtceu:quantum_dots 80")
        .itemOutputs("8x gtlcecore:exotic_processing_core")
        .EUt(4000000)
        .duration(160)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:exotic_chip"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:cosmic_processing_core")
        .itemInputs("gtlcecore:cosmic_printed_circuit_board",
            "24x gtlcecore:smd_capacitor_cosmic",
            "24x gtlcecore:smd_diode_cosmic",
            "24x gtlcecore:smd_resistor_cosmic",
            "24x gtlcecore:smd_transistor_cosmic",
            "24x gtlcecore:smd_inductor_cosmic",
            "gtlcecore:cosmic_processing_unit_core",
            "gtlcecore:ultrashort_pulse_laser",
            "16x gtceu:fine_cinobite_wire",
            "32x gtceu:fine_borosilicate_glass_wire",
            "4x gtlcecore:bose_einstein_cooling_container",
        ...
        .itemOutputs("8x gtlcecore:cosmic_processing_core")
        .EUt(11796480)
        .duration(320)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:cosmic_processing_unit_core"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:supracausal_processing_core")
        .itemInputs("gtlcecore:supracausal_printed_circuit_board",
            "64x gtlcecore:smd_capacitor_supracausal",
            "64x gtlcecore:smd_diode_supracausal",
            "64x gtlcecore:smd_resistor_supracausal",
            "64x gtlcecore:smd_transistor_supracausal",
            "64x gtlcecore:smd_inductor_supracausal",
            "3x gtlcecore:quantumchromodynamic_protective_plating",
            "2x gtceu:legendarium_single_wire",
            "gtlcecore:nuclear_clock",
            "gtlcecore:topological_manipulator_unit",
            "gtlcecore:relativistic_spinorial_memory_system",
            "gtlcecore:graviton_transducer",
        ...
        .itemOutputs("8x gtlcecore:supracausal_processing_core")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:relativistic_spinorial_memory_system"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:qft_coil")
        .itemInputs("gtceu:quantumchromodynamically_confined_matter_frame",
            "gtlcecore:uruium_coil_block",
            "gtceu:uev_field_generator",
            "gtlcecore:quantumchromodynamic_protective_plating",
        ...
        .itemOutputs("gtlcecore:qft_coil")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
    ...
    gtr.assembly_line("gtlcecore:spacetimecontinuumripper")
        .itemInputs("gtlcecore:manipulator",
        ...
        .itemOutputs("gtlcecore:spacetimecontinuumripper")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:manipulator"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:spacetimebendingcore")
        .itemInputs("gtlcecore:manipulator",
            "4x gtceu:uiv_field_generator",
        ...
        .itemOutputs("gtlcecore:spacetimebendingcore")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:spacetimecontinuumripper"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:a_mass_fabricator")
        .itemInputs("16x gtceu:active_transformer",
            "4x gtlcecore:mass_fabricator",
            "4x gtlcecore:cosmic_processing_core",
            "16x gtlcecore:magnetic_trap",
            "32x gtlcecore:scintillator_crystal",
            "16x gtlcecore:electron_source",
            "8x gtlcecore:unstable_star",
            "4x gtceu:vibranium_nanoswarm",
            "16x gtlcecore:charged_lepton_trap_crystal",
            "4x #gtceu:circuits/opv",
            "gtlcecore:extremely_max_battery",
        ...
        .itemOutputs("gtlcecore:a_mass_fabricator")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(1800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:mass_fabricator"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:mage_assembler")
        .itemInputs("16x gtceu:large_assembler",
            "16x gtceu:large_circuit_assembler",
            "16x gtlcecore:precision_circuit_assembly_robot_mk1",
        ...
        .itemOutputs("gtlcecore:mage_assembler")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:precision_assembler"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:cooling_tower")
        .itemInputs("64x gtceu:hsse_frame",
            "16x gtlcecore:plasma_condenser",
            "16x gtceu:mega_vacuum_freezer",
            "64x gtlcecore:empty_laser_cooling_container",
            "64x gtlcecore:high_frequency_laser",
            "64x gtlcecore:medium_frequency_laser",
            "64x gtlcecore:low_frequency_laser",
        ...
        .itemOutputs("gtlcecore:cooling_tower")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(1200)
    ...
    gtr.assembly_line("gtlcecore:bedrock_drilling_rig")
        .itemInputs("16x gtceu:uev_rock_crusher",
            "16x gtceu:uev_cutter",
            "16x gtceu:uev_macerator",
            "4x gtlcecore:machine_casing_grinding_head",
            "4x gtlcecore:bedrock_drill",
            "8x gtceu:uev_sensor",
        ...
        .itemOutputs("gtlcecore:bedrock_drilling_rig")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(1200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:bedrock_drill"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:superconducting_electromagnetism")
        ...
        .itemOutputs("gtlcecore:superconducting_electromagnetism")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(1200)
    ...
    gtr.assembly_line("gtlcecore:create_aggregation")
        .itemInputs("32x gtceu:magnetohydrodynamicallyconstrainedstarmatter_frame",
            "16x gtlcecore:chain_command_block_core",
            "16x gtlcecore:spacetimecontinuumripper",
            "8x gtlcecore:create_aggregatione_core",
            "32x gtlcecore:max_robot_arm",
            "32x gtlcecore:max_emitter",
            "16x gtlcecore:max_field_generator",
            "64x gtceu:infinity_octal_wire",
            "2x gtlcecore:mega_max_battery",
        ...
        .itemOutputs("gtlcecore:create_aggregation")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(12000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:create_aggregatione_core"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(16384))

    gtr.assembly_line("gtlcecore:create_aggregatione_core")
        .itemInputs("gtceu:magnetohydrodynamicallyconstrainedstarmatter_frame",
            "16x gtlcecore:dimension_creation_casing",
            "16x gtlcecore:two_way_foil",
            "16x gtceu:cosmic_foil",
            "64x gtlcecore:black_body_naquadria_supersolid",
            "16x gtlcecore:max_field_generator",
            "32x gtceu:magmatter_rod",
            "8x gtlcecore:eigenfolded_kerr_manifold",
            "16x gtlcecore:max_robot_arm",
            "gtlcecore:insanely_max_battery",
        ...
        .itemOutputs("gtlcecore:create_aggregatione_core")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(120000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:dragon_stabilizer_core"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(16384))
    ...
    parts_materialas.forEach((parts_material) => {
        const eut = parseInt(parts_material[6], 10);
        const cuw = parseInt(parts_material[1], 10);
        gtr.assembly_line("gtceu:" + parts_material[0] + "_electric_motor")
            .itemInputs("gtlcecore:magnetic_long_netherite_rod",
    ...
    const parts_materials = [
        ["uiv", "4", "neutronium", "adamantine", "uev", "uhv", "6400000", "adamantium", "echoite", "infuscolium", "gtlcecore:unstable_star", "3", "arceusalloy2b", "gtceu:taranium 576"],
        ["uxv", "8", "taranium", "naquadriatictaranium", "uiv", "uev", "25600000", "vibranium", "legendarium", "hastelloyk_243", "2x gtlcecore:unstable_star", "4", "titan_precision_steel", "gtceu:astraltitanium 576"],
        ["opv", "16", "crystalmatrix", "starmetal", "uxv", "uev", "102400000", "draconium", "draconiumawakened", "vibramantium", "4x gtlcecore:unstable_star", "5", "hikarium", "gtceu:celestialtungsten 576"]
    ]
    ...
    gtr.assembly_line("gtlcecore:dimensional_stability_casing")
        .itemInputs("gtlcecore:containment_field_generator",
            "4x gtlcecore:dyson_control_casing",
            "4x gtlcecore:dyson_control_toroid",
        ...
        .itemOutputs("gtlcecore:dimensional_stability_casing")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:dimensional_bridge_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:pcb_factory")
        .itemInputs("4x gtceu:neutronium_frame",
            "4x gtceu:uv_circuit_assembler",
            "4x gtlcecore:chemical_plant",
            "4x #gtceu:circuits/uev",
        ...
        .itemOutputs("gtlcecore:pcb_factory")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:bioware_circuit_board"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:large_naquadah_reactor")
        ...
        .itemOutputs("gtlcecore:large_naquadah_reactor")
        .EUt(90000)
        .duration(1000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:zpm_naquadah_reactor"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(64))

    gtr.assembly_line("gtlcecore:aggregation_device")
        .itemInputs("4x gtlcecore:draconium_block_charged", "64x gtlcecore:pm_chip", "64x gtlcecore:pm_chip", "8x gtlcecore:reinforced_echo_shard", "4x gtceu:enderite_hex_wire", "4x gtceu:uev_field_generator", "gtlcecore:really_max_battery", "64x gtceu:quantanium_screw", "8x gtceu:double_dalisenite_plate", "8x gtceu:double_seaborgium_plate")
        .itemOutputs("gtlcecore:aggregation_device")
        .inputFluids("gtceu:mutated_living_solder 1296", "gtceu:neutronium 576", "gtceu:mana 1000", "gtceu:enriched_dragon_breath 100")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(1600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:aggregatione_core"))
            .EUt(GTValues.VA[GTValues.UEV])
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .CWUt(128))

    gtr.assembly_line("gtlcecore:super_particle_collider")
    ...
    gtr.assembly_line("gtlcecore:engraving_laser_plant")
        ...
        .itemOutputs("gtlcecore:engraving_laser_plant")
    ...
    gtr.assembly_line("gtlcecore:qft")
        .itemInputs("8x gtceu:vibranium_frame", "4x gtlcecore:spacetimecontinuumripper", "4x gtlcecore:spacetimebendingcore", "8x gtlcecore:precision_circuit_assembly_robot_mk4", "8x gtceu:uxv_sensor", "8x gtceu:uxv_robot_arm", "8x gtceu:uxv_electric_pump", "8x gtceu:uxv_field_generator", "8x #gtceu:circuits/opv", "gtlcecore:extremely_max_battery", "64x gtceu:double_lafium_plate", "64x gtceu:double_titan_precision_steel_plate")
        .itemOutputs("gtlcecore:qft")
        .inputFluids("gtceu:super_mutated_living_solder 1296", "gtceu:tairitsu 2880", "gtceu:soldering_alloy 2880", "gtceu:periodicium 2880")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(2400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:spacetimebendingcore"))
            .EUt(GTValues.VA[GTValues.UXV])
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .CWUt(2048))

    const wireless_tiers = [
        [0, "uhv", "neutronium", "europium", "gtlcecore:nm_chip", "8x gtlcecore:smd_inductor_bioware"],
        [1, "uev", "quantanium", "mithril", "gtlcecore:nm_chip", "8x gtlcecore:smd_inductor_optical"],
        [2, "uiv", "adamantium", "neutronium", "gtlcecore:pm_chip", "8x gtlcecore:smd_inductor_exotic"],
        [3, "uxv", "vibranium", "taranium", "gtlcecore:pm_chip", "8x gtlcecore:smd_inductor_cosmic"],
        [4, "opv", "draconium", "crystalmatrix", "gtlcecore:fm_chip", "8x gtlcecore:smd_inductor_supracausal"],
        [5, "max", "chaos", "cosmicneutronium", "gtlcecore:fm_chip", "8x gtceu:shirabon_foil"]
    ]
    wireless_tiers.forEach((tier) => {
        ...
        gtr.assembler(`gtmthings:${tier[1]}_wireless_energy_receive_cover`)
            .itemInputs(`gtceu:${tier[1]}_sensor`,
                ...
                `gtlcecore:${tier[1]}_voltage_coil`,
                tier[4],
        ...
        gtr.assembler(`gtmthings:${tier[1]}_4a_wireless_energy_receive_cover`)
            .itemInputs(`2x gtmthings:${tier[1]}_wireless_energy_receive_cover`,
                ...
                `2x gtlcecore:${tier[1]}_voltage_coil`,
    ...
    const machine_materials = [
        ["uhv", "neutronium", "europium", "abyssalalloy", "uev", "1966080", "uv", "128", "gtlcecore:smd_diode_bioware"],
        ["uev", "quantanium", "mithril", "titansteel", "uiv", "7864320", "uhv", "256", "gtlcecore:smd_diode_optical"],
        ["uiv", "adamantium", "neutronium", "adamantine", "uxv", "31457280", "uev", "512", "gtlcecore:smd_diode_exotic"],
        ["uxv", "vibranium", "taranium", "naquadriatictaranium", "opv", "125829120", "uiv", "1024", "gtlcecore:smd_diode_cosmic"],
        ["opv", "draconium", "crystalmatrix", "starmetal", "max", "503316480", "uxv", "2048", "gtlcecore:smd_diode_supracausal"]
    ]
    ...
    gtr.assembler("gtlcecore:large_recycler")
        ...
        .itemOutputs("gtlcecore:large_recycler")
        .EUt(1920)
        .duration(400)

    gtr.large_recycler("gtlcecore:scrap_1")
        .itemInputs("#forge:ingots")
        .itemOutputs("gtlcecore:scrap")
        .EUt(480)
        .duration(200)

    gtr.large_recycler("gtlcecore:scrap_2")
        .itemInputs("#forge:dusts")
        .itemOutputs("gtlcecore:scrap")
        .EUt(120)
        .duration(200)

    gtr.large_recycler("gtlcecore:scrap_3")
        .itemInputs("4x #forge:small_dusts")
        .itemOutputs("gtlcecore:scrap")
        .EUt(120)
        .duration(200)

    gtr.large_recycler("gtlcecore:scrap_4")
        .itemInputs("9x #forge:tiny_dusts")
        .itemOutputs("gtlcecore:scrap")
        .EUt(120)
        .duration(200)

    gtr.large_recycler("gtlcecore:scrap_5")
        .itemInputs("#forge:storage_blocks")
        .itemOutputs("9x gtlcecore:scrap")
        .EUt(1920)
        .duration(400)

    gtr.large_recycler("gtlcecore:scrap_6")
        .itemInputs("9x #forge:nuggets")
        .itemOutputs("gtlcecore:scrap")
        .EUt(480)
        .duration(200)

    gtr.large_recycler("gtlcecore:scrap_7")
        .itemInputs("#forge:gems")
        .itemOutputs("gtlcecore:scrap")
        .EUt(480)
        .duration(200)

    gtr.large_recycler("gtlcecore:scrap_8")
    ...
    gtr.mixer("gtceu:fertilizer_")
        .itemInputs("gtceu:fertilizer", "2x gtlcecore:scrap")
        .itemOutputs("2x gtceu:fertilizer")
        .EUt(480)
        .duration(40)

    gtr.packer("gtlcecore:scrap_box")
        .itemInputs("9x gtlcecore:scrap")
        .itemOutputs("gtlcecore:scrap_box")
        .EUt(12)
        .duration(200)

    gtr.assembler("gtlcecore:space_elevator_mechanical_casing")
        .itemInputs("gtceu:hssg_frame", "6x gtceu:inconel_792_plate", "6x gtceu:double_pikyonium_plate")
        .itemOutputs("2x gtlcecore:space_elevator_mechanical_casing")
        .EUt(16)
        .duration(50)
        .circuit(6)

    gtr.chemical_bath("gtlcecore:high_strength_concrete")
        .itemInputs("#forge:concretes")
        .inputFluids("gtceu:concrete 1152")
        .itemOutputs("gtlcecore:high_strength_concrete")
        .EUt(480)
        .duration(200)

    gtr.assembler("gtlcecore:space_elevator_support")
        .itemInputs("gtceu:naquadah_frame", "4x gtceu:red_steel_rod", "6x gtceu:black_steel_plate")
        .inputFluids("gtceu:concrete 1152")
        .itemOutputs("2x gtlcecore:space_elevator_support")
        .EUt(480)
        .duration(400)

    gtr.assembler("gtlcecore:space_elevator_internal_support")
        ...
        .inputFluids("gtceu:concrete 1152")
        .itemOutputs("2x gtlcecore:space_elevator_internal_support")
        .EUt(480)
        .duration(400)
    ...
    world_data_scanner.forEach((scanner) => {
        event.shaped("gtlcecore:" + scanner[0] + "_world_data_scanner", [
            "CDC",
            "BAB",
            "CDC"
        ], {
    ...
    event.shaped("2x gtlcecore:neutronium_pipe_casing", [
        "CBC",
        "BAB",
        "CBC"
    ], {
    ...
    event.shaped("2x gtlcecore:neutronium_gearbox", [
        "CEC",
        "BAB",
        "CFC"
    ], {
    ...
    event.shaped("gtlcecore:advanced_assembly_line_unit", [
        "CEC",
        "BAB",
        "CEC"
    ], {
    ...
    gtr.assembler("gtlcecore:void_miner")
        ...
        .inputFluids("gtceu:soldering_alloy 1440")
        .itemOutputs("gtlcecore:void_miner")
    ...
    gtr.forming_press("gtlcecore:netherite_rod")
        .itemInputs("minecraft:netherite_upgrade_smithing_template", "2x gtceu:neodymium_rod", "minecraft:netherite_ingot")
        .itemOutputs("2x gtlcecore:netherite_rod")
        .EUt(480)
        .duration(400)

    gtr.forge_hammer("gtlcecore:long_netherite_rod")
        .itemInputs("2x gtlcecore:netherite_rod")
        .itemOutputs("gtlcecore:long_netherite_rod")
        .EUt(30)
        .duration(200)

    gtr.forge_hammer("gtlcecore:magnetic_long_netherite_rod")
        .itemInputs("2x gtlcecore:magnetic_netherite_rod")
        .itemOutputs("gtlcecore:magnetic_long_netherite_rod")
        .EUt(30)
        .duration(200)

    gtr.polarizer("gtlcecore:magnetic_netherite_rod")
        .itemInputs("gtlcecore:netherite_rod")
        .itemOutputs("gtlcecore:magnetic_netherite_rod")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(200)

    gtr.polarizer("gtlcecore:magnetic_long_netherite_rod")
        .itemInputs("gtlcecore:long_netherite_rod")
        .itemOutputs("gtlcecore:magnetic_long_netherite_rod")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
    ...
    coils.forEach((coil) => {
        gtr.assembler("gtlcecore:" + coil[0] + "_voltage_coil")
            .itemInputs("gtlcecore:magnetic_netherite_rod", "16x #forge:fine_wires/" + coil[2])
            .itemOutputs("gtlcecore:" + coil[0] + "_voltage_coil")
            .EUt(coil[1])
            .duration(200)
            .circuit(1)
        gtr.assembler("gtlcecore:" + coil[2] + "_coil_block")
            .itemInputs("8x gtceu:" + coil[2] + "_double_wire", "8x gtceu:" + coil[3] + "_foil")
            .inputFluids("gtceu:" + coil[4] + " 144")
            .itemOutputs("gtlcecore:" + coil[2] + "_coil_block")
            .EUt(coil[1])
            .duration(800)
    })
    const coilas = [
    ...
    gtr.assembler("gtlcecore:max_voltage_coil")
        .itemInputs("gtceu:attuned_tengam_rod", "16x #forge:fine_wires/cosmicneutronium")
        .itemOutputs("gtlcecore:max_voltage_coil")
        .EUt(2013265920)
        .duration(200)
        .circuit(1)

    gtr.assembly_line("gtlcecore:infinity_coil_block")
        .itemInputs("gtlcecore:qft_coil", "8x gtceu:infinity_double_wire", "16x gtceu:draconium_screw", "64x gtceu:kevlar_foil", "32x gtceu:radox_foil")
        .inputFluids("gtceu:starmetal 576", "gtceu:crystalmatrix 576")
        .itemOutputs("gtlcecore:infinity_coil_block")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:starmetal_coil_block"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(2048))

    gtr.assembly_line("gtlcecore:hypogen_coil_block")
        .itemInputs("gtlcecore:qft_coil", "8x gtceu:hypogen_double_wire", "16x gtceu:transcendentmetal_screw", "64x gtceu:radox_foil", "32x gtceu:chaos_foil")
        .inputFluids("gtceu:infinity 576", "gtceu:cosmicneutronium 576")
        .itemOutputs("gtlcecore:hypogen_coil_block")
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:infinity_coil_block"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(4096))

    gtr.assembly_line("gtlcecore:eternity_coil_block")
        .itemInputs("gtlcecore:qft_coil", "8x gtceu:spacetime_double_wire", "4x gtceu:eternity_rod", "avaritia:eternal_singularity", "64x gtlcecore:cosmic_fabric", "64x gtceu:radox_foil", "64x gtceu:radox_foil", "64x gtceu:chaos_foil")
        .inputFluids("gtceu:hypogen 576", "gtceu:spacetime 576")
        .itemOutputs("gtlcecore:eternity_coil_block")
        .EUt(16 * GTValues.VA[GTValues.MAX])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:hypogen_coil_block"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(8192))

    gtr.assembler("gtlcecore:ingot_field_shape")
        ...
        .itemOutputs("gtlcecore:ingot_field_shape")
        .EUt(30720)
        .duration(200)

    gtr.assembler("gtlcecore:ball_field_shape")
        ...
        .itemOutputs("gtlcecore:ball_field_shape")
        .EUt(30720)
        .duration(200)

    gtr.forming_press("gtlcecore:scintillator_crystal")
        ...
        .itemOutputs("gtlcecore:scintillator_crystal")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(280)
    ...
    gtr.assembler_module("gtlcecore:scintillator")
        .itemInputs("12x gtceu:highurabilityompoundteel_screw", "12x gtceu:fine_cinobite_wire", "6x gtceu:zylon_foil", "4x gtceu:cinobite_plate", "4x gtceu:echoite_plate", "gtlcecore:scintillator_crystal", "gtlcecore:separation_electromagnet", "gtceu:double_astraltitanium_plate")
        .itemOutputs("gtlcecore:scintillator")
        .inputFluids("gtceu:trinium_titanium 432", "gtceu:soldering_alloy 288", "gtceu:mutated_living_solder 144")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .addData("SEPMTier", 2)

    gtr.assembler("gtlcecore:rare_earth_centrifugal")
        ...
        .itemOutputs("gtlcecore:rare_earth_centrifugal")
    ...
    gtr.decay_hastener("gtlcecore:rutherfordium_dust")
        .inputFluids("gtceu:seaborgium 144")
        .itemOutputs("gtceu:rutherfordium_dust")
        .EUt(480)
        .duration(4000)

    gtr.decay_hastener("gtlcecore:rutherfordium_dust1")
        .inputFluids("gtceu:actinium 144")
        .itemOutputs("gtceu:rutherfordium_dust")
        .EUt(480)
        .duration(8000)

    gtr.decay_hastener("gtlcecore:actinium_dust")
        .inputFluids("gtceu:radium 144")
        .itemOutputs("gtceu:actinium_dust")
        .EUt(480)
        .duration(2000)

    gtr.assembler("gtlcecore:plasma_containment_cell")
        ...
        .itemOutputs("gtlcecore:plasma_containment_cell")
        .inputFluids("gtceu:mutated_living_solder 576")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:magic_core")
        .itemInputs("8x gtceu:double_stellite_100_plate", "gtlcecore:bose_einstein_cooling_container", "minecraft:conduit", "8x gtceu:double_enderium_plate")
        .itemOutputs("gtlcecore:magic_core")
        .inputFluids("gtceu:mutated_living_solder 576")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)

    gtr.assembler("gtlcecore:separation_electromagnet")
        ...
        .itemOutputs("gtlcecore:separation_electromagnet")
        .inputFluids("gtceu:soldering_alloy 288")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(600)

    gtr.canner("gtlcecore:rhenium_plasma_containment_cell")
        .notConsumable("gtceu:naquadah_nanoswarm")
        .itemInputs("gtlcecore:plasma_containment_cell")
        .itemOutputs("gtlcecore:rhenium_plasma_containment_cell")
    ...
    gtr.sps_crafting("gtceu:echoite_plasma")
        .itemInputs("16x gtceu:exquisite_echo_shard_gem", "gtlcecore:rhenium_plasma_containment_cell")
    ...
    gtr.bedrock_drilling_rig("gtceu:bedrock_dust_1")
        .chancedInput("gtlcecore:bedrock_drill", 10, 0)
        .itemOutputs("gtceu:bedrock_dust")
        .EUt(GTValues.VA[GTValues.UEV])
        .circuit(1)
        .duration(200)
    ...
    gtr.bedrock_drilling_rig("gtceu:bedrock_dust_2")
        .chancedInput("4x gtlcecore:bedrock_drill", 10, 0)
    ...
    gtr.bedrock_drilling_rig("gtceu:bedrock_dust_3")
        .chancedInput("16x gtlcecore:bedrock_drill", 10, 0)
    ...
    gtr.bedrock_drilling_rig("gtceu:bedrock_dust_4")
        .chancedInput("64x gtlcecore:bedrock_drill", 10, 0)
    ...
    gtr.matter_fabricator("gtceu:uu_amplifier_a")
        .itemInputs("gtlcecore:scrap_box")
        .circuit(1)
    ...
    gtr.centrifuge("gtceu:free_electron_gas")
        .notConsumable("gtlcecore:separation_electromagnet")
    ...
    gtr.polarizer("gtlcecore:triplet_neutronium_sphere")
        .itemInputs("gtlcecore:neutronium_sphere")
        .itemOutputs("gtlcecore:triplet_neutronium_sphere")
        .EUt(5000000)
        .duration(200)

    gtr.canner("gtlcecore:charged_triplet_neutronium_sphere")
        .notConsumable("gtceu:neutronium_nanoswarm")
        .itemInputs("gtlcecore:triplet_neutronium_sphere")
        .inputFluids("gtceu:free_alpha_gas 1000")
        .itemOutputs("gtlcecore:charged_triplet_neutronium_sphere")
        .EUt(500000)
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:hyper_core")
        ...
        .itemOutputs("gtlcecore:hyper_core")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:annihilate_core")
        .itemInputs("gtceu:quantumchromodynamically_confined_matter_frame", "gtlcecore:graviton_transducer", "gtlcecore:topological_manipulator_unit", "gtceu:uxv_field_generator", "2x #gtceu:circuits/uxv", "4x gtceu:double_cinobite_plate")
        .inputFluids("gtceu:super_mutated_living_solder 1296")
        .itemOutputs("gtlcecore:annihilate_core")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.canner("gtlcecore:draconiumawakened_plasma_containment_cell")
        .notConsumable("gtceu:draconium_nanoswarm")
        .inputFluids("gtceu:draconiumawakened_plasma 1000")
        .itemInputs("gtlcecore:plasma_containment_cell")
        .itemOutputs("gtlcecore:draconiumawakened_plasma_containment_cell")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(20)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.canner("gtlcecore:dense_neutron_plasma_cell")
        .notConsumable("gtceu:neutronium_nanoswarm")
        .inputFluids("gtceu:dense_neutron_plasma 1000")
        .itemInputs("gtlcecore:extremely_durable_plasma_cell")
        .itemOutputs("gtlcecore:dense_neutron_plasma_cell")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(20)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.canner("gtlcecore:chaos_containment_unit")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .inputFluids("gtceu:chaos_plasma 1000")
        .itemInputs("gtlcecore:time_dilation_containment_unit")
        .itemOutputs("gtlcecore:chaos_containment_unit")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(20)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:neutronium_gearbox")
        .itemInputs("4x gtceu:neutronium_plate", "2x gtceu:neutronium_gear", "gtceu:neutronium_frame")
        .itemOutputs("2x gtlcecore:neutronium_gearbox")
        .EUt(16)
        .duration(50)
        .circuit(4)

    gtr.precision_assembler("gtlcecore:annihilation_constrainer")
        .itemInputs("gtlcecore:hypercube", "8x gtlcecore:contained_reissner_nordstrom_singularity", "4x #gtceu:circuits/uxv", "16x gtceu:cosmicneutronium_foil")
        .inputFluids("gtceu:cinobite 1152", "gtceu:neutronium_doped_nanotubes 2000")
        .itemOutputs("gtlcecore:annihilation_constrainer")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(800)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:neutronium_antimatter_fuel_rod")
        .itemInputs("64x gtlcecore:pellet_antimatter", "gtlcecore:annihilation_constrainer")
        .inputFluids("gtceu:liquid_hydrogen 200000", "gtceu:zylon 100", "gtceu:neutronium 100")
        .itemOutputs("gtlcecore:neutronium_antimatter_fuel_rod")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(2000)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.precision_assembler("gtlcecore:draconium_antimatter_fuel_rod")
        .itemInputs("64x gtlcecore:pellet_antimatter", "64x gtlcecore:pellet_antimatter", "gtlcecore:annihilation_constrainer")
        .inputFluids("gtceu:liquid_hydrogen 200000", "gtceu:fullerene_polymer_matrix_pulp 100", "gtceu:draconium 100")
        .itemOutputs("gtlcecore:draconium_antimatter_fuel_rod")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(2000)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.precision_assembler("gtlcecore:cosmicneutronium_antimatter_fuel_rod")
        .itemInputs("64x gtlcecore:pellet_antimatter", "64x gtlcecore:pellet_antimatter", "64x gtlcecore:pellet_antimatter", "gtlcecore:annihilation_constrainer")
        .inputFluids("gtceu:liquid_hydrogen 200000", "gtceu:radox 100", "gtceu:cosmicneutronium 100")
        .itemOutputs("gtlcecore:cosmicneutronium_antimatter_fuel_rod")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(2000)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.precision_assembler("gtlcecore:infinity_antimatter_fuel_rod")
        .itemInputs("64x gtlcecore:pellet_antimatter", "64x gtlcecore:pellet_antimatter", "64x gtlcecore:pellet_antimatter", "gtlcecore:annihilation_constrainer")
        ...
        .itemOutputs("gtlcecore:infinity_antimatter_fuel_rod")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(2000)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.precision_assembler("gtlcecore:reinforced_echo_shard")
        .itemInputs("4x gtceu:echo_shard_plate", "4x gtlcecore:echobone", "2x minecraft:netherite_scrap", "gtceu:double_echoite_plate")
        .inputFluids("gtceu:liquid_hydrogen 8000", "gtceu:echoite_plasma 1000")
        .itemOutputs("gtlcecore:reinforced_echo_shard")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(200)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.assembler("gtlcecore:graviton_field_constraint_casing")
        .itemInputs("gtceu:draconium_frame", "gtlcecore:annihilation_constrainer", "gtceu:neutronium_nanoswarm", "gtceu:celestialtungsten_gear", "4x gtceu:double_adamantium_plate")
        .inputFluids("gtceu:neutronium 288")
        .itemOutputs("2x gtlcecore:graviton_field_constraint_casing")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(100)

    gtr.assembler("gtlcecore:laser_cooling_casing")
        .itemInputs("gtceu:hsse_frame", "gtlcecore:laser_cooling_unit", "2x gtlcecore:uhv_voltage_coil", "6x gtceu:zirconium_carbide_plate", "2x gtceu:double_fluxed_electrum_plate", "4x gtceu:double_zeron_100_plate")
        .inputFluids("gtceu:soldering_alloy 576")
        .itemOutputs("gtlcecore:laser_cooling_casing")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(200)

    gtr.dimensionally_transcendent_plasma_forge("gtlcecore:hypercube")
        .itemInputs("12x gtceu:cosmicneutronium_rod", "24x gtceu:celestialtungsten_rod")
        .inputFluids("gtceu:exciteddtec 1000")
        .itemOutputs("gtlcecore:hypercube")
    ...
    gtr.mixer("gtceu:dimensionallytranscendentcrudecatalyst")
        .itemInputs("gtlcecore:resonating_gem")
    ...
    gtr.stellar_forge("gtceu:exciteddtec")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge")
    ...
    gtr.annihilate_generator("gtlcecore:neutronium_antimatter_fuel_rod")
        .itemInputs("gtlcecore:neutronium_antimatter_fuel_rod")
        .chancedOutput("gtlcecore:annihilation_constrainer", 9000, 0)
        .duration(200)
        .EUt(-GTValues.V[GTValues.MAX] * 256)

    gtr.annihilate_generator("gtlcecore:draconium_antimatter_fuel_rod")
        .itemInputs("gtlcecore:draconium_antimatter_fuel_rod")
        .chancedOutput("gtlcecore:annihilation_constrainer", 8000, 0)
        .duration(200)
        .EUt(-GTValues.V[GTValues.MAX] * 4096)

    gtr.annihilate_generator("gtlcecore:cosmicneutronium_antimatter_fuel_rod")
        .itemInputs("gtlcecore:cosmicneutronium_antimatter_fuel_rod")
        .chancedOutput("gtlcecore:annihilation_constrainer", 7000, 0)
        .duration(200)
        .EUt(-GTValues.V[GTValues.MAX] * 65536)

    gtr.annihilate_generator("gtlcecore:infinity_antimatter_fuel_rod")
        .itemInputs("gtlcecore:infinity_antimatter_fuel_rod")
        .chancedOutput("gtlcecore:annihilation_constrainer", 6000, 0)
        .duration(200)
        .EUt(-GTValues.V[GTValues.MAX] * 1048576)

    gtr.assembler("gtlcecore:fishing_ground")
        ...
        .inputFluids("gtceu:soldering_alloy 576")
        .itemOutputs("gtlcecore:fishing_ground")
        .EUt(480)
        .duration(400)

    gtr.assembler("gtlcecore:extreme_strength_tritanium_casing")
        .itemInputs("gtceu:tritanium_frame", "6x gtceu:tritanium_plate")
        .itemOutputs("2x gtlcecore:extreme_strength_tritanium_casing")
        .circuit(6)
        .EUt(16)
        .duration(50)

    gtr.assembler("gtlcecore:aluminium_bronze_casing")
        .itemInputs("gtceu:aluminium_bronze_frame", "6x gtceu:aluminium_bronze_plate")
        .itemOutputs("2x gtlcecore:aluminium_bronze_casing")
        .circuit(6)
        .EUt(16)
        .duration(50)

    gtr.assembler("gtlcecore:hyper_mechanical_casing")
        .itemInputs("gtceu:naquadah_alloy_frame", "6x gtceu:naquadria_plate")
        .itemOutputs("2x gtlcecore:hyper_mechanical_casing")
        .circuit(6)
        .EUt(16)
        .duration(50)

    gtr.assembler("gtlcecore:enhance_hyper_mechanical_casing")
        ...
        .itemOutputs("2x gtlcecore:enhance_hyper_mechanical_casing")
        .inputFluids("gtceu:naquadria 576")
        .circuit(6)
        .EUt(16)
        .duration(50)

    gtr.assembler("gtlcecore:dimensionally_transcendent_casing")
        .itemInputs("gtceu:mithril_frame", "2x gtlcecore:dimension_injection_casing", "2x gtlcecore:molecular_casing", "gtceu:iv_quantum_chest", "gtceu:iv_quantum_tank", "12x gtceu:adamantium_bolt", "gtceu:enderite_single_wire", "6x gtceu:palladium_plate", "6x gtceu:osmiridium_plate")
        .itemOutputs("2x gtlcecore:dimensionally_transcendent_casing")
        .inputFluids("gtceu:liquid_degenerate_rhenium 200")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(200)

    gtr.assembler("gtlcecore:uruium_coil_block")
        ...
        .itemOutputs("gtlcecore:uruium_coil_block")
    ...
    gtr.mixer("gtceu:concentration_mixing_hyper_fuel_2")
        .itemInputs("gtceu:starmetal_dust", "gtlcecore:draconium_dust")
    ...
    gtr.centrifuge("nuclear_waste")
        .itemInputs("gtlcecore:nuclear_waste")
    ...
    //radox
    gtr.incubator("gtlcecore:variation_wood")
        .itemInputs("64x gtlcecore:barnarda_log", "16x minecraft:crimson_stem", "64x #forge:dusts/wood", "gtceu:lapotron_dust")
        .inputFluids("gtceu:unknowwater 10000", "gtceu:biomass 1000")
        .itemOutputs("64x gtlcecore:variation_wood")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(2400)

    gtr.incubator("gtlcecore:variation_wood1")
        .itemInputs("64x gtlcecore:barnarda_log", "16x minecraft:warped_stem", "64x #forge:dusts/wood", "gtceu:lapotron_dust")
        .inputFluids("gtceu:unknowwater 10000", "gtceu:biomass 1000")
        .itemOutputs("64x gtlcecore:variation_wood")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(2400)
    ...
    gtr.pyrolyse_oven("gtceu:rawradox")
        ...
        .itemInputs("16x gtlcecore:variation_wood")
    ...
    gtr.electric_blast_furnace("gtceu:hot_draconium_ingot_1")
        .itemInputs("gtlcecore:draconium_dust")
    ...
    gtr.canner("gtlcecore:infused_breath")
        .inputFluids("gtceu:xpjuice 1000")
        .itemInputs("minecraft:dragon_breath")
        .itemOutputs("gtlcecore:infused_breath")
        .EUt(480)
        .duration(400)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.extractor("gtceu:dragon_breath")
        .itemInputs("gtlcecore:infused_breath")
    ...
    gtr.sps_crafting("gtlcecore:dragon_stem_cells")
        .itemInputs("gtceu:stem_cells")
        .inputFluids("gtceu:mana 1000", "gtceu:mutagen 100", "gtceu:enriched_dragon_breath 100")
        .itemOutputs("gtlcecore:dragon_stem_cells")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)

    gtr.incubator("gtlcecore:dragon_cells")
        .itemInputs("64x gtlcecore:dragon_stem_cells", "16x gtceu:naquadria_dust")
        .inputFluids("gtceu:biohmediumsterilized 10000", "gtceu:mutagen 10000")
        .itemOutputs("64x gtlcecore:dragon_cells")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1600)

    gtr.brewery("gtceu:dragon_blood")
        .itemInputs("gtlcecore:dragon_cells")
    ...
    gtr.chemical_bath("gtceu:kevlar_plate")
        .itemInputs("gtlcecore:woven_kevlar")
    ...
    gtr.assembler("gtlcecore:woven_kevlar")
        .itemInputs("8x gtlcecore:kevlar_fiber")
        .itemOutputs("gtlcecore:woven_kevlar")
        .circuit(8)
        .EUt(120)
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.fluid_solidifier("gtlcecore:kevlar_fiber")
        .notConsumable("gtceu:nugget_casting_mold")
        .inputFluids("gtceu:liquidcrystalkevlar 72")
        .itemOutputs("gtlcecore:kevlar_fiber")
        .EUt(30)
        .duration(800)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.chemical_bath("gtlcecore:resonating_gem")
        .itemInputs("gtceu:exquisite_sapphire_gem")
        .inputFluids("gtceu:liquid_starlight 1000")
        .itemOutputs("gtlcecore:resonating_gem")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.assembler("gtlcecore:highly_dense_polymer_plate")
        ...
        .itemOutputs("gtlcecore:highly_dense_polymer_plate")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(350)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.stellar_forge("gtceu:cosmic_mesh_plasma")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "gtlcecore:highly_dense_polymer_plate")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtceu:chaos_plasma")
        .itemInputs("gtlcecore:chaos_shard")
    ...
    gtr.canner("gtlcecore:cosmic_mesh_containment_unit")
        .notConsumable("gtceu:uruium_nanoswarm")
        .itemInputs("gtlcecore:time_dilation_containment_unit")
        .inputFluids("gtceu:cosmic_mesh_plasma 1000")
        .itemOutputs("gtlcecore:cosmic_mesh_containment_unit")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(20)

    gtr.plasma_condenser("gtceu:cosmic_mesh")
        .itemInputs("gtlcecore:cosmic_mesh_containment_unit")
    ...
    gtr.sps_crafting("gtlcecore:cosmic_fabric")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .inputFluids("gtceu:mana 1000", "gtceu:enriched_xenoxene 1000", "gtceu:liquid_cosmic_mesh 100")
        .itemInputs("gtceu:rubber_foil", "gtlcecore:amorphous_matter")
        .itemOutputs("gtlcecore:cosmic_fabric")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
    ...
    gtr.dimensionally_transcendent_plasma_forge("avaritia:infinity_catalyst")
        .itemInputs("64x gtlcecore:contained_exotic_matter", "64x gtlcecore:essentia_matter")
        .inputFluids("gtceu:infinity 1000", "gtceu:high_energy_quark_gluon_plasma 100000")
        .itemOutputs("avaritia:infinity_catalyst", "64x gtlcecore:time_dilation_containment_unit")
        .outputFluids("gtceu:dimensionallytranscendentresidue 100")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(4800)
        .blastFurnaceTemp(32000)
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtceu:transcendentmetal")
        .notConsumable("gtlcecore:spacetime_catalyst")
        .itemInputs("gtlcecore:hypercube")
    ...
    gtr.autoclave("gtlcecore:spacetime_catalyst")
        .itemInputs("avaritia:infinity_catalyst")
        .inputFluids("gtceu:spacetime 1000")
        .itemOutputs("gtlcecore:spacetime_catalyst")
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(1200)

    gtr.chemical_bath("gtlcecore:eternity_catalyst")
        .itemInputs("gtlcecore:spacetime_catalyst")
        .inputFluids("gtceu:eternity 1000")
        .itemOutputs("gtlcecore:eternity_catalyst")
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(1600)
    ...
    //optical
    gtr.forming_press("gtlcecore:optical_soc_containment_housing")
        ...
        .itemOutputs("gtlcecore:optical_soc_containment_housing")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(290)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:optical_soc")
        .itemInputs("gtlcecore:optical_soc_containment_housing", "gtlcecore:optical_slice", "8x gtceu:gold_bolt", "8x gtceu:fine_zinc_wire")
        .inputFluids("gtceu:lumiium 144", "gtceu:mutated_living_solder 144", "gtceu:soldering_alloy 288", "gtceu:helium 100")
        .itemOutputs("gtlcecore:optical_soc")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.canner("gtlcecore:bose_einstein_cooling_container")
        .notConsumable("gtceu:iridium_nanoswarm")
        .inputFluids("gtceu:rubidium 288")
        .itemInputs("gtlcecore:empty_laser_cooling_container")
        .itemOutputs("gtlcecore:bose_einstein_cooling_container")
        .EUt(90000)
        .duration(280)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.assembler("gtlcecore:low_frequency_laser")
        .itemInputs("gtceu:red_garnet_rod", "gtlcecore:red_halide_lamp", "gtlcecore:highly_reflective_mirror", "gtlcecore:non_linear_optical_lens", "gtlcecore:smd_diode_optical")
        .itemOutputs("gtlcecore:low_frequency_laser")
        .inputFluids("gtceu:soldering_alloy 576")
        .EUt(491520)
        .duration(320)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:medium_frequency_laser")
        .itemInputs("gtceu:lazurite_rod", "gtlcecore:green_halide_lamp", "gtlcecore:highly_reflective_mirror", "gtlcecore:non_linear_optical_lens", "gtlcecore:smd_diode_optical")
        .itemOutputs("gtlcecore:medium_frequency_laser")
        .inputFluids("gtceu:soldering_alloy 576")
        .EUt(491520)
        .duration(320)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:high_frequency_laser")
        .itemInputs("gtceu:amethyst_rod", "gtlcecore:blue_halide_lamp", "gtlcecore:highly_reflective_mirror", "gtlcecore:non_linear_optical_lens", "gtlcecore:smd_diode_optical")
        .itemOutputs("gtlcecore:high_frequency_laser")
        .inputFluids("gtceu:soldering_alloy 576")
        .EUt(491520)
        .duration(320)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:ballast")
        .itemInputs("2x gtceu:fine_annealed_copper_wire", "gtceu:resistor", "gtceu:inductor", "gtceu:double_annealed_copper_plate")
        .itemOutputs("gtlcecore:ballast")
        .inputFluids("gtceu:soldering_alloy 144")
        .EUt(1920)
        .duration(290)

    gtr.assembler("gtlcecore:laser_diode")
        .itemInputs("2x gtceu:fine_gold_wire", "gtlcecore:smd_diode_bioware", "gtceu:amethyst_lens", "gtceu:double_nichrome_plate")
        .itemOutputs("gtlcecore:laser_diode")
        .inputFluids("gtceu:soldering_alloy 288")
        .EUt(980000)
        .duration(260)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:laser_cooling_unit")
        .itemInputs("4x gtceu:fine_gold_wire", "gtceu:frostproof_machine_casing", "gtlcecore:laser_diode", "#gtceu:circuits/hv")
        .itemOutputs("gtlcecore:laser_cooling_unit")
        .inputFluids("gtceu:soldering_alloy 288")
        .EUt(1200000)
        .duration(300)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:empty_laser_cooling_container")
        .itemInputs("8x gtceu:steel_plate", "gtlcecore:laser_cooling_unit", "gtlcecore:magnetic_trap", "2x gtceu:double_magnalium_plate")
        .itemOutputs("gtlcecore:empty_laser_cooling_container")
        .inputFluids("gtceu:soldering_alloy 144")
        .EUt(1150000)
        .duration(380)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:magnetic_trap")
        ...
        .itemOutputs("gtlcecore:magnetic_trap")
        .inputFluids("gtceu:soldering_alloy 432")
        .EUt(1000000)
        .duration(480)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:red_halide_lamp")
        .itemInputs("2x gtceu:electrum_foil", "gtceu:potassium_bromide_dust", "4x gtceu:strontium_europium_aluminate_dust", "2x gtceu:cubic_zirconia_plate", "4x gtceu:maraging_steel_300_rod", "2x gtceu:borosilicate_glass_ingot", "gtlcecore:ballast", "gtceu:glass_tube", "2x gtceu:molybdenum_foil")
        .itemOutputs("gtlcecore:red_halide_lamp")
        .inputFluids("gtceu:nitrogen 1000")
        .EUt(7680)
        .duration(110)

    gtr.assembler("gtlcecore:green_halide_lamp")
        .itemInputs("2x gtceu:electrum_foil", "gtceu:iridium_chloride_dust", "4x gtceu:strontium_europium_aluminate_dust", "2x gtceu:cubic_zirconia_plate", "4x gtceu:maraging_steel_300_rod", "2x gtceu:borosilicate_glass_ingot", "gtlcecore:ballast", "gtceu:glass_tube", "2x gtceu:molybdenum_foil")
        .itemOutputs("gtlcecore:green_halide_lamp")
        .inputFluids("gtceu:nitrogen 1000")
        .EUt(7680)
        .duration(110)

    gtr.assembler("gtlcecore:blue_halide_lamp")
        .itemInputs("2x gtceu:electrum_foil", "gtceu:titanium_trifluoride_dust", "4x gtceu:strontium_europium_aluminate_dust", "2x gtceu:cubic_zirconia_plate", "4x gtceu:maraging_steel_300_rod", "2x gtceu:borosilicate_glass_ingot", "gtlcecore:ballast", "gtceu:glass_tube", "2x gtceu:molybdenum_foil")
        .itemOutputs("gtlcecore:blue_halide_lamp")
        .inputFluids("gtceu:nitrogen 1000")
        .EUt(7680)
        .duration(110)
    ...
    gtr.chemical_reactor("gtlcecore:highly_reflective_mirror")
        .itemInputs("gtceu:germanium_plate")
        .inputFluids("gtceu:hydrogen_sulfide 1000", "gtceu:zinc 144")
        .itemOutputs("gtlcecore:highly_reflective_mirror")
        .EUt(710000)
        .duration(240)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.autoclave("gtlcecore:periodically_poled_lithium_niobate_boule")
        .notConsumable("gtlcecore:electron_source")
        .itemInputs("2x gtceu:lithium_niobate_nanoparticles_dust")
        .inputFluids("gtceu:xenon 1000")
        .itemOutputs("gtlcecore:periodically_poled_lithium_niobate_boule")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:electron_source")
        ...
        .inputFluids("gtceu:soldering_alloy 144")
        .itemOutputs("gtlcecore:electron_source")
        .EUt(750000)
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:rotating_transparent_surface")
        .itemInputs("4x gtceu:graphene_plate", "gtceu:uhv_electric_motor")
        .inputFluids("gtceu:soldering_alloy 144")
        .itemOutputs("gtlcecore:rotating_transparent_surface")
        .EUt(1250000)
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.lathe("gtlcecore:non_linear_optical_lens")
        .itemInputs("gtlcecore:periodically_poled_lithium_niobate_boule")
        .itemOutputs("gtlcecore:non_linear_optical_lens")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(360)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.cutter("gtlcecore:optical_slice")
        .itemInputs("gtlcecore:optical_wafer")
        .itemOutputs("16x gtlcecore:optical_slice")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(560)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.large_chemical_reactor("gtlcecore:optical_wafer")
        .itemInputs("2x gtceu:francium_caesium_cadmium_bromide_dust", "gtlcecore:photon_carrying_wafer", "gtceu:glowstone_nanoswarm")
        .inputFluids("gtceu:seaborgium_doped_nanotubes 144", "gtceu:carbon_nanotubes 144")
        .itemOutputs("gtlcecore:optical_wafer")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.chemical_bath("gtlcecore:photon_carrying_wafer")
        .itemInputs("gtlcecore:raw_photon_carrying_wafer")
        .inputFluids("gtceu:blaze 288")
        .itemOutputs("gtlcecore:photon_carrying_wafer")
        .EUt(1920)
        .duration(800)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    //exotic
    gtr.laser_engraver("gtlcecore:exotic_wafer")
        .notConsumable("gtceu:magenta_glass_lens")
        .itemInputs("gtceu:highly_advanced_soc_wafer")
        .itemOutputs("gtlcecore:exotic_wafer")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:exotic_chip")
        .itemInputs("gtlcecore:exotic_wafer")
        .itemOutputs("4x gtlcecore:exotic_chip")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:x_ray_laser")
        .itemInputs("gtlcecore:x_ray_waveguide", "gtlcecore:microfocus_x_ray_tube", "gtceu:exquisite_jasper_gem", "gtlcecore:x_ray_mirror_plate")
        .itemOutputs("gtlcecore:x_ray_laser")
    ...
    gtr.chemical_bath("gtlcecore:x_ray_waveguide")
        .itemInputs("gtlcecore:fullerene_polymer_matrix_fine_tubing")
        .inputFluids("gtceu:iridium_trichloride_solution 100")
        .itemOutputs("gtlcecore:x_ray_waveguide")
        .EUt(8000000)
        .duration(240)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:rydberg_spinorial_assembly")
        .itemInputs("gtlcecore:cryogenic_interface",
            "gtlcecore:rotating_transparent_surface",
            "gtlcecore:exotic_chip",
            "gtlcecore:x_ray_waveguide")
        .notConsumableFluid("gtceu:xenon 10")
        .inputFluids("gtceu:quantum_dots 10", "gtceu:zylon 144", "gtceu:liquid_hydrogen 10")
        .itemOutputs("gtlcecore:rydberg_spinorial_assembly")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(560)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:cryogenic_interface")
        ...
        .itemOutputs("gtlcecore:cryogenic_interface")
        .EUt(8000)
        .duration(160)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    //cosmic
    gtr.sps_crafting("gtlcecore:photocoated_hassium_boule")
        .itemInputs("gtceu:silicon_boule", "2x gtceu:hassium_ingot", "gtlcecore:hassium_seed_crystal")
        .inputFluids("gtceu:mana 10000", "gtceu:woods_glass 2304", "gtceu:photopolymer 2000")
        .itemOutputs("gtlcecore:photocoated_hassium_boule")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(1000)

    gtr.cutter("gtlcecore:photocoated_hassium_wafer")
        .itemInputs("gtlcecore:photocoated_hassium_boule")
        .itemOutputs("4x gtlcecore:photocoated_hassium_wafer")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(280)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:lithography_mask")
        ...
        .itemOutputs("gtlcecore:lithography_mask")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1200)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.assembler("gtlcecore:grating_lithography_mask")
        .itemInputs("gtlcecore:lithography_mask", "gtceu:glass_lens")
        .itemOutputs("gtlcecore:grating_lithography_mask")
        .EUt(1920)
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.laser_engraver("gtlcecore:diffractor_grating_mirror")
        .itemInputs("gtlcecore:photocoated_hassium_wafer")
        .notConsumable("gtlcecore:grating_lithography_mask")
        .itemOutputs("gtlcecore:diffractor_grating_mirror")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.precision_assembler("gtlcecore:cosmic_processing_unit_core")
        .itemInputs("6x gtceu:fine_heavy_quark_degenerate_matter_wire", "4x gtlcecore:cosmic_soc", "3x gtceu:degenerate_rhenium_plate", "gtlcecore:empty_laser_cooling_container")
        ...
        .itemOutputs("gtlcecore:cosmic_processing_unit_core")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(3500)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.assembler("gtlcecore:ultrashort_pulse_laser")
        .itemInputs("4x gtlcecore:diffractor_grating_mirror", "8x gtceu:fine_borosilicate_glass_wire", "gtlcecore:high_frequency_laser", "2x gtlcecore:insulation_wire_assembly", "gtceu:yellow_garnet_rod", "gtceu:lapis_rod", "gtceu:exquisite_olivine_gem", "gtceu:ev_emitter", "gtceu:double_platinum_plate")
        .inputFluids("gtceu:soldering_alloy 288")
        .itemOutputs("gtlcecore:ultrashort_pulse_laser")
        .EUt(45000000)
        .duration(270)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:insulation_wire_assembly")
        .itemInputs("gtceu:reinforced_epoxy_resin_rod", "gtlcecore:aerographene", "gtlcecore:highly_insulating_foil", "gtlcecore:memory_foam_block", "gtceu:fullerene_polymer_matrix_pulp_foil")
        .inputFluids("gtceu:polyimide 144")
        .itemOutputs("gtlcecore:insulation_wire_assembly")
        .EUt(480)
        .duration(200)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.chemical_bath("gtlcecore:highly_insulating_foil")
        .itemInputs("gtceu:polyetheretherketone_foil")
        .inputFluids("gtceu:azafullerene 10")
        .itemOutputs("gtlcecore:highly_insulating_foil")
        .EUt(7680)
        .duration(70)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.assembler("gtlcecore:graviton_transducer")
        .itemInputs("2x gtlcecore:quantumchromodynamic_protective_plating", "gtlcecore:contained_reissner_nordstrom_singularity", "gtlcecore:microwormhole_generator", "gtlcecore:dark_matter", "gtceu:uiv_sensor")
        .inputFluids("gtceu:neutronium 144")
        .itemOutputs("gtlcecore:graviton_transducer")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:topological_manipulator_unit")
        .itemInputs("2x gtlcecore:quantumchromodynamic_protective_plating", "gtlcecore:contained_kerr_newmann_singularity", "gtlcecore:microwormhole_generator", "gtceu:uhv_field_generator")
        .inputFluids("gtceu:antineutron 10", "gtceu:neutronium 144", "gtceu:arceusalloy2b 144", "gtceu:nitrogen 10000")
        .itemOutputs("gtlcecore:topological_manipulator_unit")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(1800)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler_module("gtlcecore:relativistic_spinorial_memory_system")
        .itemInputs("2x gtceu:neutron_reflector", "gtlcecore:rydberg_spinorial_assembly", "4x gtlcecore:charged_lepton_trap_crystal", "2x gtceu:legendarium_single_wire", "gtceu:uhv_field_generator", "gtceu:uiv_sensor", "gtceu:fusion_coil")
        .inputFluids("gtceu:uu_matter 10000", "gtceu:noble_gas 2000", "gtceu:cosmic_computing_mixture 1000", "gtceu:neutronium 1296")
        .itemOutputs("gtlcecore:relativistic_spinorial_memory_system")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .addData("SEPMTier", 4)

    gtr.assembler_module("gtlcecore:microwormhole_generator")
        .itemInputs("2x gtceu:zpm_emitter", "2x gtceu:enriched_naquadah_trinium_europium_duranide_single_wire", "2x gtceu:neutronium_plate", "gtceu:zpm_field_generator", "gtlcecore:contained_kerr_singularity", "gtlcecore:void_matter", "gtceu:enderium_nanoswarm", "2x gtceu:celestialtungsten_plate")
        .inputFluids("gtceu:tritanium 576")
        .itemOutputs("gtlcecore:microwormhole_generator")
        .EUt(100000)
        .duration(200)
        .addData("SEPMTier", 4)

    gtr.assembler_module("gtlcecore:nuclear_clock")
        .itemInputs("2x gtceu:uiv_sensor", "2x gtlcecore:ultrashort_pulse_laser", "2x gtceu:neutronium_plate", "gtlcecore:scintillator", "gtlcecore:bose_einstein_cooling_container", "gtceu:iron_nanoswarm", "gtceu:uv_naquadria_battery", "2x gtceu:double_rhodium_plate")
        .inputFluids("gtceu:thorium 144", "gtceu:black_titanium 1296")
        .itemOutputs("gtlcecore:nuclear_clock")
        .EUt(33550000)
        .duration(1600)
        .addData("SEPMTier", 3)

    gtr.autoclave("gtlcecore:contained_kerr_singularity")
        .notConsumable("gtceu:vibranium_nanoswarm")
        .itemInputs("gtlcecore:contained_kerr_newmann_singularity")
        .inputFluids("gtceu:free_electron_gas 1000")
        .itemOutputs("gtlcecore:contained_kerr_singularity")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler_module("gtlcecore:macrowormhole_generator")
        .itemInputs("4x gtceu:uv_emitter", "4x gtceu:uv_sensor", "2x gtceu:uv_field_generator", "gtlcecore:contained_high_density_protonic_matter", "gtlcecore:microwormhole_generator", "gtlcecore:contained_kerr_singularity", "gtceu:zpm_naquadria_battery", "gtlcecore:kinetic_matter")
        .inputFluids("gtceu:naquadah_alloy 576")
        .itemOutputs("gtlcecore:macrowormhole_generator")
        .EUt(1000000)
        .duration(400)
        .addData("SEPMTier", 4)

    gtr.assembler_module("gtlcecore:stabilized_wormhole_generator")
        .itemInputs("4x gtceu:uev_emitter", "4x gtceu:uev_sensor", "2x gtceu:uev_field_generator", "gtlcecore:contained_exotic_matter", "gtlcecore:macrowormhole_generator", "gtlcecore:contained_kerr_singularity", "gtceu:energy_cluster", "gtlcecore:omni_matter")
        .inputFluids("gtceu:naquadah_alloy 576")
        .itemOutputs("gtlcecore:stabilized_wormhole_generator")
        .EUt(10000000)
        .duration(800)
        .addData("SEPMTier", 4)

    gtr.precision_assembler("gtlcecore:ctc_guidance_unit")
        .itemInputs("64x gtlcecore:cosmic_ram_chip", "gtlcecore:supracausal_processing_core", "gtceu:data_module", "gtlcecore:nuclear_clock")
        ...
        .itemOutputs("gtlcecore:ctc_guidance_unit")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(1600)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler_module("gtlcecore:ctc_computational_unit_container")
        .itemInputs("36x gtceu:enriched_naquadah_plate", "36x gtceu:fullerene_polymer_matrix_pulp_plate", "6x gtceu:heavy_quark_degenerate_matter_plate", "3x gtceu:uhv_field_generator", "2x gtceu:taranium_plate", "gtlcecore:ctc_guidance_unit", "gtlcecore:manifold_oscillatory_power_cell", "4x gtceu:double_uranium_plate", "gtceu:dense_darmstadtium_plate", "gtceu:neutronium_frame", "gtlcecore:time_dilation_containment_unit", "gtlcecore:stabilized_wormhole_generator", "2x gtlcecore:dark_matter", "gtceu:starmetal_nanoswarm", "8x gtceu:double_black_dwarf_mtter_plate", "8x gtceu:double_trinium_plate")
    ...
    overworld_fluids.forEach((overworld_fluid) => {
        gtr.void_fluid_drilling_rig("overworld_fluid_" + overworld_fluid[1])
            .notConsumable("gtlcecore:overworld_data")
    ...
    nether_fluids.forEach((nether_fluid) => {
        gtr.void_fluid_drilling_rig("nether_fluid_" + nether_fluid[1])
            .notConsumable("2x gtlcecore:nether_data")
    ...
    end_raw_ores.forEach((end_ore) => {
        let recipe = gtr.void_miner("end_void_ore_" + end_ore[1])
            ...
            .notConsumable("4x gtlcecore:end_data")
            .circuit(end_ore[1])
            .EUt(GTValues.VA[GTValues.IV])
            .duration(20)
    ...
    const overworld_vs =
        [[["6x #forge:ores/bentonite",
            ...
            "2x #forge:ores/glauconite_sand"], "gtlcecore:olivine_vein_essence"],

        [["18x #forge:ores/almandine",
            "12x #forge:ores/pyrope",
            "6x #forge:ores/sapphire",
            "6x #forge:ores/green_sapphire"], "gtlcecore:sapphire_vein_essence"],

        [["6x #forge:ores/goethite",
            "24x #forge:ores/yellow_limonite",
            "24x #forge:ores/hematite",
            "12x #forge:ores/malachite"], "gtlcecore:iron_vein_essence"],

        [["12x #forge:ores/soapstone",
            "8x #forge:ores/talc",
            "8x #forge:ores/glauconite_sand",
            "4x #forge:ores/pentlandite"], "gtlcecore:lubricant_vein_essence"],

        [["6x #forge:ores/grossular",
            "4x #forge:ores/spessartine",
            "4x #forge:ores/pyrolusite",
            "2x #forge:ores/tantalite"], "gtlcecore:manganese_vein_ow_essence"],

        [["25x #forge:ores/chalcopyrite",
            "1x #forge:ores/zeolite",
            "1x #forge:ores/cassiterite",
            "5x #forge:ores/realgar"], "gtlcecore:copper_tin_vein_essence"],

        [["24x #forge:ores/coal"], "gtlcecore:coal_vein_essence"],

        [["4x #forge:ores/chalcopyrite",
            "16x #forge:ores/iron",
            "16x #forge:ores/pyrite",
            "16x #forge:ores/copper"], "gtlcecore:copper_vein_essence"],

        [["24x #forge:ores/magnetite",
            "16x #forge:ores/vanadium_magnetite",
            "8x #forge:ores/gold"], "gtlcecore:magnetite_vein_ow_essence"],

        [["12x #forge:ores/lazurite",
            "8x #forge:ores/sodalite",
            "8x #forge:ores/lapis",
            "4x #forge:ores/calcite"], "gtlcecore:lapis_vein_essence"],

        [["12x #forge:ores/galena",
            "8x #forge:ores/silver",
            "4x #forge:ores/lead"], "gtlcecore:galena_vein_essence"],

        [["6x #forge:ores/kyanite",
            "4x #forge:ores/mica",
            "4x #forge:ores/bauxite",
            "2x #forge:ores/pollucite"], "gtlcecore:mica_vein_essence"],

        [["32x #forge:ores/tin",
            "16x #forge:ores/cassiterite"], "gtlcecore:cassiterite_vein_essence"],

        [["12x #forge:ores/red_garnet",
            "8x #forge:ores/yellow_garnet",
            "8x #forge:ores/amethyst",
            "4x #forge:ores/opal"], "gtlcecore:garnet_vein_essence"],

        [["24x #forge:ores/basaltic_mineral_sand",
            "16x #forge:ores/granitic_mineral_sand",
            "16x #forge:ores/fullers_earth",
            "8x #forge:ores/gypsum"], "gtlcecore:mineral_sand_vein_essence"],

        [["15x #forge:ores/rock_salt",
            "1x #forge:ores/salt",
            "5x #forge:ores/lepidolite",
            "5x #forge:ores/spodumene"], "gtlcecore:salts_vein_essence"],

        [["18x #forge:ores/redstone",
            "12x #forge:ores/ruby",
            "6x #forge:ores/cinnabar"], "gtlcecore:redstone_vein_ow_essence"],

        [["12x #forge:ores/apatite",
            "8x #forge:ores/tricalcium_phosphate",
            "4x #forge:ores/pyrochlore"], "gtlcecore:apatite_vein_essence"],

        [["24x #forge:ores/cassiterite_sand",
            "16x #forge:ores/garnet_sand",
            "16x #forge:ores/asbestos",
            "8x #forge:ores/diatomite"], "gtlcecore:garnet_tin_vein_essence"],

        [["24x #forge:ores/oilsands"], "gtlcecore:oilsands_vein_essence"],

        [["12x #forge:ores/graphite",
            "8x #forge:ores/diamond"], "gtlcecore:diamond_vein_essence"],

        [["12x #forge:ores/garnierite",
            "8x #forge:ores/nickel",
            "8x #forge:ores/cobaltite",
            "4x #forge:ores/pentlandite"], "gtlcecore:nickel_vein_essence"]]

    overworld_vs.forEach((overworld_v) => {
        gtr.incubator("overworld_e_" + overworld_v[1])
            .notConsumable("16x gtlcecore:overworld_data")
            .itemInputs("gtlcecore:essence_seed")
    ...
    const nether_vs =
        [[["28x #forge:ores/tetrahedrite",
            ...
            "7x #forge:ores/stibnite"], "gtlcecore:tetrahedrite_vein_essence"],

        [["9x #forge:ores/bastnasite",
            "3x #forge:ores/molybdenum",
            "3x #forge:ores/neodymium"], "gtlcecore:monazite_vein_essence"],

        [["18x #forge:ores/redstone",
            "12x #forge:ores/ruby",
            "6x #forge:ores/cinnabar"], "gtlcecore:redstone_vein_essence"],

        [["12x #forge:ores/saltpeter",
            "8x #forge:ores/diatomite",
            "8x #forge:ores/electrotine",
            "4x #forge:ores/alunite"], "gtlcecore:saltpeter_vein_essence"],

        [["9x #forge:ores/beryllium",
            "12x #forge:ores/emerald"], "gtlcecore:beryllium_vein_essence"],

        [["6x #forge:ores/grossular",
            "4x #forge:ores/pyrolusite",
            "2x #forge:ores/tantalite"], "gtlcecore:manganese_vein_essence"],

        [["15x #forge:ores/wulfenite",
            "1x #forge:ores/molybdenite",
            "5x #forge:ores/molybdenum",
            "5x #forge:ores/powellite"], "gtlcecore:molybdenum_vein_essence"],

        [["9x #forge:ores/goethite",
            "6x #forge:ores/yellow_limonite",
            "6x #forge:ores/hematite",
            "3x #forge:ores/gold"], "gtlcecore:banded_iron_vein_essence"],

        [["12x #forge:ores/quartzite",
            "8x #forge:ores/certus_quartz",
            "4x #forge:ores/barite"], "gtlcecore:certus_quartz_essence"],

        [["21x #forge:ores/blue_topaz",
            "14x #forge:ores/topaz",
            "14x #forge:ores/chalcocite",
            "7x #forge:ores/bornite"], "gtlcecore:topaz_vein_essence"],

        [["24x #forge:ores/nether_quartz",
            "8x #forge:ores/quartzite",
            "5x minecraft:ancient_debris"], "gtlcecore:nether_quartz_vein_essence"],

        [["3x #forge:ores/sulfur",
            "2x #forge:ores/pyrite",
            "1x #forge:ores/sphalerite"], "gtlcecore:sulfur_vein_essence"]]

    nether_vs.forEach((nether_v) => {
        gtr.incubator("nether_e_" + nether_v[1])
            .notConsumable("32x gtlcecore:nether_data")
            .itemInputs("gtlcecore:essence_seed")
            .inputFluids("gtceu:biomass 10000", "gtceu:milk 10000")
    ...
    const end_vs =
        [[["18x #forge:ores/magnetite",
            ...
            "6x #forge:ores/gold"], "gtlcecore:magnetite_vein_end_essence"],

        [["16x #forge:ores/bauxite",
            "8x #forge:ores/ilmenite",
            "8x #forge:ores/aluminium"], "gtlcecore:bauxite_vein_end_essence"],

        [["6x #forge:ores/bornite",
            "4x #forge:ores/cooperite",
            "4x #forge:ores/platinum",
            "2x #forge:ores/palladium"], "gtlcecore:sheldonite_vein_essence"],

        [["12x #forge:ores/scheelite",
            "8x #forge:ores/tungstate",
            "4x #forge:ores/lithium"], "gtlcecore:scheelite_vein_essence"],

        [["18x #forge:ores/pitchblende",
            "12x #forge:ores/uraninite"], "gtlcecore:pitchblende_vein_end_essence"],

        [["18x #forge:ores/naquadah",
            "6x #forge:ores/plutonium"], "gtlcecore:naquadah_vein_essence"]]

    end_vs.forEach((end_v) => {
        gtr.incubator("end_e_" + end_v[1])
            .notConsumable("64x gtlcecore:end_data")
            .itemInputs("gtlcecore:essence_seed")
            .inputFluids("gtceu:biomass 10000", "gtceu:milk 10000")
            .itemInputs(end_v[0])
    ...
    gtr.macerator("gtlcecore:essence")
        .itemInputs("gtlcecore:essence_block")
        .itemOutputs("gtlcecore:essence")
        .chancedOutput("gtlcecore:essence", 5000, 400)
        .chancedOutput("gtlcecore:essence", 5000, 200)
        .chancedOutput("gtlcecore:essence", 5000, 100)
        .EUt(30)
        .duration(200)

    gtr.mixer("gtlcecore:essence_seed")
        .itemInputs("16x #forge:seeds", "gtlcecore:essence")
        .inputFluids("gtceu:distilled_water 1000", "gtceu:carbon_dioxide 1000")
        .itemOutputs("16x gtlcecore:essence_seed")
        .EUt(120)
        .duration(400)

    gtr.incubator("gtlcecore:space_essence")
        ...
        .itemOutputs("gtlcecore:space_essence")
        .EUt(480)
        .duration(1200)
    ...
    const overworld_ores =
        [[["60x gtceu:bentonite_ore",
            ...
            "20x gtceu:glauconite_sand_ore"], "gtlcecore:olivine_vein_essence"],

        [["180x gtceu:almandine_ore",
            "120x gtceu:pyrope_ore",
            "60x gtceu:sapphire_ore",
            "60x gtceu:green_sapphire_ore"], "gtlcecore:sapphire_vein_essence"],

        [["60x gtceu:goethite_ore",
            "240x gtceu:yellow_limonite_ore",
            "240x gtceu:hematite_ore",
            "120x gtceu:malachite_ore"], "gtlcecore:iron_vein_essence"],

        [["120x gtceu:soapstone_ore",
            "80x gtceu:talc_ore",
            "80x gtceu:glauconite_sand_ore",
            "40x gtceu:pentlandite_ore"], "gtlcecore:lubricant_vein_essence"],

        [["60x gtceu:grossular_ore",
            "40x gtceu:spessartine_ore",
            "40x gtceu:pyrolusite_ore",
            "20x gtceu:tantalite_ore"], "gtlcecore:manganese_vein_ow_essence"],

        [["250x gtceu:chalcopyrite_ore",
            "10x gtceu:zeolite_ore",
            "10x gtceu:cassiterite_ore",
            "50x gtceu:realgar_ore"], "gtlcecore:copper_tin_vein_essence"],

        [["240x gtceu:coal_ore"], "gtlcecore:coal_vein_essence"],

        [["40x gtceu:chalcopyrite_ore",
            "160x gtceu:iron_ore",
            "160x gtceu:pyrite_ore",
            "160x gtceu:copper_ore"], "gtlcecore:copper_vein_essence"],

        [["240x gtceu:magnetite_ore",
            "160x gtceu:vanadium_magnetite_ore",
            "80x gtceu:gold_ore"], "gtlcecore:magnetite_vein_ow_essence"],

        [["120x gtceu:lazurite_ore",
            "80x gtceu:sodalite_ore",
            "80x gtceu:lapis_ore",
            "40x gtceu:calcite_ore"], "gtlcecore:lapis_vein_essence"],

        [["120x gtceu:galena_ore",
            "80x gtceu:silver_ore",
            "40x gtceu:lead_ore"], "gtlcecore:galena_vein_essence"],

        [["60x gtceu:kyanite_ore",
            "40x gtceu:mica_ore",
            "40x gtceu:bauxite_ore",
            "20x gtceu:pollucite_ore"], "gtlcecore:mica_vein_essence"],

        [["320x gtceu:tin_ore",
            "160x gtceu:cassiterite_ore"], "gtlcecore:cassiterite_vein_essence"],

        [["120x gtceu:red_garnet_ore",
            "80x gtceu:yellow_garnet_ore",
            "80x gtceu:amethyst_ore",
            "40x gtceu:opal_ore"], "gtlcecore:garnet_vein_essence"],

        [["240x gtceu:basaltic_mineral_sand_ore",
            "160x gtceu:granitic_mineral_sand_ore",
            "160x gtceu:fullers_earth_ore",
            "80x gtceu:gypsum_ore"], "gtlcecore:mineral_sand_vein_essence"],

        [["150x gtceu:rock_salt_ore",
            "10x gtceu:salt_ore",
            "50x gtceu:lepidolite_ore",
            "50x gtceu:spodumene_ore"], "gtlcecore:salts_vein_essence"],

        [["180x gtceu:redstone_ore",
            "120x gtceu:ruby_ore",
            "60x gtceu:cinnabar_ore"], "gtlcecore:redstone_vein_ow_essence"],

        [["120x gtceu:apatite_ore",
            "80x gtceu:tricalcium_phosphate_ore",
            "40x gtceu:pyrochlore_ore"], "gtlcecore:apatite_vein_essence"],

        [["240x gtceu:cassiterite_sand_ore",
            "160x gtceu:garnet_sand_ore",
            "160x gtceu:asbestos_ore",
            "80x gtceu:diatomite_ore"], "gtlcecore:garnet_tin_vein_essence"],

        [["240x gtceu:oilsands_ore"], "gtlcecore:oilsands_vein_essence"],

        [["120x gtceu:graphite_ore",
            "80x gtceu:diamond_ore",
            "40x gtceu:coal_ore"], "gtlcecore:diamond_vein_essence"],

        [["120x gtceu:garnierite_ore",
            "80x gtceu:nickel_ore",
            "80x gtceu:cobaltite_ore",
            "40x gtceu:pentlandite_ore"], "gtlcecore:nickel_vein_essence"]]
    ...
    space_drones.forEach((space_drone) => {
        space_ores1.forEach((space_ore) => {
            gtr.miner_module("space_ore_1_" + space_ore[1] + space_drone)
                .notConsumable("16x gtlcecore:space_drone_mk" + space_drone)
                .circuit(space_ore[1])
    ...
    space_drones.slice(5).forEach((space_drone) => {
        space_fluid5s.forEach((space_fluid) => {
            gtr.drilling_module(space_drone + "1_space_fluid_" + space_fluid[1])
                .notConsumable("64x gtlcecore:space_drone_mk" + space_drone)
                .circuit(space_fluid[1])
    ...
    event.shaped("gtlcecore:greenhouse", ["GGG", "CHC", "PUP"], {
    ...
    gtr.greenhouse("barnarda_log")
        .notConsumable("64x gtlcecore:barnarda_leaves")
        .itemInputs("4x gtceu:fertilizer")
        .inputFluids("gtceu:unknowwater 1000")
        .itemOutputs("16x gtlcecore:barnarda_log")
        .duration(600)
        .EUt(30)
        .circuit(1)
    ...
    gtr.greenhouse("barnarda_log_fertiliser")
        ...
        .inputFluids("gtceu:unknowwater 1000")
        .itemOutputs("32x gtlcecore:barnarda_log")
        .duration(200)
        .EUt(60)
        .circuit(2)
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcecore:cosmic_neutron_plasma_cell")
        .notConsumable("avaritia:infinity_catalyst")
        .itemInputs("5x gtlcecore:extremely_durable_plasma_cell")
        .inputFluids("gtceu:uu_matter 1000000", "gtceu:dense_neutron_plasma 1000")
        .itemOutputs("5x gtlcecore:cosmic_neutron_plasma_cell")
        .outputFluids("gtceu:dimensionallytranscendentresidue 100")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(800)
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcecore:infinity")
        .notConsumable("gtlcecore:spacetime_catalyst")
    ...
    gtr.stellar_forge("gtceu:eternity_dust")
        .itemInputs("4x gtlcecore:quantum_chromodynamic_charge", "avaritia:eternal_singularity")
    ...
    gtr.stellar_forge("gtceu:temporalfluid")
        .itemInputs("4x gtlcecore:quantum_chromodynamic_charge", "gtlcecore:hypercube")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtceu:spacetime_ingot")
        .notConsumable("64x gtlcecore:ingot_field_shape")
        .notConsumable("64x gtlcecore:spacetimebendingcore")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtceu:magnetohydrodynamicallyconstrainedstarmatter")
        .notConsumable("gtlcecore:eternity_catalyst")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtceu:dense_neutron_plasma")
        .notConsumable("avaritia:infinity_catalyst")
        .itemInputs("gtlcecore:neutron_plasma_containment_cell")
    ...
    mcsms.forEach((mcsm) => {
        gtr.sps_crafting("gtceu:magnetohydrodynamicallyconstrainedstarmatter" + mcsm[0])
            .itemInputs("gtceu:eternity_" + mcsm[0], "gtlcecore:solar_light_splitter")
    ...
    gtr.sps_crafting("gtceu:double_magnetohydrodynamicallyconstrainedstarmatter_plate")
        .itemInputs("gtceu:double_eternity_plate", "gtlcecore:solar_light_splitter")
    ...
    gtr.sps_crafting("gtceu:tiny_magnetohydrodynamicallyconstrainedstarmatter_dust")
        .itemInputs("gtceu:tiny_eternity_dust", "gtlcecore:solar_light_splitter")
    ...
    gtr.sps_crafting("gtceu:small_magnetohydrodynamicallyconstrainedstarmatter_dust")
        .itemInputs("gtceu:small_eternity_dust", "gtlcecore:solar_light_splitter")
    ...
    gtr.assembler("gtlcecore:stellar_containment_casing")
        ...
        .inputFluids("gtceu:neutronium 144")
        .itemOutputs("gtlcecore:stellar_containment_casing")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(140)

    gtr.assembler("gtlcecore:naquadria_charge")
        ...
        .itemOutputs("gtlcecore:naquadria_charge")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
    ...
    gtr.assembler("gtlcecore:antifreeze_heatproof_machine_casing")
        .itemInputs("gtceu:inconel_792_frame", "2x gtceu:double_hsse_plate", "4x gtceu:double_rhodium_plated_palladium_plate")
        .itemOutputs("2x gtlcecore:antifreeze_heatproof_machine_casing")
        .EUt(16)
        .duration(50)
        .circuit(6)

    gtr.assembler("gtlcecore:pikyonium_machine_casing")
        .itemInputs("gtceu:hastelloy_x_frame", "6x gtceu:pikyonium_plate")
        .itemOutputs("2x gtlcecore:pikyonium_machine_casing")
        .EUt(16)
        .duration(50)
        .circuit(6)

    gtr.assembler("gtlcecore:oxidation_resistant_hastelloy_n_mechanical_casing")
        .itemInputs("gtceu:hastelloy_n_frame", "6x gtceu:hastelloy_n_plate")
        .itemOutputs("2x gtlcecore:oxidation_resistant_hastelloy_n_mechanical_casing")
        .EUt(16)
        .duration(50)
        .circuit(6)
    ...
    gtr.stellar_forge("gtlcecore:neutron_plasma_containment_cell")
        .inputFluids("gtceu:neutronium 1000", "gtceu:heavy_lepton_mixture 1000")
        .itemInputs("gtlcecore:naquadria_charge", "gtlcecore:plasma_containment_cell")
        .itemOutputs("gtlcecore:neutron_plasma_containment_cell")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(200)
        .addData("SCTier", 1)

    gtr.stellar_forge("gtceu:free_proton_gas")
        .itemInputs("gtlcecore:naquadria_charge", "gtlcecore:contained_high_density_protonic_matter")
    ...
    gtr.stellar_forge("gtceu:enderium_plasma")
        ...
        .itemInputs("gtlcecore:naquadria_charge", "gtlcecore:warped_ender_pearl")
    ...
    gtr.stellar_forge("gtceu:adamantium_plasma")
        ...
        .itemInputs("gtlcecore:naquadria_charge", "24x gtceu:bloodstone_dust")
    ...
    gtr.stellar_forge("gtceu:degenerate_rhenium_plasma")
        .itemInputs("gtlcecore:naquadria_charge", "5x gtceu:double_rhenium_plate")
    ...
    gtr.stellar_forge("gtceu:infuscolium_plasma")
        ...
        .itemInputs("gtlcecore:naquadria_charge", "16x minecraft:end_crystal", "16x minecraft:popped_chorus_fruit")
    ...
    gtr.stellar_forge("gtceu:legendarium_plasma")
        ...
        .itemInputs("gtlcecore:leptonic_charge", "gtlcecore:neutron_plasma_containment_cell")
    ...
    gtr.stellar_forge("gtceu:quark_gluon_plasma")
        .itemInputs("gtlcecore:leptonic_charge", "10x gtceu:degenerate_rhenium_dust")
    ...
    gtr.stellar_forge("gtceu:heavy_quark_degenerate_matter_plasma")
        ...
        .itemInputs("gtlcecore:leptonic_charge")
        .outputFluids("gtceu:heavy_quark_degenerate_matter_plasma 1152")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(200)
        .addData("SCTier", 2)

    gtr.stellar_forge("gtlcecore:contained_high_density_protonic_matter")
        .itemInputs("gtlcecore:leptonic_charge", "gtlcecore:time_dilation_containment_unit", "gtlcecore:charged_triplet_neutronium_sphere")
        .itemOutputs("gtlcecore:contained_high_density_protonic_matter")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(200)
        .addData("SCTier", 2)

    gtr.stellar_forge("gtceu:crystalmatrix_plasma")
        .itemInputs("gtlcecore:leptonic_charge", "avaritia:crystal_matrix", "16x gtlcecore:corporeal_matter")
    ...
    gtr.stellar_forge("gtceu:starmetal_plasma")
        .itemInputs("gtlcecore:leptonic_charge", "10x gtlcecore:resonating_gem")
    ...
    gtr.stellar_forge("gtceu:high_energy_quark_gluon_plasma")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "10x gtceu:double_heavy_quark_degenerate_matter_plate")
    ...
    gtr.stellar_forge("gtceu:quantumchromodynamically_confined_matter_plasma")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "20x gtlcecore:quantumchromodynamic_protective_plating")
    ...
    gtr.stellar_forge("gtceu:dense_neutron_plasma")
        ...
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "5x gtceu:neutronium_block", "5x gtceu:heavy_quark_degenerate_matter_block")
        .outputFluids("gtceu:dense_neutron_plasma 6000")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
        .addData("SCTier", 3)

    gtr.stellar_forge("gtlcecore:extremely_durable_plasma_cell")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "2x gtlcecore:dense_neutron_plasma_cell")
        .itemOutputs("gtlcecore:cosmic_neutron_plasma_cell", "gtlcecore:extremely_durable_plasma_cell")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
        .addData("SCTier", 3)
    ...
    gtr.stellar_forge("gtlcecore:contained_reissner_nordstrom_singularity")
        .itemInputs("gtlcecore:naquadria_charge", "64x gtlcecore:time_dilation_containment_unit", "64x gtlcecore:charged_triplet_neutronium_sphere")
        .itemOutputs("64x gtlcecore:contained_reissner_nordstrom_singularity")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(200)
        .addData("SCTier", 1)

    gtr.stellar_forge("gtlcecore:contained_kerr_newmann_singularity")
        .itemInputs("gtlcecore:leptonic_charge", "64x gtlcecore:contained_reissner_nordstrom_singularity")
        .itemOutputs("gtlcecore:contained_kerr_newmann_singularity", "63x gtlcecore:time_dilation_containment_unit")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(200)
        .addData("SCTier", 2)

    gtr.stellar_forge("gtlcecore:contained_exotic_matter")
        .itemInputs("gtlcecore:leptonic_charge", "gtlcecore:contained_high_density_protonic_matter", "9x gtceu:tiny_degenerate_rhenium_dust")
        .itemOutputs("gtlcecore:contained_exotic_matter")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(200)
        .addData("SCTier", 2)

    gtr.stellar_forge("gtlcecore:recursively_folded_negative_space")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "2x gtlcecore:macrowormhole_generator", "2x gtlcecore:temporal_matter")
        .itemOutputs("gtlcecore:recursively_folded_negative_space")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
        .addData("SCTier", 3)

    gtr.stellar_forge("gtlcecore:eigenfolded_kerr_manifold")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "gtlcecore:stabilized_wormhole_generator", "gtlcecore:recursively_folded_negative_space")
        .itemOutputs("gtlcecore:eigenfolded_kerr_manifold")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
        .addData("SCTier", 3)

    gtr.stellar_forge("gtlcecore:ctc_computational_unit")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "gtlcecore:eigenfolded_kerr_manifold", "gtlcecore:ctc_computational_unit_container")
        .itemOutputs("gtlcecore:ctc_computational_unit")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
        .addData("SCTier", 3)
    ...
    gtr.plasma_condenser("minecraft:iron_ingot")
        .notConsumable("gtlcecore:ingot_field_shape")
    ...
    gtr.plasma_condenser("gtceu:degenerate_rhenium")
        .itemInputs("gtlcecore:rhenium_plasma_containment_cell")
        .inputFluids("gtceu:liquid_helium 100000")
    ...
    gtr.plasma_condenser("gtceu:draconiumawakened")
        .itemInputs("gtlcecore:draconiumawakened_plasma_containment_cell")
        .inputFluids("gtceu:liquid_helium 100000")
    ...
    gtr.plasma_condenser("gtlcecore:neutronium_sphere")
        .notConsumable("gtlcecore:ball_field_shape")
        .inputFluids("gtceu:liquid_helium 32000")
        .outputFluids("gtceu:helium 32000")
        .itemInputs("gtlcecore:neutron_plasma_containment_cell")
        .itemOutputs("4x gtlcecore:neutronium_sphere", "gtlcecore:plasma_containment_cell")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(800)

    gtr.plasma_condenser("gtlcecore:quantumchromodynamic_protective_plating")
        .notConsumable("gtceu:vibranium_nanoswarm")
        ...
        .itemOutputs("gtlcecore:quantumchromodynamic_protective_plating")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(300)

    gtr.plasma_condenser("gtceu:cosmicneutronium")
        .itemInputs("gtlcecore:cosmic_neutron_plasma_cell")
        .inputFluids("gtceu:liquid_helium 100000")
    ...
    gtr.plasma_condenser("gtceu:crystalmatrix")
        .itemInputs("gtlcecore:crystalmatrix_plasma_containment_cell")
        .inputFluids("gtceu:liquid_helium 100000")
    ...
    gtr.plasma_condenser("gtceu:chaos")
        .itemInputs("gtlcecore:chaos_containment_unit")
        .inputFluids("gtceu:liquid_helium 100000")
    ...
    gtr.canner("gtlcecore:crystalmatrix_plasma_containment_cell")
        .notConsumable("gtceu:enderium_nanoswarm")
        .inputFluids("gtceu:crystalmatrix_plasma 1000")
        .itemInputs("gtlcecore:plasma_containment_cell")
        .itemOutputs("gtlcecore:crystalmatrix_plasma_containment_cell")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(20)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    robots.forEach((robot) => {
        gtr.assembler("gtlcecore:precision_circuit_assembly_robot_mk" + robot[1])
            ...
            .inputFluids("gtceu:soldering_alloy 1440")
            .itemOutputs("gtlcecore:precision_circuit_assembly_robot_mk" + robot[1])
            .EUt(robot[3])
            .duration(400)
    })

    event.shaped("gtlcecore:machine_casing_circuit_assembly_line", [
        "ABA",
        "CDC",
        "ABA"
    ], {
    ...
    event.shaped("gtlcecore:aggregatione_core", [
        "ABA",
        "BDB",
        "ABA"
    ], {
        A: "gtceu:attuned_tengam_ingot",
        B: "gtlcecore:infused_obsidian",
        D: "gtlcecore:magic_core"
    })

    event.shaped("gtlcecore:stabilizer_core", [
        "ABA",
        "BDB",
        "ABA"
    ], {
        ...
        D: "gtlcecore:time_dilation_containment_unit"
    })

    event.shaped("gtlcecore:dragon_stabilizer_core", [
        "ABA",
        "BDB",
        "ABA"
    ], {
        ...
        D: "gtlcecore:stabilizer_core"
    })

    gtr.macerator("gtlcecore:draconium_dust")
        .itemInputs("gtlcecore:draconium_block_charged")
        .itemOutputs("9x gtlcecore:draconium_dust", "gtceu:obsidian_dust", "gtceu:ender_eye_dust", "minecraft:redstone")
        .EUt(1920)
        .duration(400)

    gtr.alloy_smelter("gtlcecore:infused_obsidian")
        .itemInputs("gtlcecore:ender_obsidian", "gtlcecore:draconium_dust")
        .itemOutputs("gtlcecore:infused_obsidian")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(200)

    gtr.sps_crafting("gtlcecore:draconium_dust")
    ...
    //bioware
    gtr.circuit_assembler("gtlcecore:bioware_circuit_board")
        .itemInputs("32x gtceu:wetware_circuit_board", "8x gtlcecore:electricaly_wired_petri_dish", "gtceu:uv_electric_pump", "2x gtceu:luv_sensor", "#gtceu:circuits/luv", "32x gtceu:vanadium_gallium_foil")
        .itemOutputs("32x gtlcecore:bioware_circuit_board")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(2400)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.chemical_reactor("gtlcecore:bioware_printed_circuit_board")
        .itemInputs("gtlcecore:bioware_circuit_board", "32x gtceu:vanadium_gallium_foil")
        .inputFluids("gtceu:iron_iii_chloride 10000")
        .itemOutputs("gtlcecore:bioware_printed_circuit_board")
        .EUt(1920)
        .duration(2100)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.chemical_reactor("gtlcecore:bioware_printed_circuit_board1")
        .itemInputs("gtlcecore:bioware_circuit_board", "32x gtceu:vanadium_gallium_foil")
    ...
    gtr.incubator("gtceu:biomediumraw")
        .itemInputs("64x gtceu:stem_cells", "16x gtlcecore:tcetieseaweedextract", "gtceu:tritanium_dust")
    ...
    gtr.incubator("gtceu:biomediumraw1")
        .itemInputs("64x gtlcecore:biological_cells", "16x gtlcecore:tcetieseaweedextract", "gtceu:tritanium_dust")
    ...
    gtr.extractor("gtlcecore:tcetieseaweedextract")
        .itemInputs("64x gtlcecore:tcetiedandelions")
        .itemOutputs("gtlcecore:tcetieseaweedextract")
        .EUt(16)
        .duration(200)
        .addCondition(new GravityCondition(false))

    gtr.centrifuge("gtlcecore:tcetiedandelions")
        .inputFluids("gtceu:seaweedbroth 1000")
        .itemOutputs("64x gtlcecore:tcetiedandelions")
        .EUt(120)
        .duration(200)
        .addCondition(new GravityCondition(false))
    ...
    gtr.incubator("gtlcecore:biological_cells")
        ...
        .itemOutputs("64x gtlcecore:biological_cells")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(800)

    gtr.precision_assembler("gtlcecore:bioware_boule")
        .itemInputs("gtceu:neutronium_wafer", "16x gtlcecore:biological_cells", "gtceu:small_actinium_dust", "gtceu:small_strontium_dust")
        .inputFluids("gtceu:biohmediumsterilized 1000", "gtceu:lubricant 1000", "gtceu:nitrogen 10000")
        .itemOutputs("gtlcecore:bioware_boule")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(600)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.cutter("gtlcecore:bioware_chip")
        .itemInputs("gtlcecore:bioware_boule")
        .itemOutputs("16x gtlcecore:bioware_chip", "8x gtlcecore:biological_cells")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(600)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.assembler("gtlcecore:smd_transistor_bioware")
        ...
        .itemOutputs("16x gtlcecore:smd_transistor_bioware")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(100)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.assembler("gtlcecore:smd_capacitor_bioware")
        .itemInputs("8x gtceu:fine_naquadah_alloy_wire", "8x gtceu:silicon_foil", "4x gtceu:naquadah_foil")
        .inputFluids("gtceu:polyimide 288")
        .itemOutputs("16x gtlcecore:smd_capacitor_bioware")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(100)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.assembler("gtlcecore:smd_resistor_bioware")
        .itemInputs("8x gtceu:fine_naquadah_alloy_wire", "gtceu:naquadria_plate", "gtceu:tritanium_plate")
        .inputFluids("gtceu:polyimide 288")
        .itemOutputs("16x gtlcecore:smd_resistor_bioware")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(100)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.assembler("gtlcecore:smd_diode_bioware")
        .itemInputs("8x gtceu:fine_naquadah_alloy_wire", "gtceu:lutetium_dust", "gtceu:tritanium_dust")
        .inputFluids("gtceu:polyimide 288")
        .itemOutputs("16x gtlcecore:smd_diode_bioware")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(100)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.assembler("gtlcecore:smd_inductor_bioware")
        .itemInputs("8x gtceu:fine_naquadah_alloy_wire", "gtceu:naquadah_alloy_ring")
        .inputFluids("gtceu:polyimide 288")
        .itemOutputs("16x gtlcecore:smd_inductor_bioware")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(100)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)

    gtr.circuit_assembler("gtlcecore:bioware_processor")
        .itemInputs("gtlcecore:bioware_processing_core",
            "4x gtceu:qbit_cpu_chip",
            "gtceu:highly_advanced_soc",
            "8x gtlcecore:smd_capacitor_bioware",
            "8x gtlcecore:smd_transistor_bioware",
            "8x gtceu:fine_naquadah_wire")
        .itemOutputs("4x gtlcecore:bioware_processor")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(200)
        .cleanroom(CleanroomType.STERILE_CLEANROOM)
    ...
    circuit_robots.forEach((circuit_robot) => {
        gtr.circuit_assembly_line("gtlcecore:bioware_assembly" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:bioware_printed_circuit_board",
                "2x gtlcecore:bioware_processor",
                "16x gtlcecore:smd_capacitor_bioware",
                "16x gtlcecore:smd_diode_bioware",
                "16x gtlcecore:smd_resistor_bioware",
                "16x gtlcecore:smd_transistor_bioware",
                "16x gtlcecore:smd_inductor_bioware",
                "16x gtceu:fine_naquadah_wire",
                "48x gtceu:ram_chip",
            ...
            .itemOutputs("2x gtlcecore:bioware_assembly")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 4 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:bioware_computer" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:bioware_printed_circuit_board",
                "2x gtlcecore:bioware_assembly",
                "32x gtlcecore:smd_capacitor_bioware",
                "32x gtlcecore:smd_diode_bioware",
                "32x gtlcecore:smd_resistor_bioware",
                "32x gtlcecore:smd_transistor_bioware",
                "32x gtlcecore:smd_inductor_bioware",
            ...
            .itemOutputs("gtlcecore:bioware_computer")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 4 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:bioware_mainframe" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("2x gtceu:neutronium_frame",
                "2x gtlcecore:bioware_computer",
                "64x gtlcecore:smd_capacitor_bioware",
                "64x gtlcecore:smd_diode_bioware",
                "64x gtlcecore:smd_resistor_bioware",
                "64x gtlcecore:smd_transistor_bioware",
            ...
            .itemOutputs("gtlcecore:bioware_mainframe")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
    ...
    gtr.assembler("gtlcecore:smd_transistor_optical")
        ...
        .itemOutputs("16x gtlcecore:smd_transistor_optical")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_capacitor_optical")
        .itemInputs("8x gtceu:fine_dubnium_wire", "4x gtceu:polyetheretherketone_foil", "2x gtceu:tritanium_foil")
        .inputFluids("gtceu:polyimide 576")
        .itemOutputs("16x gtlcecore:smd_capacitor_optical")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_resistor_optical")
        ...
        .inputFluids("gtceu:polyimide 576")
        .itemOutputs("16x gtlcecore:smd_resistor_optical")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_diode_optical")
        ...
        .inputFluids("gtceu:polyimide 576")
        .itemOutputs("16x gtlcecore:smd_diode_optical")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_inductor_optical")
        .itemInputs("8x gtceu:fine_dubnium_wire", "gtceu:quantanium_ring")
        .inputFluids("gtceu:polyimide 576")
        .itemOutputs("16x gtlcecore:smd_inductor_optical")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)


    gtr.circuit_assembler("gtlcecore:optical_processor")
        .itemInputs("gtlcecore:optical_processing_core",
            "4x gtlcecore:optical_ram_chip",
            "gtceu:highly_advanced_soc",
            "8x gtlcecore:smd_capacitor_optical",
            "8x gtlcecore:smd_transistor_optical",
            "8x gtceu:fine_dubnium_wire")
        .itemOutputs("4x gtlcecore:optical_processor")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    circuit_robots.slice(1).forEach((circuit_robot) => {
        gtr.circuit_assembly_line("gtlcecore:optical_assembly" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:optical_printed_circuit_board",
                "2x gtlcecore:optical_processor",
                "16x gtlcecore:smd_capacitor_optical",
                "16x gtlcecore:smd_diode_optical",
                "16x gtlcecore:smd_resistor_optical",
                "16x gtlcecore:smd_transistor_optical",
                "16x gtlcecore:smd_inductor_optical",
                "16x gtceu:fine_dubnium_wire",
                "24x gtlcecore:optical_ram_chip",
            ...
            .itemOutputs("2x gtlcecore:optical_assembly")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 16 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:optical_computer" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:optical_printed_circuit_board",
                "2x gtlcecore:optical_assembly",
                "32x gtlcecore:smd_capacitor_optical",
                "32x gtlcecore:smd_diode_optical",
                "32x gtlcecore:smd_resistor_optical",
                "32x gtlcecore:smd_transistor_optical",
                "32x gtlcecore:smd_inductor_optical",
                "32x gtceu:fine_dubnium_wire",
                "32x gtlcecore:optical_ram_chip",
                "64x gtceu:nor_memory_chip",
                "64x gtceu:nand_memory_chip",
                "2x gtlcecore:nm_chip",
            ...
            .itemOutputs("gtlcecore:optical_computer")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 16 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:optical_mainframe" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("2x gtceu:quantanium_frame",
                "2x gtlcecore:optical_computer",
                "64x gtlcecore:smd_capacitor_optical",
                "64x gtlcecore:smd_diode_optical",
                "64x gtlcecore:smd_resistor_optical",
                "64x gtlcecore:smd_transistor_optical",
                "64x gtlcecore:smd_inductor_optical",
                "64x gtlcecore:optical_ram_chip",
                "4x gtlcecore:nm_chip",
            ...
            .itemOutputs("gtlcecore:optical_mainframe")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(800 * 16 / (4 ** circuit_robot))
    })

    //exotic
    gtr.assembler("gtlcecore:smd_transistor_exotic")
        ...
        .itemOutputs("16x gtlcecore:smd_transistor_exotic")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_capacitor_exotic")
        .itemInputs("gtceu:glowstone_plate", "gtceu:quantum_plate", "2x gtceu:cinobite_foil", "2x gtceu:carbon_nanotubes_foil")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
        .itemOutputs("16x gtlcecore:smd_capacitor_exotic")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_resistor_exotic")
        ...
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
        .itemOutputs("16x gtlcecore:smd_resistor_exotic")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_diode_exotic")
        .itemInputs("gtceu:enderite_plate", "gtceu:trinium_titanium_plate", "2x gtceu:dubnium_foil", "2x gtceu:quantum_foil")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
        .itemOutputs("16x gtlcecore:smd_diode_exotic")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_inductor_exotic")
        .itemInputs("8x gtceu:fine_cinobite_wire", "gtceu:adamantium_ring")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
        .itemOutputs("16x gtlcecore:smd_inductor_exotic")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.circuit_assembler("gtlcecore:exotic_processor")
        .itemInputs("gtlcecore:exotic_processing_core",
            "4x gtlcecore:exotic_ram_chip",
            "gtceu:highly_advanced_soc",
            "8x gtlcecore:smd_capacitor_exotic",
            "8x gtlcecore:smd_transistor_exotic",
            "8x gtceu:fine_cinobite_wire")
        .itemOutputs("4x gtlcecore:exotic_processor")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    circuit_robots.slice(2).forEach((circuit_robot) => {
        gtr.circuit_assembly_line("gtlcecore:exotic_assembly" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:exotic_printed_circuit_board",
                "2x gtlcecore:exotic_processor",
                "16x gtlcecore:smd_capacitor_exotic",
                "16x gtlcecore:smd_diode_exotic",
                "16x gtlcecore:smd_resistor_exotic",
                "16x gtlcecore:smd_transistor_exotic",
                "16x gtlcecore:smd_inductor_exotic",
                "gtlcecore:draconic_core",
                "16x gtceu:fine_cinobite_wire",
                "24x gtlcecore:exotic_ram_chip",
                "16x gtceu:polyetheretherketone_foil",
                "2x gtceu:infuscolium_plate")
            .inputFluids("gtceu:tritanium 576", "gtceu:zylon 288", "gtceu:quantanium 288", "gtceu:naquadria 1296")
            .itemOutputs("2x gtlcecore:exotic_assembly")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 64 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:exotic_computer" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:exotic_printed_circuit_board",
                "2x gtlcecore:exotic_assembly",
                "32x gtlcecore:smd_capacitor_exotic",
                "32x gtlcecore:smd_diode_exotic",
                "32x gtlcecore:smd_resistor_exotic",
                "32x gtlcecore:smd_transistor_exotic",
                "32x gtlcecore:smd_inductor_exotic",
                "32x gtceu:fine_cinobite_wire",
                "32x gtlcecore:exotic_ram_chip",
                "64x gtceu:nor_memory_chip",
                "64x gtceu:nor_memory_chip",
                "2x gtlcecore:pm_chip",
                "32x gtceu:polyetheretherketone_foil",
                "gtlcecore:unstable_star",
                "2x gtceu:adamantine_plate")
            .inputFluids("gtceu:enderium 576", "gtceu:zylon 576", "gtceu:quantanium 576", "gtceu:orichalcum 1296")
            .itemOutputs("gtlcecore:exotic_computer")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 64 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:exotic_mainframe" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("2x gtceu:adamantium_frame",
                "2x gtlcecore:exotic_computer",
                "64x gtlcecore:smd_capacitor_exotic",
                "64x gtlcecore:smd_diode_exotic",
                "64x gtlcecore:smd_resistor_exotic",
                "64x gtlcecore:smd_transistor_exotic",
                "64x gtlcecore:smd_inductor_exotic",
                "64x gtlcecore:exotic_ram_chip",
                "16x gtceu:data_stick",
                "4x gtlcecore:pm_chip",
                "16x gtceu:echoite_double_wire",
                "64x gtceu:polyetheretherketone_foil",
                "2x gtlcecore:unstable_star",
            ...
            .itemOutputs("gtlcecore:exotic_mainframe")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(800 * 64 / (4 ** circuit_robot))
    })

    //cosmic
    gtr.assembler("gtlcecore:smd_transistor_cosmic")
        ...
        .itemOutputs("16x gtlcecore:smd_transistor_cosmic")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_capacitor_cosmic")
        .itemInputs("8x gtceu:fine_hastelloyx_78_wire", "4x gtceu:graphene_plate", "4x gtceu:taranium_foil", "2x gtceu:polycaprolactam_foil")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 144")
        .itemOutputs("16x gtlcecore:smd_capacitor_cosmic")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_resistor_cosmic")
        ...
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 144")
        .itemOutputs("16x gtlcecore:smd_resistor_cosmic")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_diode_cosmic")
        ...
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 144")
        .itemOutputs("16x gtlcecore:smd_diode_cosmic")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_inductor_cosmic")
        .itemInputs("8x gtceu:fine_hastelloyx_78_wire", "gtceu:vibranium_ring")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 144")
        .itemOutputs("16x gtlcecore:smd_inductor_cosmic")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.circuit_assembler("gtlcecore:cosmic_processor")
        .itemInputs("gtlcecore:cosmic_processing_core",
            "4x gtlcecore:cosmic_ram_chip",
            "gtceu:highly_advanced_soc",
            "16x gtlcecore:smd_capacitor_cosmic",
            "16x gtlcecore:smd_transistor_cosmic",
            "8x gtceu:fine_cinobite_wire")
        .itemOutputs("4x gtlcecore:cosmic_processor")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    circuit_robots.slice(3).forEach((circuit_robot) => {
        gtr.circuit_assembly_line("gtlcecore:cosmic_assembly" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:cosmic_printed_circuit_board",
                "2x gtlcecore:cosmic_processor",
                "32x gtlcecore:smd_capacitor_cosmic",
                "32x gtlcecore:smd_diode_cosmic",
                "32x gtlcecore:smd_resistor_cosmic",
                "32x gtlcecore:smd_transistor_cosmic",
                "32x gtlcecore:smd_inductor_cosmic",
                "gtlcecore:wyvern_core",
                "4x gtceu:enderite_single_wire",
                "24x gtlcecore:cosmic_ram_chip",
            ...
            .itemOutputs("2x gtlcecore:cosmic_assembly")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 256 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:cosmic_computer" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("gtlcecore:cosmic_printed_circuit_board",
                "2x gtlcecore:cosmic_assembly",
                "64x gtlcecore:smd_capacitor_cosmic",
                "64x gtlcecore:smd_diode_cosmic",
                "64x gtlcecore:smd_resistor_cosmic",
                "64x gtlcecore:smd_transistor_cosmic",
                ...
                "32x gtlcecore:cosmic_ram_chip",
                "32x gtlcecore:exotic_ram_chip",
                "64x gtceu:nor_memory_chip",
                "2x gtlcecore:fm_chip",
            ...
            .itemOutputs("gtlcecore:cosmic_computer")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(400 * 256 / (4 ** circuit_robot))

        gtr.circuit_assembly_line("gtlcecore:cosmic_mainframe" + circuit_robot)
            .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk" + circuit_robot)
            .itemInputs("2x gtceu:vibranium_frame",
                "2x gtlcecore:cosmic_computer",
                "64x gtlcecore:smd_capacitor_cosmic",
                "64x gtlcecore:smd_diode_cosmic",
                "64x gtlcecore:smd_resistor_cosmic",
                "64x gtlcecore:smd_transistor_cosmic",
                "64x gtlcecore:smd_inductor_cosmic",
                "64x gtlcecore:cosmic_ram_chip",
                "16x gtceu:data_orb",
                "4x gtlcecore:fm_chip",
                "16x gtceu:legendarium_double_wire",
                "64x gtceu:fullerene_polymer_matrix_pulp_foil",
                "4x gtlcecore:unstable_star",
                "16x gtlcecore:proto_matter",
            ...
            .itemOutputs("gtlcecore:cosmic_mainframe")
            .EUt(GTValues.VA[GTValues.ZPM] * (4 ** circuit_robot))
            .duration(800 * 256 / (4 ** circuit_robot))
    })

    //supracausal
    gtr.assembler("gtlcecore:smd_capacitor_supracausal")
        .notConsumable("gtlcecore:microwormhole_generator")
        .itemInputs("gtceu:adamantine_plate")
        .itemOutputs("32x gtlcecore:smd_capacitor_supracausal")
        .inputFluids("gtceu:radox 144")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_diode_supracausal")
        .notConsumable("gtlcecore:microwormhole_generator")
        .itemInputs("gtceu:vibramantium_plate")
        .itemOutputs("32x gtlcecore:smd_diode_supracausal")
        .inputFluids("gtceu:radox 144")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_transistor_supracausal")
        .notConsumable("gtlcecore:microwormhole_generator")
        .itemInputs("gtceu:neutronium_plate")
        .itemOutputs("32x gtlcecore:smd_transistor_supracausal")
        .inputFluids("gtceu:radox 144")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_resistor_supracausal")
        .notConsumable("gtlcecore:microwormhole_generator")
        .itemInputs("gtceu:fullerene_polymer_matrix_pulp_foil")
        .itemOutputs("32x gtlcecore:smd_resistor_supracausal")
        .inputFluids("gtceu:radox 144")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:smd_inductor_supracausal")
        .notConsumable("gtlcecore:microwormhole_generator")
        .itemInputs("gtceu:draconium_ring")
        .itemOutputs("32x gtlcecore:smd_inductor_supracausal")
        .inputFluids("gtceu:radox 144")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.circuit_assembler("gtlcecore:supracausal_processor")
        .itemInputs("gtlcecore:supracausal_processing_core", "4x gtlcecore:supracausal_ram_chip", "16x gtlcecore:cosmic_processing_unit_core", "gtlcecore:microwormhole_generator", "gtlcecore:manifold_oscillatory_power_cell", "gtceu:crystalmatrix_plate")
        .itemOutputs("2x gtlcecore:supracausal_processor")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.circuit_assembly_line("gtlcecore:supracausal_assembly")
        .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk5")
        .itemInputs("gtlcecore:supracausal_printed_circuit_board",
            "2x gtlcecore:supracausal_processor",
            "16x gtlcecore:smd_capacitor_supracausal",
            "16x gtlcecore:smd_diode_supracausal",
            "16x gtlcecore:smd_resistor_supracausal",
            "16x gtlcecore:smd_transistor_supracausal",
            "16x gtlcecore:smd_inductor_supracausal",
            "gtlcecore:awakened_core",
            "64x gtceu:fine_heavy_quark_degenerate_matter_wire",
            "16x gtceu:radox_foil",
            "8x gtceu:legendarium_single_wire",
            "8x gtlcecore:optical_soc",
            "gtlcecore:recursively_folded_negative_space",
            "gtlcecore:contained_exotic_matter",
        ...
        .EUt(GTValues.VA[GTValues.UXV])
        .itemOutputs("gtlcecore:supracausal_assembly")
        .duration(200)

    gtr.circuit_assembly_line("gtlcecore:supracausal_computer")
        .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk5")
        .itemInputs("gtlcecore:supracausal_printed_circuit_board",
            "2x gtlcecore:supracausal_assembly",
            "32x gtlcecore:smd_capacitor_supracausal",
            "32x gtlcecore:smd_diode_supracausal",
            "32x gtlcecore:smd_resistor_supracausal",
            "32x gtlcecore:smd_transistor_supracausal",
            "32x gtlcecore:smd_inductor_supracausal",
            "32x gtlcecore:supracausal_ram_chip",
            "16x gtceu:data_module",
            "32x gtceu:trinium_titanium_plate",
            "64x gtceu:legendarium_single_wire",
            "16x gtceu:starmetal_plate",
            "gtlcecore:nuclear_star",
            "gtlcecore:eigenfolded_kerr_manifold",
        ...
        .EUt(GTValues.VA[GTValues.UXV])
        .itemOutputs("gtlcecore:supracausal_computer")
        .duration(200)

    gtr.circuit_assembly_line("gtlcecore:supracausal_mainframe")
        .notConsumable("gtlcecore:precision_circuit_assembly_robot_mk5")
        .itemInputs("2x gtceu:infinity_frame",
            "2x gtlcecore:supracausal_computer",
            "64x gtlcecore:smd_capacitor_supracausal",
            "64x gtlcecore:smd_diode_supracausal",
            "64x gtlcecore:smd_resistor_supracausal",
            "64x gtlcecore:smd_transistor_supracausal",
            ...
            "64x gtceu:draconiumawakened_double_wire",
            "64x gtlcecore:cosmic_fabric",
            "32x gtlcecore:cosmic_processing_unit_core",
            "8x gtlcecore:ultrashort_pulse_laser",
            "2x gtlcecore:nuclear_star",
            "gtlcecore:ctc_computational_unit",
    ...
    tierss.forEach((c) => {
        gtr.packer("gtlcecore:" + c[0] + "_universal_circuit")
            ...
            .itemOutputs("gtlcecore:" + c[0] + "_universal_circuit")
            .EUt(7)
            .duration(2 * (c[1] + 1))
    })

    tierss.forEach((c) => {
        gtr.suprachronal_assembly_line("gtlcecore:suprachronal_" + c[0])
            .notConsumable("gtlcecore:hyperdimensional_drone")
            .itemInputs("gtlcecore:timepiece")
            ...
            .itemOutputs("gtlcecore:suprachronal_" + c[0])
            .duration(2 * (c[1] + 1))
            .circuit((c[1] + 1))
            .EUt(GTValues.VA[GTValues.MAX])
            .stationResearch(b => b.researchStack(Registries.getItemStack((c[1] + 1) == 1 ? "gtlcecore:supracausal_mainframe" : "gtlcecore:suprachronal_" + tierss[(c[1] + 1) - 2][0]))
                .dataStack(Registries.getItemStack("gtceu:data_module"))
                .EUt(GTValues.VA[GTValues.MAX])
                .CWUt(8192))
    })
    ...
    gtr.autoclave("gtlcecore:unstable_star")
        .notConsumable("gtceu:orichalcum_nanoswarm")
        .itemInputs("gtceu:gravi_star")
        .inputFluids("gtceu:adamantine 288")
        .itemOutputs("gtlcecore:unstable_star")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(480)
        .addCondition(new GravityCondition(true))

    gtr.autoclave("gtlcecore:nuclear_star")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .itemInputs("gtlcecore:unstable_star")
        .inputFluids("gtceu:infinity 288")
        .itemOutputs("gtlcecore:nuclear_star")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(480)
        .addCondition(new GravityCondition(true))
    ...
    gtr.assembler_module("gtlcecore:space_probe_mk1")
        ...
        .itemOutputs("gtlcecore:space_probe_mk1")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(400)
        .addData("SEPMTier", 3)

    gtr.assembler_module("gtlcecore:space_probe_mk2")
        ...
        .inputFluids("gtceu:mutated_living_solder 1296", "gtceu:soldering_alloy 2880", "gtceu:lubricant 5760", "gtceu:neutronium 1296")
        .itemOutputs("gtlcecore:space_probe_mk2")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .addData("SEPMTier", 4)

    gtr.assembler_module("gtlcecore:space_probe_mk3")
        ...
        .itemOutputs("gtlcecore:space_probe_mk3")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(400)
        .addData("SEPMTier", 5)

    gtr.assembler_module("gtlcecore:space_drone_mk1")
        ...
        .itemOutputs("gtlcecore:space_drone_mk1")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(600)
        .addData("SEPMTier", 1)

    gtr.assembler_module("gtlcecore:space_drone_mk2")
        ...
        .itemOutputs("gtlcecore:space_drone_mk2")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .addData("SEPMTier", 1)

    gtr.assembler_module("gtlcecore:space_drone_mk3")
        ...
        .itemOutputs("gtlcecore:space_drone_mk3")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(600)
        .addData("SEPMTier", 2)

    gtr.assembler_module("gtlcecore:space_drone_mk4")
        ...
        .itemOutputs("gtlcecore:space_drone_mk4")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)
        .addData("SEPMTier", 3)

    gtr.assembler_module("gtlcecore:space_drone_mk5")
        ...
        .itemOutputs("gtlcecore:space_drone_mk5")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(600)
        .addData("SEPMTier", 4)

    gtr.assembler_module("gtlcecore:space_drone_mk6")
        ...
        .itemOutputs("gtlcecore:space_drone_mk6")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(600)
        .addData("SEPMTier", 5)
    ...
    function space_probe(material, grade, amount, circuit) {
        gtr.space_probe_surface_reception(material + grade)
            .notConsumable("gtlcecore:space_probe_mk" + grade)
    ...
    const fishing = [
        ...
        ["gtlcecore:zero_point_module_fragments", 0.012]
    ]
    ...
    gtr.packer("gtceu:zero_point_module")
        .itemInputs("64x gtlcecore:zero_point_module_fragments")
    ...
    gtr.cosmos_simulation("cosmos_simulation1")
        ...
        .itemOutputs("131072x gtceu:carbon_dust",
            ...
            "131072x gtlcecore:draconium_dust",
    ...
    gtr.pcb_factory("gtlcecore:bioware_printed_circuit_board")
        .itemInputs("gtlcecore:bioware_circuit_board", "32x gtceu:vanadium_gallium_foil")
    ...
    gtr.pcb_factory("gtlcecore:optical_circuit_board")
        .itemInputs("gtceu:kevlar_plate", "32x gtceu:rhodium_foil")
        .inputFluids("gtceu:sulfuric_acid 1000", "gtceu:mithril_plasma 100")
        .itemOutputs("gtlcecore:optical_circuit_board")
        .EUt(7680 * 4)
        .duration(600)

    gtr.pcb_factory("gtlcecore:optical_printed_circuit_board")
        .itemInputs("gtlcecore:optical_circuit_board", "32x gtceu:ruthenium_foil")
        .inputFluids("gtceu:sodium_persulfate 4000", "gtceu:iron_iii_chloride 2000")
        .itemOutputs("gtlcecore:optical_printed_circuit_board")
        .EUt(7680 * 4)
        .duration(600)

    gtr.pcb_factory("gtlcecore:exotic_circuit_board")
        .itemInputs("2x gtceu:kevlar_plate", "32x gtceu:enderium_foil")
        .inputFluids("gtceu:sulfuric_acid 1000", "gtceu:vibranium_plasma 100")
        .itemOutputs("gtlcecore:exotic_circuit_board")
        .EUt(7680 * 16)
        .duration(900)

    gtr.pcb_factory("gtlcecore:exotic_printed_circuit_board")
        .itemInputs("gtlcecore:exotic_circuit_board", "32x gtceu:americium_foil")
        .inputFluids("gtceu:sodium_persulfate 8000", "gtceu:iron_iii_chloride 4000")
        .itemOutputs("gtlcecore:exotic_printed_circuit_board")
        .EUt(7680 * 16)
        .duration(900)

    gtr.pcb_factory("gtlcecore:cosmic_circuit_board")
        ...
        .itemOutputs("gtlcecore:cosmic_circuit_board")
        .EUt(7680 * 64)
        .duration(1200)

    gtr.pcb_factory("gtlcecore:cosmic_printed_circuit_board")
        .itemInputs("gtlcecore:cosmic_circuit_board", "32x gtceu:uruium_foil")
        .inputFluids("gtceu:sodium_persulfate 8000", "gtceu:iron_iii_chloride 4000")
        .itemOutputs("gtlcecore:cosmic_printed_circuit_board")
        .EUt(7680 * 64)
        .duration(1200)

    gtr.pcb_factory("gtlcecore:supracausal_circuit_board")
        .itemInputs("gtlcecore:cosmic_circuit_board", "32x gtceu:echoite_foil")
        .inputFluids("gtceu:dense_neutron_plasma 1000", "gtceu:quantumchromodynamically_confined_matter_plasma 100")
        .itemOutputs("gtlcecore:supracausal_circuit_board")
        .EUt(7680 * 256)
        .duration(1500)

    gtr.pcb_factory("gtlcecore:supracausal_printed_circuit_board")
        .itemInputs("gtlcecore:supracausal_circuit_board", "32x gtceu:legendarium_foil")
        .inputFluids("gtceu:sodium_persulfate 16000", "gtceu:iron_iii_chloride 8000")
        .itemOutputs("gtlcecore:supracausal_printed_circuit_board")
        .EUt(7680 * 256)
        .duration(1500)
    ...
    gtr.assembler("gtlcecore:large_gas_collector")
        ...
        .itemOutputs("gtlcecore:large_gas_collector")
        .inputFluids("gtceu:soldering_alloy 1296")
        .EUt(1920)
        .duration(400)

    gtr.assembler("gtlcecore:large_incubator")
        .itemInputs("gtlcecore:incubator", "4x gtceu:luv_field_generator", "4x gtceu:luv_sensor", "4x gtceu:luv_fluid_regulator", "4x gtceu:indium_tin_barium_titanium_cuprate_octal_wire", "16x gtceu:laminated_glass")
        .itemOutputs("gtlcecore:large_incubator")
        .inputFluids("gtceu:polytetrafluoroethylene 1440")
        .EUt(122880)
        .duration(800)

    gtr.cutter("gtlcecore:taranium_wafer")
        .itemInputs("gtlcecore:taranium_boule")
        .itemOutputs("64x gtlcecore:taranium_wafer", "64x gtlcecore:taranium_wafer")
        .EUt(122880)
        .duration(3200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:rutherfordium_neutronium_wafer")
        .itemInputs("gtlcecore:rutherfordium_neutronium_boule")
        .itemOutputs("64x gtlcecore:rutherfordium_neutronium_wafer", "32x gtlcecore:rutherfordium_neutronium_wafer")
        .EUt(30720)
        .duration(3200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:nm_chip")
        .itemInputs("gtlcecore:nm_wafer")
        .itemOutputs("4x gtlcecore:nm_chip")
        .EUt(30720)
        .duration(1800)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:pm_chip")
        .itemInputs("gtlcecore:pm_wafer")
        .itemOutputs("4x gtlcecore:pm_chip")
        .EUt(122880)
        .duration(1800)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:fm_chip")
        .itemInputs("gtlcecore:fm_wafer")
        .itemOutputs("2x gtlcecore:fm_chip")
        .EUt(524288)
        .duration(2700)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:optical_ram_chip")
        .itemInputs("gtlcecore:optical_ram_wafer")
        .itemOutputs("32x gtlcecore:optical_ram_chip")
        .EUt(122880)
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:exotic_ram_chip")
        .itemInputs("gtlcecore:exotic_ram_wafer")
        .itemOutputs("32x gtlcecore:exotic_ram_chip")
        .EUt(524288)
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:cosmic_ram_chip")
        .itemInputs("gtlcecore:cosmic_ram_wafer")
        .itemOutputs("32x gtlcecore:cosmic_ram_chip")
        .EUt(524288 * 4)
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:supracausal_ram_chip")
        .itemInputs("gtlcecore:supracausal_ram_wafer")
        .itemOutputs("4x gtlcecore:supracausal_ram_chip")
        .EUt(524288 * 16)
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.forming_press("gtlcecore:optical_ram_wafer")
        .itemInputs("gtlcecore:rutherfordium_neutronium_wafer", "gtceu:ram_wafer", "gtlcecore:photon_carrying_wafer")
        .itemOutputs("gtlcecore:optical_ram_wafer")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(150)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.forming_press("gtlcecore:exotic_ram_wafer")
        .itemInputs("gtlcecore:optical_ram_wafer", "gtceu:nor_memory_wafer", "gtceu:nand_memory_wafer", "gtceu:amethyst_plate", "gtceu:technetium_plate")
        .itemOutputs("gtlcecore:exotic_ram_wafer")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(350)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.forming_press("gtlcecore:cosmic_ram_wafer")
        .itemInputs("gtlcecore:taranium_wafer", "gtceu:ram_wafer", "gtlcecore:prepared_cosmic_soc_wafer")
        .itemOutputs("gtlcecore:cosmic_ram_wafer")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(550)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.forming_press("gtlcecore:supracausal_ram_wafer")
        .itemInputs("gtlcecore:cosmic_ram_wafer", "gtlcecore:exotic_ram_wafer", "gtlcecore:pellet_antimatter", "gtceu:legendarium_foil", "gtceu:double_hikarium_plate")
        .itemOutputs("gtlcecore:supracausal_ram_wafer")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(750)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.laser_engraver("gtceu:ilc_wafer")
        .itemInputs("gtlcecore:taranium_wafer")
    ...
    gtr.precision_laser_engraver("gtlcecore:prepared_cosmic_soc_wafer")
        .itemInputs("gtlcecore:taranium_wafer")
        .notConsumable("gtlcecore:lithography_mask")
        .notConsumable("#forge:lenses/yellow")
        ...
        .itemOutputs("gtlcecore:prepared_cosmic_soc_wafer")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(4800)
        .CWUt(1024)

    gtr.precision_laser_engraver("gtlcecore:high_precision_crystal_soc")
        ...
        .itemOutputs("gtlcecore:high_precision_crystal_soc")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2400)
        .CWUt(256)

    gtr.precision_laser_engraver("gtlcecore:nm_wafer")
        .itemInputs("gtlcecore:rutherfordium_neutronium_wafer")
        .notConsumable("gtlcecore:lithography_mask")
        .notConsumable("#forge:lenses/blue")
        .notConsumable("#forge:lenses/brown")
        .notConsumable("#forge:lenses/orange")
        ...
        .itemOutputs("gtlcecore:nm_wafer")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(900)
        .CWUt(128)

    gtr.precision_laser_engraver("gtlcecore:pm_wafer")
        .itemInputs("gtlcecore:taranium_wafer")
        .notConsumable("gtlcecore:lithography_mask")
        .notConsumable("#forge:lenses/blue")
        .notConsumable("#forge:lenses/brown")
        ...
        .notConsumable("#forge:lenses/gray")
        .inputFluids("gtceu:euv_photoresist 1000")
        .itemOutputs("gtlcecore:pm_wafer")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(1800)
        .CWUt(256)

    gtr.precision_laser_engraver("gtlcecore:fm_wafer")
        .itemInputs("gtlcecore:pm_wafer")
        .notConsumable("gtlcecore:grating_lithography_mask")
        .notConsumable("#forge:lenses/blue")
        .notConsumable("#forge:lenses/brown")
        ...
        .notConsumable("#forge:lenses/gray")
        .inputFluids("gtceu:gamma_rays_photoresist 1000")
        .itemOutputs("gtlcecore:fm_wafer")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2800)
        .CWUt(512)

    gtr.precision_laser_engraver("gtlcecore:raw_photon_carrying_wafer")
        .itemInputs("gtlcecore:rutherfordium_neutronium_wafer")
        .notConsumable("gtlcecore:lithography_mask")
        ...
        .notConsumable("#forge:lenses/light_blue")
        .notConsumable("#forge:lenses/pink")
        .itemOutputs("gtlcecore:raw_photon_carrying_wafer")
        .inputFluids("gtceu:photoresist 1000")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .CWUt(128)

    gtr.dimensional_focus_engraving_array("gtlcecore:raw_photon_carrying_wafer")
        .itemInputs("gtlcecore:rutherfordium_neutronium_wafer")
        .notConsumable("#forge:lenses/yellow")
        ...
        .duration(600)
        .CWUt(1)
    ["scannerResearch(java.util.function.UnaryOperator)"](b => b.researchStack(Registries.getItemStack("gtlcecore:raw_photon_carrying_wafer"))
        .dataStack(Registries.getItemStack("gtceu:data_module"))
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(2400))

    gtr.dimensional_focus_engraving_array("gtlcecore:prepared_cosmic_soc_wafer")
        .itemInputs("gtlcecore:taranium_wafer")
        .notConsumable("#forge:lenses/light_blue")
        ...
        .duration(4800)
        .CWUt(8)
    ["scannerResearch(java.util.function.UnaryOperator)"](b => b.researchStack(Registries.getItemStack("gtlcecore:prepared_cosmic_soc_wafer"))
        .dataStack(Registries.getItemStack("gtceu:data_module"))
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(2400))

    gtr.dimensional_focus_engraving_array("gtlcecore:high_precision_crystal_soc")
        .itemInputs("gtceu:crystal_soc")
        .notConsumable("#forge:lenses/lime")
        ...
        .duration(2400)
        .CWUt(2)
    ["scannerResearch(java.util.function.UnaryOperator)"](b => b.researchStack(Registries.getItemStack("gtlcecore:high_precision_crystal_soc"))
        .dataStack(Registries.getItemStack("gtceu:data_module"))
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2400))

    gtr.dimensional_focus_engraving_array("gtlcecore:nm_wafer")
        .itemInputs("gtlcecore:rutherfordium_neutronium_wafer")
        .notConsumable("#forge:lenses/blue")
        .inputFluids("gtceu:photoresist 100")
        .itemOutputs("gtlcecore:nm_wafer")
        ...
        .duration(900)
        .CWUt(1)
    ["scannerResearch(java.util.function.UnaryOperator)"](b => b.researchStack(Registries.getItemStack("gtlcecore:nm_wafer"))
        .dataStack(Registries.getItemStack("gtceu:data_module"))
        .EUt(GTValues.VA[GTValues.UV])
        .duration(2400))

    gtr.dimensional_focus_engraving_array("gtlcecore:pm_wafer")
        .itemInputs("gtlcecore:taranium_wafer")
        .notConsumable("#forge:lenses/magenta")
        .inputFluids("gtceu:euv_photoresist 100")
        .itemOutputs("gtlcecore:pm_wafer")
        ...
        .duration(1800)
        .CWUt(2)
    ["scannerResearch(java.util.function.UnaryOperator)"](b => b.researchStack(Registries.getItemStack("gtlcecore:pm_wafer"))
        .dataStack(Registries.getItemStack("gtceu:data_module"))
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(2400))

    gtr.dimensional_focus_engraving_array("gtlcecore:fm_wafer")
        .itemInputs("gtlcecore:pm_wafer")
        .notConsumable("#forge:lenses/orange")
        .inputFluids("gtceu:gamma_rays_photoresist 100")
        .itemOutputs("gtlcecore:fm_wafer")
        ...
        .duration(2700)
        .CWUt(4)
    ["scannerResearch(java.util.function.UnaryOperator)"](b => b.researchStack(Registries.getItemStack("gtlcecore:fm_wafer"))
        .dataStack(Registries.getItemStack("gtceu:data_module"))
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2400))

    gtr.chemical_bath("gtlcecore:cosmic_soc_wafer")
        .itemInputs("gtlcecore:prepared_cosmic_soc_wafer")
        .inputFluids("gtceu:argon_plasma 1000")
        .itemOutputs("gtlcecore:cosmic_soc_wafer")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(600)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.cutter("gtlcecore:cosmic_soc")
        .itemInputs("gtlcecore:cosmic_soc_wafer")
        .itemOutputs("8x gtlcecore:cosmic_soc")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.stellar_forge("gtlcecore:dragon_heart")
        .itemInputs("gtlcecore:naquadria_charge", "64x minecraft:dragon_egg", "gtceu:double_draconiumawakened_plate")
        .itemOutputs("gtlcecore:dragon_heart")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(200)
        .addData("SCTier", 1)

    gtr.stellar_forge("gtlcecore:chaos_shard")
        .itemInputs("gtlcecore:quantum_chromodynamic_charge", "gtlcecore:infused_obsidian", "minecraft:bedrock")
        .inputFluids("gtceu:radox 1000")
        .itemOutputs("gtlcecore:chaos_shard")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(200)
        .addData("SCTier", 3)
    ...
    gtr.assembler("gtlcecore:accelerated_pipeline")
        ...
        .itemOutputs("gtlcecore:accelerated_pipeline")
        .inputFluids("gtceu:soldering_alloy 288")
        .duration(400)
        .EUt(GTValues.VA[GTValues.IV])
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:lafium_mechanical_casing")
        .itemInputs("gtceu:enriched_naquadah_frame", "6x gtceu:lafium_plate")
        .itemOutputs("2x gtlcecore:lafium_mechanical_casing")
        .circuit(6)
        .EUt(16)
        .duration(50)

    gtr.assembler("gtlcecore:module_connector")
        ...
        .itemOutputs("gtlcecore:module_connector")
        .inputFluids("gtceu:soldering_alloy 2880")
        .EUt(122880)
        .duration(400)

    gtr.assembler("gtlcecore:module_base")
        .itemInputs("gtlcecore:high_strength_concrete", "4x gtceu:technetium_plate", "4x gtceu:osmium_plate")
        .inputFluids("gtceu:soldering_alloy 288")
        .itemOutputs("gtlcecore:module_base")
        .EUt(480)
        .duration(400)
    ...
    gtr.forming_press("gtlcecore:raw_imprinted_resonatic_circuit_board")
        .itemInputs("4x gtceu:circuit_compound_dust", "gtceu:magneto_resonatic_dust")
        .itemOutputs("gtlcecore:raw_imprinted_resonatic_circuit_board")
        .EUt(480)
        .duration(300)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.autoclave("gtlcecore:imprinted_resonatic_circuit_board")
        .itemInputs("gtlcecore:raw_imprinted_resonatic_circuit_board")
        .inputFluids("gtceu:soldering_alloy 432")
        .itemOutputs("gtlcecore:imprinted_resonatic_circuit_board")
        .EUt(1920)
        .duration(300)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_ulv")
        .itemInputs("4x gtceu:tantalum_capacitor", "4x gtceu:resistor", "4x gtceu:inductor", "gtlcecore:imprinted_resonatic_circuit_board", "gtceu:magneto_resonatic_gem", "gtceu:vacuum_tube")
        .itemOutputs("4x gtlcecore:circuit_resonatic_ulv")
        .EUt(30)
        .duration(50)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_lv")
        .itemInputs("4x gtceu:diode", "4x gtceu:capacitor", "4x gtceu:transistor", "gtlcecore:imprinted_resonatic_circuit_board", "gtceu:magneto_resonatic_gem", "gtlcecore:circuit_resonatic_ulv")
        .itemOutputs("4x gtlcecore:circuit_resonatic_lv")
        .EUt(120)
        .duration(90)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_mv")
        .itemInputs("8x gtceu:diode", "8x gtceu:capacitor", "8x gtceu:transistor", "gtlcecore:imprinted_resonatic_circuit_board", "gtceu:magneto_resonatic_gem", "gtlcecore:circuit_resonatic_lv")
        .itemOutputs("4x gtlcecore:circuit_resonatic_mv")
        .EUt(480)
        .duration(150)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_hv")
        .itemInputs("4x gtceu:smd_diode", "4x gtceu:smd_capacitor", "4x gtceu:smd_transistor", "2x gtlcecore:imprinted_resonatic_circuit_board", "gtceu:flawless_magneto_resonatic_gem", "gtlcecore:circuit_resonatic_mv")
        .itemOutputs("4x gtlcecore:circuit_resonatic_hv")
        .EUt(1920)
        .duration(230)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_ev")
        .itemInputs("8x gtceu:smd_diode", "8x gtceu:smd_capacitor", "8x gtceu:smd_transistor", "4x gtlcecore:imprinted_resonatic_circuit_board", "gtceu:flawless_magneto_resonatic_gem", "gtlcecore:circuit_resonatic_hv")
        .itemOutputs("4x gtlcecore:circuit_resonatic_ev")
        .EUt(7680)
        .duration(330)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_iv")
        .itemInputs("4x gtceu:advanced_smd_diode", "4x gtceu:advanced_smd_capacitor", "4x gtceu:advanced_smd_transistor", "4x gtlcecore:imprinted_resonatic_circuit_board", "gtceu:flawless_magneto_resonatic_gem", "gtlcecore:circuit_resonatic_ev")
        .itemOutputs("4x gtlcecore:circuit_resonatic_iv")
        .EUt(30720)
        .duration(450)

    gtr.circuit_assembler("gtlcecore:circuit_resonatic_luv")
        .itemInputs("8x gtceu:advanced_smd_diode", "8x gtceu:advanced_smd_capacitor", "8x gtceu:advanced_smd_transistor", "4x gtlcecore:imprinted_resonatic_circuit_board", "gtceu:flawless_magneto_resonatic_gem", "gtlcecore:circuit_resonatic_iv")
        .itemOutputs("4x gtlcecore:circuit_resonatic_luv")
        .EUt(122880)
        .duration(570)
    ...
    circuits.forEach((circuit) => {
        gtr.circuit_assembler("gtlcecore:circuit_resonatic_" + circuit[1])
            .itemInputs("16x gtlcecore:smd_diode_" + circuit[0], "16x gtlcecore:smd_capacitor_" + circuit[0], "16x gtlcecore:smd_transistor_" + circuit[0], "8x gtlcecore:imprinted_resonatic_circuit_board", "gtceu:exquisite_magneto_resonatic_gem", "gtlcecore:circuit_resonatic_" + circuit[2])
            .itemOutputs("4x gtlcecore:circuit_resonatic_" + circuit[1])
            .EUt(122880 * (4 ** circuit[3]))
            .duration(570 + (120 + (20 * circuit[3])))
    })

    gtr.electric_blast_furnace("gtlcecore:rutherfordium_neutronium_boule")
        .itemInputs("gtceu:neutronium_boule", "4x gtceu:rutherfordium_dust")
        .inputFluids("gtceu:radon 8000")
        .itemOutputs("gtlcecore:rutherfordium_neutronium_boule")
        .EUt(30720)
        .duration(21000)
    ...
    gtr.chemical_bath("gtlcecore:fullerene_polymer_matrix_soft_tubing")
        .itemInputs("gtceu:fine_polyetheretherketone_wire")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 18")
        .itemOutputs("gtlcecore:fullerene_polymer_matrix_soft_tubing")
        .EUt(100)
        .duration(80)

    gtr.vacuum_freezer("gtlcecore:fullerene_polymer_matrix_fine_tubing")
        .itemInputs("gtlcecore:fullerene_polymer_matrix_soft_tubing")
        .itemOutputs("gtlcecore:fullerene_polymer_matrix_fine_tubing")
        .EUt(500)
        .duration(240)
    ...
    gtr.assembler("gtceu:luv_solar_panel")
        .itemInputs("4x gtlcecore:pm_wafer", "16x gtceu:solar_panel", "16x gtceu:ulv_solar_panel", "16x gtceu:lv_solar_panel", "2x gtceu:cosmicneutronium_quadruple_wire", "4x gtceu:fusion_glass", "4x gtceu:double_hastelloyk_243_plate")
    ...
    gtr.assembler("gtceu:zpm_solar_panel")
        .itemInputs("4x gtlcecore:fm_wafer", "16x gtceu:mv_solar_panel", "16x gtceu:hv_solar_panel", "16x gtceu:ev_solar_panel", "2x gtceu:cosmicneutronium_hex_wire", "16x gtceu:fusion_glass", "16x gtceu:double_vibranium_plate")
    ...
    gtr.assembler("gtceu:uv_solar_panel")
        .itemInputs("16x gtlcecore:fm_wafer", "16x gtceu:iv_solar_panel", "16x gtceu:luv_solar_panel", "16x gtceu:zpm_solar_panel", "2x gtceu:infinity_hex_wire", "64x gtceu:fusion_glass", "64x gtceu:double_neutronium_plate")
        .itemOutputs("gtceu:uv_solar_panel")
        .inputFluids("gtceu:super_mutated_living_solder 576")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_0")
        .itemInputs("64x gtceu:lafium_block", "64x gtceu:potin_block")
        .itemOutputs("gtlcecore:combined_singularity_0")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_1")
        .itemInputs("64x gtceu:enderite_block", "64x gtceu:indium_gallium_phosphide_block")
        .itemOutputs("gtlcecore:combined_singularity_1")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_2")
        .itemInputs("64x gtceu:ruthenium_trinium_americium_neutronate_block", "64x gtceu:yttrium_barium_cuprate_block")
        .itemOutputs("gtlcecore:combined_singularity_2")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_3")
        .itemInputs("64x gtceu:hastelloyk_243_block", "64x gtceu:cobalt_brass_block")
        .itemOutputs("gtlcecore:combined_singularity_3")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_4")
        .itemInputs("64x gtceu:titansteel_block", "64x gtceu:uranium_rhodium_dinaquadide_block")
        .itemOutputs("gtlcecore:combined_singularity_4")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_5")
        .itemInputs("64x gtceu:hastelloy_x_block", "64x gtceu:red_steel_block")
        .itemOutputs("gtlcecore:combined_singularity_5")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_6")
        .itemInputs("64x gtceu:highurabilityompoundteel_block", "64x gtceu:germaniumtungstennitride_block")
        .itemOutputs("gtlcecore:combined_singularity_6")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_7")
        .itemInputs("64x gtceu:hsse_block", "64x gtceu:watertight_steel_block")
        .itemOutputs("gtlcecore:combined_singularity_7")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_8")
        .itemInputs("64x gtceu:pikyonium_block", "64x gtceu:aluminium_bronze_block")
        .itemOutputs("gtlcecore:combined_singularity_8")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_9")
        .itemInputs("64x gtceu:abyssalalloy_block", "64x gtceu:soldering_alloy_block")
        .itemOutputs("gtlcecore:combined_singularity_9")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_10")
        .itemInputs("64x gtceu:black_titanium_block", "64x gtceu:nickel_zinc_ferrite_block")
        .itemOutputs("gtlcecore:combined_singularity_10")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_11")
        .itemInputs("64x gtceu:ultimet_block", "64x gtceu:hsla_steel_block")
        .itemOutputs("gtlcecore:combined_singularity_11")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_12")
        .itemInputs("64x gtceu:enriched_naquadah_trinium_europium_duranide_block", "64x gtceu:rtm_alloy_block")
        .itemOutputs("gtlcecore:combined_singularity_12")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_13")
        .itemInputs("64x gtceu:blue_steel_block", "64x gtceu:hastelloy_c_276_block")
        .itemOutputs("gtlcecore:combined_singularity_13")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_14")
        .itemInputs("64x gtceu:cinobite_block", "64x gtceu:stellite_100_block")
        .itemOutputs("gtlcecore:combined_singularity_14")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.neutron_compressor("gtlcecore:combined_singularity_15")
        .itemInputs("64x gtceu:maraging_steel_300_block", "64x gtceu:grisium_block")
        .itemOutputs("gtlcecore:combined_singularity_15")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(200)
    ...
    gtr.qft("avaritia:eternal_singularity")
        ...
        .itemInputs("64x gtceu:neutronium_block",
            "gtlcecore:combined_singularity_0",
            "gtlcecore:combined_singularity_1",
            "gtlcecore:combined_singularity_2",
            "gtlcecore:combined_singularity_3",
            "gtlcecore:combined_singularity_4",
            "gtlcecore:combined_singularity_5",
            "gtlcecore:combined_singularity_6",
            "gtlcecore:combined_singularity_7",
            "gtlcecore:combined_singularity_8",
            "gtlcecore:combined_singularity_9",
            "gtlcecore:combined_singularity_10",
            "gtlcecore:combined_singularity_11",
            "gtlcecore:combined_singularity_12",
            "gtlcecore:combined_singularity_13",
            "gtlcecore:combined_singularity_14",
            "gtlcecore:combined_singularity_15")
    ...
    gtr.qft("gtceu:spatialfluid")
        .notConsumable("gtlcecore:hypercube")
        .notConsumable("gtlcecore:quantum_anomaly")
    ...
    gtr.qft("gtlcecore:quantum_anomaly")
        .chancedInput("gtceu:draconium_nanoswarm", 100, 0)
        .itemInputs("gtlcecore:entangled_singularity")
        .inputFluids("gtceu:duranium 144", "gtceu:exciteddtec 100")
        .chancedOutput("gtlcecore:quantum_anomaly", 1000, 0)
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(400)

    gtr.qft("gtceu:radox_gas")
        .notConsumable("gtlcecore:quantum_anomaly")
        .itemInputs("64x gtlcecore:variation_wood")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcecore:hypercube_1")
        .itemInputs("16x gtceu:transcendentmetal_rod", "gtlcecore:quantum_anomaly")
        .inputFluids("gtceu:exciteddtec 1000", "gtceu:spatialfluid 1000")
        .itemOutputs("64x gtlcecore:hypercube")
        .outputFluids("gtceu:dimensionallytranscendentresidue 100")
        .EUt(16 * GTValues.VA[GTValues.MAX])
        .duration(6400)
        .blastFurnaceTemp(62000)
    ...
    gtr.autoclave("gtlcecore:hassium_seed_crystal")
        .itemInputs("gtceu:tiny_hassium_dust")
        .inputFluids("gtceu:nitrogen 10000")
        .itemOutputs("gtlcecore:hassium_seed_crystal")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:manipulator")
        ...
        .inputFluids("gtceu:mutated_living_solder 576")
        .itemOutputs("gtlcecore:manipulator")
        .EUt(30720)
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.assembler("gtlcecore:wyvern_energy_core")
        .itemInputs("16x gtlcecore:wyvern_core", "64x gtlcecore:draconium_block_charged", "64x gtceu:iv_lapotronic_battery", "64x gtceu:luv_lapotronic_battery", "64x gtceu:double_draconium_plate")
        .inputFluids("gtceu:mutated_living_solder 5760")
        .itemOutputs("gtlcecore:wyvern_energy_core")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(2400)

    gtr.sps_crafting("gtlcecore:dust_blizz")
        ...
        .itemOutputs("2x gtlcecore:dust_blizz")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(200)

    gtr.alloy_smelter("gtlcecore:dust_cryotheum")
        .itemInputs("gtlcecore:dust_blizz", "gtceu:enderium_dust")
        .itemOutputs("2x gtlcecore:dust_cryotheum")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(160)

    gtr.extractor("gtlcecore:gelid_cryotheum")
        .itemInputs("gtlcecore:dust_cryotheum")
        .outputFluids("gtlcecore:gelid_cryotheum 144")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(80)
    ...
    gtr.stellar_forge("gtceu:actinium_superhydride_plasma")
        .itemInputs("gtlcecore:naquadria_charge", "36x gtceu:atinium_hydride_dust")
    ...
    gtr.canner("gtlcecore:actinium_superhydride_plasma_containment_cell")
        .notConsumable("gtceu:infuscolium_nanoswarm")
        .inputFluids("gtceu:actinium_superhydride_plasma 1000")
        .itemInputs("gtlcecore:plasma_containment_cell")
        .itemOutputs("gtlcecore:actinium_superhydride_plasma_containment_cell")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(20)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.plasma_condenser("gtceu:actinium_superhydride_dust")
        .itemInputs("gtlcecore:actinium_superhydride_plasma_containment_cell")
        .inputFluids("gtceu:liquid_helium 24000")
        .itemOutputs("13x gtceu:actinium_superhydride_dust", "gtlcecore:plasma_containment_cell")
    ...
    gtr.large_chemical_reactor("gtlcecore:charged_lepton_trap_crystal")
        .notConsumable("gtceu:starmetal_nanoswarm")
        .itemInputs("gtlcecore:lepton_trap_crystal", "2x gtceu:small_vibranium_dust")
        .inputFluids("gtceu:free_electron_gas 1000", "gtceu:heavy_lepton_mixture 1000")
        .itemOutputs("gtlcecore:charged_lepton_trap_crystal")
        .EUt(491520)
        .duration(240)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.electric_blast_furnace("gtlcecore:lepton_trap_crystal")
        .itemInputs("gtceu:meitnerium_dust", "gtceu:molybdenum_dust", "gtceu:rhenium_dust")
        .inputFluids("gtceu:naquadah_alloy 288")
        .itemOutputs("gtlcecore:lepton_trap_crystal")
        .EUt(3450000)
        .duration(340)
    ...
    gtr.assembler("gtlcecore:integrated_ore_processor")
        ...
        .itemOutputs("gtlcecore:integrated_ore_processor")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(1000)

    gtr.alloy_smelter("gtlcecore:dragon_strength_tritanium_casing")
        .itemInputs("16x gtlcecore:extreme_strength_tritanium_casing", "16x gtlcecore:draconium_block_charged")
        .itemOutputs("gtlcecore:dragon_strength_tritanium_casing")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2000)

    gtr.chemical_reactor("gtlcecore:blaze_blast_furnace_casing")
        ...
        .itemOutputs("gtlcecore:blaze_blast_furnace_casing")
        .EUt(1920)
        .duration(900)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.assembly_line("gtlcecore:dimension_creation_casing")
        .itemInputs("gtceu:infinity_frame",
            ...
            "64x gtceu:uv_world_accelerator",
            "16x gtlcecore:hyper_core",
            "4x gtlcecore:spacetimebendingcore",
            "4x gtlcecore:dimensional_stability_casing",
            "4x gtlcecore:spacetime_compression_field_generator",
            "6x gtlcecore:topological_manipulator_unit",
            "gtlcecore:max_field_generator",
        ...
        .itemOutputs("gtlcecore:dimension_creation_casing")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:dimension_connection_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(8192))

    gtr.assembly_line("gtlcecore:door_of_create")
        .itemInputs("16x gtceu:infinity_frame",
            "16x gtlcecore:eye_of_harmony",
            "16x gtlcecore:dimension_creation_casing",
            "16x gtlcecore:dimension_connection_casing",
            "8x gtlcecore:suprachronal_mainframe_complex",
            "8x gtlcecore:cosmic_singularity",
            "8x gtlcecore:chaotic_core",
            "64x gtlcecore:void_matter",
            "16x gtlcecore:quantum_anomaly",
            "16x gtlcecore:max_robot_arm",
            "gtlcecore:mega_max_battery",
        ...
        .itemOutputs("gtlcecore:door_of_create")
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(2400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:dimension_creation_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(16384))

    gtr.assembler("gtlcecore:dimension_connection_casing")
        .itemInputs("gtceu:draconium_frame", "gtlcecore:dimensional_bridge_casing", "gtceu:periodicium_block", "8x gtceu:double_mithril_plate", "4x gtceu:cosmic_plate", "2x gtceu:double_shirabon_plate")
        .itemOutputs("gtlcecore:dimension_connection_casing")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(400)
    ...
    gtr.assembler("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_helmet")
        .notConsumable("gtceu:spacetime_nanoswarm")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .itemInputs("50x gtceu:magnetohydrodynamicallyconstrainedstarmatter_ingot", "gtlcecore:command_block_core")
        .itemOutputs("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_helmet")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .circuit(1)
        .duration(200)

    gtr.assembler("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_chestplate")
        .notConsumable("gtceu:spacetime_nanoswarm")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .itemInputs("80x gtceu:magnetohydrodynamicallyconstrainedstarmatter_ingot", "gtlcecore:command_block_core")
        .itemOutputs("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_chestplate")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .circuit(2)
        .duration(200)

    gtr.assembler("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_leggings")
        .notConsumable("gtceu:spacetime_nanoswarm")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .itemInputs("70x gtceu:magnetohydrodynamicallyconstrainedstarmatter_ingot", "gtlcecore:command_block_core")
        .itemOutputs("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_leggings")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .circuit(3)
        .duration(200)

    gtr.assembler("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_boots")
        .notConsumable("gtceu:spacetime_nanoswarm")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .itemInputs("40x gtceu:magnetohydrodynamicallyconstrainedstarmatter_ingot", "gtlcecore:command_block_core")
        .itemOutputs("gtlcecore:magnetohydrodynamicallyconstrainedstarmatter_boots")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .circuit(4)
        .duration(200)
    ...
    gtr.assembler("gtlcecore:echo_casing")
        .itemInputs("gtceu:europium_frame", "gtlcecore:reinforced_echo_shard", "6x gtceu:double_hsse_plate")
        .itemOutputs("2x gtlcecore:echo_casing")
        .circuit(6)
        .EUt(30)
        .duration(200)

    gtr.precision_assembler("gtlcecore:machine_casing_grinding_head")
        .itemInputs("gtceu:europium_frame", "8x gtlcecore:reinforced_echo_shard", "6x gtceu:tungsten_grinding_head", "36x gtceu:double_hsse_plate")
        .inputFluids("gtceu:annealed_copper 1440", "gtceu:invar 1440", "gtceu:nickel_zinc_ferrite 1440", "gtceu:osmiridium 1440")
        .itemOutputs("gtlcecore:machine_casing_grinding_head")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1600)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.precision_assembler("gtlcecore:bedrock_drill")
        .itemInputs("gtlcecore:reinforced_echo_shard", "minecraft:bedrock", "gtceu:neutronium_buzz_saw_blade", "4x gtceu:double_neutronium_plate")
        .inputFluids("gtceu:rhodium 576", "gtceu:hastelloy_x 576", "gtceu:hsss 576", "gtceu:hsse 576")
        .itemOutputs("gtlcecore:bedrock_drill")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1600)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)
    ...
    gtr.fluid_solidifier("gtlcecore:memory_foam_block")
        .notConsumable("gtceu:block_casting_mold")
        .inputFluids("gtceu:viscoelastic_polyurethane_foam 1000")
        .itemOutputs("gtlcecore:memory_foam_block")
        .EUt(30)
        .duration(60)
    ...
    gtr.electric_blast_furnace("gtlcecore:aerographene")
        .itemInputs("gtceu:dry_graphene_gel_dust")
        .inputFluids("gtceu:supercritical_carbon_dioxide 1000")
        .itemOutputs("gtlcecore:aerographene")
        .EUt(120)
        .duration(400)
        .blastFurnaceTemp(5000)

    gtr.qft("gtlcecore:hyper_stable_self_healing_adhesive")
        ...
        .chancedOutput("gtlcecore:hyper_stable_self_healing_adhesive", 2000, 0)
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(20)

    gtr.qft("gtlcecore:black_body_naquadria_supersolid")
        .chancedInput("gtceu:uruium_nanoswarm", 500, 0)
        ...
        .chancedOutput("gtlcecore:black_body_naquadria_supersolid", 2000, 0)
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(20)

    gtr.assembler("gtlcecore:two_way_foil")
        .itemInputs("gtceu:chaos_foil", "gtlcecore:hyper_stable_self_healing_adhesive", "gtlcecore:cosmic_fabric")
        .itemOutputs("gtlcecore:two_way_foil")
        .EUt(4 * GTValues.VA[GTValues.MAX])
        .duration(200)

    gtr.dimensionally_transcendent_plasma_forge("gtlcecore:infinity_glass")
        .itemInputs("gtlcecore:black_body_naquadria_supersolid", "2x gtceu:infinity_dust")
        .inputFluids("gtceu:dimensionallytranscendentexoticcatalyst 1000", "gtceu:woods_glass 9216")
        .itemOutputs("gtlcecore:infinity_glass")
        .EUt(4096 * GTValues.VA[GTValues.MAX])
        .duration(1600)
        .blastFurnaceTemp(88000)

    gtr.dimensionally_transcendent_plasma_forge("gtlcecore:create_casing")
        .itemInputs("gtceu:eternity_frame", "gtlcecore:command_block_core")
        .inputFluids("gtceu:exciteddtsc 1000", "gtceu:primordialmatter 1000")
        .itemOutputs("gtlcecore:create_casing")
        .EUt(16384 * GTValues.VA[GTValues.MAX])
        .duration(3200)
        .blastFurnaceTemp(96000)

    gtr.gravitation_shockburst("gtlcecore:chain_command_block_core")
        .itemInputs("gtlcecore:command_block_core", "64x minecraft:observer")
        .itemOutputs("gtlcecore:chain_command_block_core")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .duration(20)

    gtr.gravitation_shockburst("gtlcecore:repeating_command_block_core")
        .itemInputs("gtlcecore:chain_command_block_core", "64x minecraft:calibrated_sculk_sensor")
        .itemOutputs("gtlcecore:repeating_command_block_core")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .duration(20)

    gtr.gravitation_shockburst("gtlcecore:command_block_broken")
        .itemInputs("minecraft:command_block", "gtceu:magnetohydrodynamicallyconstrainedstarmatter_dust")
        .itemOutputs("gtlcecore:command_block_broken")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .duration(20)

    gtr.gravitation_shockburst("gtlcecore:chain_command_block_broken")
        .itemInputs("minecraft:chain_command_block", "gtceu:magnetohydrodynamicallyconstrainedstarmatter_dust")
        .itemOutputs("gtlcecore:chain_command_block_broken")
        .EUt(65536 * GTValues.VA[GTValues.MAX])
        .duration(20)

    gtr.assembly_line("gtlcecore:chaotic_energy_core")
        .itemInputs("gtlcecore:draconic_energy_core",
            "64x gtceu:uhv_ultimate_battery",
            "16x gtlcecore:chaotic_core",
        ...
        .itemOutputs("gtlcecore:chaotic_energy_core")
        .EUt(64 * GTValues.VA[GTValues.MAX])
        .duration(2560)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:create_ultimate_battery"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(16384))

    gtr.assembly_line("gtlcecore:hollow_casing")
        .itemInputs("gtlcecore:molecular_casing",
        ...
        .itemOutputs("2x gtlcecore:hollow_casing")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:molecular_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:spacetime_assembly_line_unit")
        .itemInputs("gtceu:adamantium_frame",
            "gtlcecore:advanced_assembly_line_unit",
            "gtlcecore:machine_casing_circuit_assembly_line",
            "gtlcecore:precision_circuit_assembly_robot_mk2",
            "gtceu:osmium_nanoswarm",
            "6x gtlcecore:optical_processing_core",
            "2x #gtceu:circuits/uev",
        ...
        .itemOutputs("gtlcecore:spacetime_assembly_line_unit")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:advanced_assembly_line_unit"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:molecular_coil")
        .itemInputs("gtlcecore:hollow_casing",
        ...
        .itemOutputs("2x gtlcecore:molecular_coil")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)
    ...
    gtr.assembly_line("gtlcecore:containment_field_generator")
        .itemInputs("gtlcecore:hollow_casing",
        ...
        .itemOutputs("gtlcecore:containment_field_generator")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(500)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:force_field_glass"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:crystalline_infinity")
        ...
        .inputFluids("gtceu:lanthanum 2304", "gtceu:cobalt_brass 5760", "gtceu:battery_alloy 5760", "gtceu:molybdenum_disilicide 1296")
        .itemOutputs("gtlcecore:crystalline_infinity")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(600)
    ...
    gtr.assembly_line("gtlcecore:star_ultimate_material_forge_factory")
        .itemInputs("4x gtlcecore:stellar_forge",
            ...
            "4x gtceu:uxv_sensor",
            "16x #gtceu:circuits/uxv",
            "8x gtlcecore:containment_field_generator",
            "8x gtlcecore:hyper_core",
        ...
        .itemOutputs("gtlcecore:star_ultimate_material_forge_factory")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(1200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:ultimate_stellar_containment_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:suprachronal_assembly_line")
        .itemInputs("gtlcecore:infinite_cell_component",
            "16x gtlcecore:advanced_assembly_line",
            "16x gtlcecore:circuit_assembly_line",
            "4x gtlcecore:spacetime_assembly_line_casing",
            "4x gtlcecore:spacetime_assembly_line_unit",
            "32x gtlcecore:molecular_coil",
            "16x gtceu:uev_emitter",
            "16x gtceu:uev_sensor",
            "16x gtlcecore:precision_circuit_assembly_robot_mk3",
            "16x #gtceu:circuits/uiv",
            "gtceu:max_battery",
        ...
        .itemOutputs("gtlcecore:suprachronal_assembly_line")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:assembler_module"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(256))

    gtr.assembler("gtlcecore:force_field_glass")
        ...
        .inputFluids("gtceu:mutated_living_solder 1296")
        .itemOutputs("gtlcecore:force_field_glass")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:molecular_casing")
        ...
        .itemOutputs("gtlcecore:molecular_casing")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:spacetime_assembly_line_casing")
        ...
        .inputFluids("gtceu:liquid_degenerate_rhenium 200")
        .itemOutputs("gtlcecore:spacetime_assembly_line_casing")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:electric_implosion_compressor")
        ...
        .inputFluids("gtceu:soldering_alloy 1296")
        .itemOutputs("gtlcecore:electric_implosion_compressor")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(600)

    gtr.compressor("gtlcecore:dimensionally_transcendent_dirt_forge")
        .itemInputs("16x gtceu:primitive_blast_furnace")
        .itemOutputs("gtlcecore:dimensionally_transcendent_dirt_forge")
        .EUt(8)
        .duration(1200)

    gtr.compressor("gtlcecore:dimensionally_transcendent_steam_boiler")
        .itemInputs("16x gtceu:tungstensteel_large_boiler")
        .itemOutputs("gtlcecore:dimensionally_transcendent_steam_boiler")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1200)

    gtr.assembler("gtlcecore:steam_mega_turbine")
        ...
        .itemOutputs("gtlcecore:steam_mega_turbine")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(1200)

    gtr.assembler("gtlcecore:gas_mega_turbine")
        ...
        .itemOutputs("gtlcecore:gas_mega_turbine")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1200)

    gtr.assembler("gtlcecore:rocket_mega_turbine")
        .itemInputs("8x gtlcecore:rocket_large_turbine", "16x #gtceu:circuits/zpm", "4x gtceu:iv_electric_motor", "8x gtceu:iv_electric_piston", "8x gtceu:tungsten_turbine_blade", "8x gtceu:double_vanadium_steel_plate", "32x gtceu:double_titanium_plate")
        .itemOutputs("gtlcecore:rocket_mega_turbine")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1200)

    gtr.assembler("gtlcecore:plasma_mega_turbine")
        ...
        .itemOutputs("gtlcecore:plasma_mega_turbine")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(1200)

    gtr.assembler("gtlcecore:chemical_energy_devourer")
        ...
        .itemOutputs("gtlcecore:chemical_energy_devourer")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1200)

    gtr.assembler("gtlcecore:degenerate_rhenium_constrained_casing")
        .circuit(6)
        .itemInputs("gtceu:quantanium_frame", "6x gtceu:degenerate_rhenium_plate")
        .itemOutputs("2x gtlcecore:degenerate_rhenium_constrained_casing")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1200)

    gtr.assembler("gtlcecore:rhenium_reinforced_energy_glass")
        .itemInputs("4x gtceu:fusion_glass", "6x gtceu:degenerate_rhenium_plate")
        .itemOutputs("2x gtlcecore:rhenium_reinforced_energy_glass")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1200)

    gtr.ultimate_material_forge("gtlcecore:proto_matter")
        .itemInputs("gtlcecore:triplet_neutronium_sphere")
        .inputFluids("gtceu:uu_matter 1000")
        .itemOutputs("gtlcecore:proto_matter")
    ...
    implosion_compressor_add(["minecraft:command_block", "gtlcecore:two_way_foil"], "gtlcecore:command_block_core", 1)
    implosion_compressor_add(["ae2:singularity", "gtlcecore:warped_ender_pearl"], "gtlcecore:entangled_singularity", 1)
    ...
    gtr.assembler("gtlcecore:petrochemical_plant")
        .itemInputs("16x gtceu:watertight_steel_frame", "8x gtceu:large_distillery", "4x gtlcecore:large_cracker", "gtlcecore:chemical_plant", "4x #gtceu:circuits/uhv", "4x gtceu:zpm_emitter", "16x gtceu:zpm_fluid_regulator", "16x gtceu:stainless_steel_nonuple_fluid_pipe", "32x gtceu:double_stainless_steel_plate")
        .itemOutputs("gtlcecore:petrochemical_plant")
        .inputFluids("gtceu:soldering_alloy 1296")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(1000)
    ...
    for (let index = 0; index < 8; index++) {
        gtr.assembler("gtceu:max_" + 256 * (4 ** index) + "a_laser_target_hatch")
            .itemInputs("gtceu:max_machine_hull",
                ...
                (2 ** index) + "x gtlcecore:max_sensor",
                (2 ** index) + "x gtlcecore:max_electric_pump",
        ...
        gtr.assembler("gtceu:max_" + 256 * (4 ** index) + "a_laser_source_hatch")
            .itemInputs("gtceu:max_machine_hull",
                (2 ** index) + "x gtceu:diamond_lens",
                (2 ** index) + "x gtlcecore:max_emitter",
                (2 ** index) + "x gtlcecore:max_electric_pump",
                "4x gtceu:cosmicneutronium_single_cable")
    ...
    gtr.dyson_sphere("gtceu:dysonsphere")
        .inputFluids("gtlcecore:gelid_cryotheum 1")
        .circuit(1)
    ...
    gtr.dyson_sphere("gtceu:dysonspherelaunch")
        .itemInputs("64x gtlcecore:dyson_swarm_module")
    ...
    gtr.compressor("gtlcecore:dimensionally_transcendent_steam_oven")
        .itemInputs("16x gtceu:steam_oven")
        .itemOutputs("gtlcecore:dimensionally_transcendent_steam_oven")
        .EUt(16)
        .duration(1200)

    gtr.assembler("gtlcecore:slaughterhouse")
        ...
        .itemOutputs("gtlcecore:slaughterhouse")
        .EUt(30)
        .duration(400)

    gtr.assembly_line("gtlcecore:holy_separator")
        ...
        .itemOutputs("gtlcecore:holy_separator")
        .duration(1000)
        .EUt(GTValues.VA[GTValues.UEV])
    ...
    gtr.large_chemical_reactor("gtceu:mutated_living_solder")
        ...
        .itemInputs("16x gtlcecore:biological_cells", "gtceu:quantum_star")
    ...
    gtr.autoclave("gtceu:super_mutated_living_solder")
        ...
        .itemInputs("64x gtlcecore:space_essence", "64x gtlcecore:draconium_dust")
        .outputFluids("gtceu:super_mutated_living_solder 10000")
        .itemOutputs("gtlcecore:essence_block")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(2400)

    gtr.distillery("gtceu:salt_water")
    ...
    gtr.distillery("gtceu:grade_7_purified_water")
    ...
    gtr.large_chemical_reactor("gtceu:grade_11_purified_water")
        .notConsumable("gtlcecore:fullerene_polymer_matrix_soft_tubing")
        .notConsumable("gtlcecore:electron_source")
    ...
    gtr.distillery("gtceu:grade_12_purified_water")
    ...
    gtr.precision_assembler("gtlcecore:power_core")
        .itemInputs("4x gtlcecore:power_module", "8x gtceu:uv_field_generator", "64x gtceu:gravitation_engine_unit", "16x gtceu:double_naquadria_plate")
        .inputFluids("gtceu:rhodium 2880", "gtceu:americium 2880", "gtceu:enriched_naquadah 2880", "gtceu:trinium 2880")
        .itemOutputs("gtlcecore:power_core")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(2400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:dyson_swarm_module")
        .itemInputs("16x gtceu:enriched_naquadah_frame", "64x gtceu:solar_panel", "gtceu:uev_sensor", "gtceu:uev_emitter")
        .inputFluids("gtceu:mutated_living_solder 20000", "gtlcecore:gelid_cryotheum 20000", "gtceu:neutronium 18432", "gtceu:orichalcum 18432")
        .itemOutputs("64x gtlcecore:dyson_swarm_module")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(800)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.precision_assembler("gtlcecore:dyson_control_casing")
        .itemInputs("gtceu:uiv_machine_hull", "gtlcecore:exotic_processing_core", "#gtceu:circuits/uiv", "gtceu:high_performance_computation_array")
        .inputFluids("gtceu:mutated_living_solder 576", "gtceu:pcb_coolant 2000", "gtceu:ruthenium 2304", "gtceu:naquadah 1296")
        .itemOutputs("gtlcecore:dyson_control_casing")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:dyson_receiver_casing")
        .itemInputs("gtceu:uiv_charger_4x", "2x gtlcecore:pm_chip", "4x gtlcecore:uiv_voltage_coil", "gtceu:echoite_quadruple_wire")
        .inputFluids("gtceu:mutated_living_solder 1296", "gtlcecore:gelid_cryotheum 576", "gtceu:echo_shard 2304", "gtceu:infuscolium 1296")
        .itemOutputs("gtlcecore:dyson_receiver_casing")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembly_line("gtlcecore:dyson_deployment_core")
        .itemInputs("4x gtceu:uiv_machine_hull",
            ...
            "64x minecraft:dispenser",
            "64x minecraft:dispenser")
        .inputFluids("gtceu:lubricant 48000", "gtceu:mutated_living_solder 12800", "gtlcecore:gelid_cryotheum 128000", "gtceu:copernicium 256000")
        .itemOutputs("gtlcecore:dyson_deployment_core")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(1200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:power_core"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:dyson_sphere")
        .itemInputs("4x gtceu:uiv_diode",
            "16x gtlcecore:pm_wafer",
            "16x gtceu:uiv_sensor",
            "4x gtlcecore:dyson_control_toroid",
            "64x gtceu:superconducting_coil",
            "16x #gtceu:circuits/uxv",
            "32x gtceu:echoite_hex_wire",
            "4x gtlcecore:uxv_voltage_coil",
            "16x gtceu:double_vibranium_plate")
        .inputFluids("gtceu:mutated_living_solder 12000", "gtlcecore:gelid_cryotheum 12800", "gtceu:scandium 576000", "gtceu:mercury_barium_calcium_cuprate 576000")
        .itemOutputs("gtlcecore:dyson_sphere")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(1600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:dyson_receiver_casing"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:dyson_deployment_casing")
        ...
        .inputFluids("gtceu:mutated_living_solder 1000", "gtlcecore:gelid_cryotheum 1000", "gtceu:lubricant 2000", "gtceu:copernicium 1296")
        .itemOutputs("gtlcecore:dyson_deployment_casing")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:module_connector"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:dyson_control_toroid")
        .itemInputs("gtceu:black_titanium_frame",
            "4x gtceu:uiv_emitter",
            "2x gtceu:uiv_electric_pump",
            "2x #gtceu:circuits/uiv",
            "gtlcecore:exotic_processing_core",
            "8x gtceu:infuscolium_bolt",
            "24x gtceu:neutronium_foil")
        .inputFluids("gtceu:mutated_living_solder 2000", "gtlcecore:gelid_cryotheum 1000", "gtceu:zylon 1296", "gtceu:kevlar 1296")
        .itemOutputs("gtlcecore:dyson_control_toroid")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:spacetime_assembly_line_unit"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:restraint_device")
        .itemInputs("2x gtlcecore:hollow_casing",
            "2x gtlcecore:force_field_glass",
            "6x gtlcecore:laser_cooling_unit",
        ...
        .itemOutputs("gtlcecore:restraint_device")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(1600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:containment_field_generator"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:atomic_energy_excitation_plant")
        .itemInputs("8x gtceu:uev_mixer",
            ...
            "4x gtlcecore:reinforced_echo_shard")
        .inputFluids("gtceu:lubricant 8000", "gtceu:mutated_living_solder 2000", "gtceu:echoite 1152", "gtceu:mana 32000")
        .itemOutputs("gtlcecore:atomic_energy_excitation_plant")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(4000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:restraint_device"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(512))
    ...
    gtr.fluid_solidifier("gtlcecore:pellet_antimatter")
        .inputFluids("gtceu:antimatter 1000")
        .notConsumable("gtlcecore:ball_field_shape")
        .itemOutputs("gtlcecore:pellet_antimatter")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(800)

    gtr.ultimate_material_forge("gtlcecore:pellet_antimatter")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:antihydrogen 10")
        .itemInputs("64x ae2:matter_ball", "gtceu:neutronium_nugget")
        .itemOutputs("gtlcecore:pellet_antimatter")
        .chancedOutput("gtlcecore:void_matter", 100, 0)
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(2000)

    gtr.ultimate_material_forge("gtlcecore:corporeal_matter")
        .itemInputs("gtlcecore:proto_matter", "minecraft:iron_block")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:nihonium 100")
        .itemOutputs("gtlcecore:corporeal_matter")
        .chancedOutput("gtceu:heavy_quark_degenerate_matter_nugget", 500, 0)
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(800)

    gtr.ultimate_material_forge("gtlcecore:kinetic_matter")
        .itemInputs("gtlcecore:corporeal_matter", "gtceu:tritanium_block")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:naquadria 1000")
        .itemOutputs("gtlcecore:kinetic_matter")
        .chancedOutput("gtlcecore:amorphous_matter", 200, 0)
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(600)

    gtr.ultimate_material_forge("gtlcecore:amorphous_matter")
        .itemInputs("gtlcecore:corporeal_matter", "gtceu:carbon_nanotubes_block")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:legendarium 1000")
        .itemOutputs("gtlcecore:amorphous_matter")
        .chancedOutput("gtlcecore:essentia_matter", 100, 0)
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(800)

    gtr.ultimate_material_forge("gtlcecore:essentia_matter")
        .itemInputs("gtlcecore:amorphous_matter", "gtceu:heavy_quark_degenerate_matter_block")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:quantumchromodynamically_confined_matter 1000")
        .itemOutputs("gtlcecore:essentia_matter")
        .chancedOutput("gtlcecore:dark_matter", 100, 0)
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(1200)

    gtr.ultimate_material_forge("gtlcecore:omni_matter")
        .itemInputs("gtlcecore:essentia_matter", "gtlcecore:kinetic_matter")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:dense_neutron_plasma 1000")
        .itemOutputs("gtlcecore:omni_matter")
        .chancedOutput("gtceu:tiny_cosmicneutronium_dust", 1000, 0)
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(800)

    gtr.ultimate_material_forge("gtlcecore:void_matter")
        .itemInputs("gtlcecore:omni_matter", "gtlcecore:pellet_antimatter")
        .inputFluids("gtceu:uu_matter 2000", "gtceu:gluons 1000")
        .itemOutputs("gtlcecore:void_matter")
        .chancedOutput("gtlcecore:corporeal_matter", 2000, 0)
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(400)

    gtr.ultimate_material_forge("gtlcecore:temporal_matter")
        .notConsumable("gtlcecore:quantum_anomaly")
        .itemInputs("gtlcecore:kinetic_matter")
        .inputFluids("gtceu:uu_matter 1000", "gtceu:draconiumawakened_plasma 1000")
        .itemOutputs("gtlcecore:temporal_matter")
        .chancedOutput("gtlcecore:omni_matter", 500, 0)
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(600)

    gtr.ultimate_material_forge("gtlcecore:dark_matter")
        .itemInputs("gtlcecore:temporal_matter", "gtlcecore:void_matter")
        .inputFluids("gtceu:uu_matter 3000", "gtceu:dimensionallytranscendentcrudecatalyst 1000")
        .itemOutputs("gtlcecore:dark_matter")
        .chancedOutput("gtlcecore:kinetic_matter", 1000, 0)
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)

    gtr.assembler("gtlcecore:dyson_deployment_magnet")
        .itemInputs("gtceu:uiv_energy_output_hatch", "4x gtceu:superconducting_coil", "8x gtlcecore:pm_chip", "4x #gtceu:circuits/uiv", "6x gtceu:neutronium_plate")
        .itemOutputs("gtlcecore:dyson_deployment_magnet")
        .inputFluids("gtceu:mutated_living_solder 1296")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)

    gtr.assembler("gtlcecore:sps_casing")
        .itemInputs("gtceu:zylon_block", "gtlcecore:restraint_device", "4x #gtceu:circuits/uev", "4x gtceu:small_quantanium_gear", "gtceu:neutronium_hex_cable", "32x gtceu:polyetheretherketone_foil")
        .inputFluids("gtceu:mutated_living_solder 576")
        .itemOutputs("gtlcecore:sps_casing")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)

    gtr.aggregation_device("gtlcecore:draconic_core")
        .notConsumable("gtlcecore:stabilizer_core")
        .itemInputs("gtlcecore:draconium_dust", "gtceu:zpm_field_generator", "gtceu:lapotronic_energy_orb", "gtceu:mithril_block", "gtceu:hexanitrohexaaxaisowurtzitane_dust", "gtceu:uv_field_generator", "minecraft:nether_star", "gtceu:enderium_block")
        .itemOutputs("2x gtlcecore:draconic_core")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .fusionStartEU(4800000000)

    gtr.aggregation_device("gtlcecore:wyvern_core")
        .notConsumable("gtlcecore:stabilizer_core")
        .itemInputs("gtlcecore:draconium_dust", "gtceu:uhv_field_generator", "gtceu:quantum_eye", "gtceu:adamantine_block", "gtlcecore:draconic_core", "gtceu:uev_field_generator", "gtceu:quantum_star", "gtceu:orichalcum_block")
        .itemOutputs("2x gtlcecore:wyvern_core")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(400)
        .fusionStartEU(4800000000)

    gtr.aggregation_device("gtlcecore:awakened_core")
        .notConsumable("gtlcecore:dragon_stabilizer_core")
        .itemInputs("gtlcecore:draconium_dust", "gtceu:uiv_field_generator", "gtlcecore:dragon_heart", "gtceu:vibranium_block", "gtlcecore:wyvern_core", "gtceu:uxv_field_generator", "gtceu:gravi_star", "gtceu:taranium_block")
        .itemOutputs("2x gtlcecore:awakened_core")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(400)
        .fusionStartEU(4800000000)

    gtr.aggregation_device("gtlcecore:chaotic_core")
        .notConsumable("gtlcecore:dragon_stabilizer_core")
        .itemInputs("gtceu:draconium_nanoswarm", "gtceu:opv_field_generator", "gtlcecore:chaos_shard", "gtceu:legendarium_block", "gtlcecore:awakened_core", "gtlcecore:max_field_generator", "gtlcecore:unstable_star", "gtceu:draconiumawakened_block")
        .itemOutputs("2x gtlcecore:chaotic_core")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(400)
        .fusionStartEU(4800000000)
    ...
    gtr.chemical_bath("gtceu:damascus_steel_dust")
        ...
        .EUt(120)
        .duration(200)
        .dimension("gtlcecore:ancient_world")
    ...
    gtr.incubator("gtceu:stem_cells")
        .chancedInput("gtlcecore:glacio_spirit", 6000, 500)
    ...
    gtr.incubator("gtlcecore:glacio_spirit")
        .chancedInput("4x gtlcecore:glacio_spirit", 1000, 100)
        .itemInputs("16x gtceu:celestine_dust", "gtlcecore:essence")
        .inputFluids("ad_astra:cryo_fuel 100", "gtceu:ice 900")
        .itemOutputs("64x gtlcecore:glacio_spirit")
        .EUt(30720)
        .duration(2000)
    ...
    gtr.assembly_line("gtlcecore:field_extruder_factory")
        ...
        .itemOutputs("gtlcecore:field_extruder_factory")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
    ...
    gtr.assembly_line("gtlcecore:mega_presser")
        ...
        .itemOutputs("gtlcecore:mega_presser")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
    ...
    gtr.assembly_line("gtlcecore:mega_wiremill")
        ...
        .itemOutputs("gtlcecore:mega_wiremill")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
    ...
    gtr.assembly_line("gtlcecore:dimensional_focus_engraving_array")
        ...
        .itemOutputs("gtlcecore:dimensional_focus_engraving_array")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(1600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:engraving_laser_plant"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(256))

    gtr.assembler("gtlcecore:naquadah_alloy_casing")
        .itemInputs("gtceu:naquadah_alloy_frame", "6x gtceu:naquadah_alloy_plate")
        .circuit(6)
        .itemOutputs("gtlcecore:naquadah_alloy_casing")
        .EUt(16)
        .duration(50)
    ...
    gtr.nano_forge("gtceu:draconium_nanoswarm")
        ...
        .itemInputs("8x gtceu:draconium_block", "32x gtceu:highly_advanced_soc_wafer", "32x gtlcecore:optical_ram_wafer", "32x gtlcecore:optical_soc", "8x gtlcecore:exotic_processing_core")
    ...
    gtr.nano_forge("gtceu:cosmicneutronium_nanoswarm")
        ...
        .itemInputs("8x gtceu:cosmicneutronium_block", "32x gtlcecore:optical_soc", "32x gtlcecore:exotic_wafer", "16x gtlcecore:cosmic_ram_wafer", "8x gtlcecore:cosmic_processing_unit_core")
    ...
    gtr.nano_forge("gtceu:white_dwarf_mtter_nanoswarm")
        ...
        .itemInputs("8x gtceu:white_dwarf_mtter_block", "8x gtlcecore:cosmic_processing_unit_core")
    ...
    gtr.nano_forge("gtceu:black_dwarf_mtter_nanoswarm")
        .notConsumable("gtceu:ruby_lens")
        .itemInputs("8x gtceu:black_dwarf_mtter_block", "8x gtlcecore:cosmic_processing_unit_core")
    ...
    gtr.nano_forge("gtceu:spacetime_nanoswarm")
        ...
        .notConsumable("gtlcecore:quantum_anomaly")
        .itemInputs("8x gtceu:spacetime_block", "4x gtlcecore:eigenfolded_kerr_manifold", "16x gtlcecore:supracausal_ram_wafer", "8x gtlcecore:supracausal_processing_core")
    ...
    gtr.nano_forge("gtceu:transcendentmetal_nanoswarm")
        .notConsumable("gtlcecore:non_linear_optical_lens")
        .notConsumable("gtlcecore:hypercube")
        .itemInputs("gtceu:rhenium_nanoswarm", "8x gtceu:transcendentmetal_block", "8x gtlcecore:recursively_folded_negative_space", "#gtceu:circuits/max")
    ...
    gtr.nano_forge("gtceu:eternity_nanoswarm")
        ...
        .notConsumable("gtlcecore:quantum_anomaly")
        .notConsumable("gtlcecore:eternity_catalyst")
        .itemInputs("gtceu:neutronium_nanoswarm", "8x gtceu:eternity_block", "8x gtlcecore:ctc_computational_unit")
    ...
    gtr.assembler("gtlcecore:chemical_distort")
        .itemInputs("gtlcecore:chemical_plant", "16x gtceu:carbon_nanoswarm", "8x gtceu:uv_electric_pump", "8x gtceu:uv_emitter", "8x #gtceu:circuits/uv", "8x gtceu:naquadria_plate")
        .inputFluids("gtceu:soldering_alloy 1296")
        .itemOutputs("gtlcecore:chemical_distort")
        .EUt(524288)
        .duration(400)
    ...
    gtr.distort("gtceu:stem_cells")
        .notConsumable("gtceu:naquadah_nanoswarm")
        .chancedInput("gtlcecore:glacio_spirit", 8000, 100)
    ...
    gtr.distort("gtceu:hexanitrohexaaxaisowurtzitane_dust")
        .notConsumable("gtceu:orichalcum_nanoswarm")
        .notConsumable("16x gtlcecore:unstable_star")
    ...
    gtr.distort("gtlcecore:biological_cells")
        .notConsumable("gtceu:neutronium_nanoswarm")
        .itemInputs("256x gtceu:stem_cells", "64x gtceu:meat_dust", "64x gtceu:salt_dust", "64x gtceu:calcium_dust", "64x gtceu:agar_dust", "4x gtlcecore:tcetieseaweedextract", "2x gtceu:enriched_naquadah_dust", "gtceu:tritanium_dust")
    ...
    gtr.qft("gtlcecore:timepiece")
        .notConsumable("gtceu:white_dwarf_mtter_nanoswarm")
        .notConsumable("gtceu:black_dwarf_mtter_nanoswarm")
        .chancedInput("gtceu:spacetime_hex_wire", 1, 0)
        .chancedOutput("gtlcecore:timepiece", 2500, 0)
    ...
    gtr.stellar_forge("gtceu:astraltitanium_plasma")
        .itemInputs("gtlcecore:naquadria_charge")
    ...
    gtr.arc_furnace("gtlcecore:cosmic_singularity")
        .itemInputs("avaritia:eternal_singularity")
        .inputFluids("gtceu:magnetohydrodynamicallyconstrainedstarmatter 9216")
        .itemOutputs("gtlcecore:cosmic_singularity", "64x gtceu:shirabon_dust")
    ...
    gtr.qft("gtceu:cosmic_ingot")
        .notConsumable("gtceu:cosmicneutronium_nanoswarm")
        .chancedInput("gtlcecore:cosmic_singularity", 1000, 0)
        .itemInputs("gtlcecore:hypercube", "avaritia:infinity_ingot")
    ...
    gtr.assembly_line("gtlcecore:mega_extractor")
        ...
        .itemOutputs("gtlcecore:mega_extractor")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
    ...
    gtr.assembly_line("gtlcecore:mega_fluid_heater")
        ...
        .itemOutputs("gtlcecore:mega_fluid_heater")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(1600)
    ...
    gtr.assembly_line("gtlcecore:mega_canner")
        ...
        .itemOutputs("gtlcecore:mega_canner")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
    ...
    gtr.assembler("gtlcecore:inverter")
        ...
        .inputFluids("gtceu:soldering_alloy 144")
        .itemOutputs("gtlcecore:inverter")
        .EUt(120)
        .duration(200)

    tierss.forEach(i => {
        gtr.assembler("gtceu:" + i[0] + "_neutron_accelerator")
            .itemInputs("gtceu:" + i[0] + "_machine_hull", "gtlcecore:inverter", i[1] == 0 ? "2x gtceu:lead_rotor" : "2x gtceu:" + i[0] + "_electric_motor", "gtceu:double_beryllium_plate", "2x gtceu:polyvinyl_chloride_plate")
    ...
    gtr.assembler("gtlcecore:neutron_sensor")
        ...
        .itemOutputs("gtlcecore:neutron_sensor")
        .EUt(1920)
        .duration(200)

    gtr.assembler("gtlcecore:neutron_activator")
        .itemInputs("gtceu:iv_machine_hull", "4x gtlcecore:hui_circuit_1", "#gtceu:circuits/iv", "2x gtceu:data_stick", "gtceu:ev_sensor", "2x gtceu:ev_emitter", "gtceu:uranium_235_block", "gtceu:polonium_block", "2x gtceu:neutron_reflector")
        .inputFluids("gtceu:stainless_steel 1296")
        .itemOutputs("gtlcecore:neutron_activator")
        .EUt(7680)
        .duration(200)

    gtr.assembler("gtlcecore:speeding_pipe")
        ...
        .itemOutputs("gtlcecore:speeding_pipe")
        .inputFluids("gtceu:mar_m_200_steel 576")
        .EUt(1920)
        .duration(200)

    gtr.assembler("gtlcecore:process_machine_casing")
        ...
        .itemOutputs("gtlcecore:process_machine_casing")
        .EUt(7680)
        .duration(200)

    gtr.assembler("gtlcecore:disassembly")
        ...
        .itemOutputs("gtlcecore:disassembly")
        .EUt(7680)
        .duration(800)

    gtr.vacuum_freezer("gtceu:metastable_oganesson")
        .inputFluids("gtceu:hot_oganesson 1000", "gtlcecore:gelid_cryotheum 144")
    ...
    gtr.neutron_activator("gtlcecore:draconium_dust")
        ...
        .chancedOutput("gtlcecore:draconium_dust", 4000, 0)
        .addData("ev_min", 800)
        .addData("ev_max", 900)
        .addData("evt", 5760)
        .duration(800)

    gtr.assembly_line("gtlcecore:auto_configuration_maintenance_hatch")
        ...
        .itemOutputs("gtlcecore:auto_configuration_maintenance_hatch")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(800)
    ...
    gtr.assembler("gtlcecore:heat_exchanger")
        ...
        .itemOutputs("gtlcecore:heat_exchanger")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(400)

    gtr.assembler("gtlcecore:supercritical_turbine_casing")
        ...
        .itemOutputs("gtlcecore:supercritical_turbine_casing")
        .EUt(16)
        .duration(50)

    gtr.assembler("gtlcecore:supercritical_steam_turbine")
        ...
        .itemOutputs("gtlcecore:supercritical_steam_turbine")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(200)

    gtr.assembler("gtlcecore:supercritical_mega_steam_turbine")
        .itemInputs("8x gtlcecore:supercritical_steam_turbine", "8x #gtceu:circuits/uv", "8x gtceu:luv_electric_piston", "16x gtceu:luv_electric_pump", "8x gtceu:naquadah_turbine_blade", "8x gtceu:double_hsss_plate", "32x gtceu:double_mar_m_200_steel_plate")
        .itemOutputs("gtlcecore:supercritical_mega_steam_turbine")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(1200)

    gtr.extractor("gtceu:antimatter")
        .itemInputs("gtlcecore:pellet_antimatter")
        .outputFluids("gtceu:antimatter 1000")
        .duration(2000)
        .EUt(480)

    gtr.assembly_line("gtlcecore:element_copying")
        ...
        .itemOutputs("gtlcecore:element_copying")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:star_ultimate_material_forge_factory"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(2048))

    gtr.electric_blast_furnace("gtlcecore:giga_chad")
        ...
        .itemOutputs("gtlcecore:giga_chad")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(4000)
        .blastFurnaceTemp(36000)
    ...
    gtr.assembler("gtlcecore:fission_reactor_casing")
        .itemInputs("gtceu:vanadium_steel_frame", "6x gtceu:lead_plate", "6x gtceu:reactor_steel_plate")
        .itemOutputs("2x gtlcecore:fission_reactor_casing")
        .EUt(30)
        .duration(50)

    gtr.assembler("gtlcecore:cooler")
        .itemInputs("gtlcecore:fission_reactor_casing", "2x gtceu:annealed_copper_hex_wire", "8x gtceu:vanadium_steel_tiny_fluid_pipe", "4x gtceu:stainless_steel_plate")
        .inputFluids("gtceu:soldering_alloy 288")
        .itemOutputs("gtlcecore:cooler")
        .EUt(120)
        .duration(200)

    gtr.assembler("gtlcecore:fission_fuel_assembly")
        .itemInputs("gtceu:graphite_block", "4x gtceu:long_stainless_steel_rod", "4x gtceu:double_reactor_steel_plate")
        .inputFluids("gtceu:soldering_alloy 288")
        .itemOutputs("gtlcecore:fission_fuel_assembly")
        .EUt(120)
        .duration(200)

    gtr.assembler("gtlcecore:fission_reactor")
        ...
        .inputFluids("gtceu:soldering_alloy 288")
        .itemOutputs("gtlcecore:fission_reactor")
        .EUt(480)
        .duration(200)
    ...
    gtr.forming_press("gtlcecore:reactor_fuel_rod")
        .notConsumable("gtceu:cell_extruder_mold")
        .itemInputs("gtceu:magnetic_steel_ingot")
        .itemOutputs("gtlcecore:reactor_fuel_rod")
        .EUt(30)
        .duration(200)

    gtr.forming_press("gtlcecore:tungsten_carbide_reactor_fuel_rod")
        .notConsumable("gtceu:cell_extruder_mold")
        .itemInputs("gtceu:magnetic_neodymium_ingot", "gtceu:tungsten_carbide_ingot")
        .itemOutputs("gtlcecore:tungsten_carbide_reactor_fuel_rod")
        .EUt(120)
        .duration(200)

    gtr.canner("gtlcecore:reactor_uranium_simple")
        .itemInputs("gtlcecore:reactor_fuel_rod", "16x gtceu:uranium_dust")
        .inputFluids("gtceu:uranium_235 96")
        .itemOutputs("gtlcecore:reactor_uranium_simple")
        .EUt(1920)
        .duration(120)

    gtr.canner("gtlcecore:reactor_thorium_simple")
        .itemInputs("gtlcecore:reactor_fuel_rod", "12x gtceu:thorium_dust")
        .itemOutputs("gtlcecore:reactor_thorium_simple")
        .EUt(480)
        .duration(120)

    gtr.canner("gtlcecore:reactor_mox_simple")
        .itemInputs("gtlcecore:reactor_fuel_rod", "18x gtceu:uranium_dust")
        .inputFluids("gtceu:plutonium 432")
        .itemOutputs("gtlcecore:reactor_mox_simple")
        .EUt(7680)
        .duration(120)

    gtr.canner("gtlcecore:reactor_naquadah_simple")
        .itemInputs("gtlcecore:tungsten_carbide_reactor_fuel_rod", "4x gtceu:naquadah_dust")
        .inputFluids("gtceu:thorium 144")
        .itemOutputs("gtlcecore:reactor_naquadah_simple")
        .EUt(30720)
        .duration(120)

    function assemble_fuel(name, isnq) {
        let rod = isnq ? "4x gtceu:tungsten_carbide_rod" : "4x gtceu:steel_rod"
        gtr.assembler("gtlcecore:reactor_" + name + "_dual")
            .itemInputs("2x gtlcecore:reactor_" + name + "_simple", rod)
            .itemOutputs("gtlcecore:reactor_" + name + "_dual")
            .EUt(30)
            .duration(40)

        gtr.assembler("gtlcecore:reactor_" + name + "_quad")
            .itemInputs("2x gtlcecore:reactor_" + name + "_dual", rod)
            .itemOutputs("gtlcecore:reactor_" + name + "_quad")
            .EUt(30)
            .duration(80)
    }
    ...
    function centrifuge_fuel(name, isnq, product, output, chance, extra) {
        ...
        let fuel_rod = isnq ? "gtlcecore:tungsten_carbide_reactor_fuel_rod" : "gtlcecore:reactor_fuel_rod"
        gtr.centrifuge("gtlcecore:depleted_reactor_" + name + "_simple")
            .itemInputs("gtlcecore:depleted_reactor_" + name + "_simple")
            .itemOutputs(fuel_rod)
            .chancedOutput(output + "x " + product, chance, extra)
            .chancedOutput("2x gtlcecore:nuclear_waste", 1600, 500)
            .EUt(480)
            .duration(40)

        gtr.centrifuge("gtlcecore:depleted_reactor_" + name + "_dual")
            .itemInputs("gtlcecore:depleted_reactor_" + name + "_dual")
            .itemOutputs("2x " + fuel_rod, "4x " + rod)
            .chancedOutput(2 * output + "x " + product, chance, extra)
            .chancedOutput("4x gtlcecore:nuclear_waste", 3600, 500)
            .EUt(480)
            .duration(80)

        gtr.centrifuge("gtlcecore:depleted_reactor_" + name + "_quad")
            .itemInputs("gtlcecore:depleted_reactor_" + name + "_quad")
            .itemOutputs("4x " + fuel_rod, "12x " + rod)
            .chancedOutput(4 * output + "x " + product, chance, extra)
            .chancedOutput("8x gtlcecore:nuclear_waste", 8000, 500)
            .EUt(480)
            .duration(160)
    }
    ...
    centrifuge_fuel("mox", false, "gtlcecore:nuclear_waste", 8, 2000, 1000)
    centrifuge_fuel("naquadah", true, "gtceu:plutonium_dust", 2, 8000, 200)

    gtr.fission_reactor("gtlcecore:reactor_thorium_simple")
        .itemInputs("gtlcecore:reactor_thorium_simple")
        .itemOutputs("gtlcecore:depleted_reactor_thorium_simple")
        .EUt(6)
        .duration(134400)
        .addData("FRheat", 1)

    gtr.fission_reactor("gtlcecore:reactor_thorium_dual")
        .itemInputs("gtlcecore:reactor_thorium_dual")
        .itemOutputs("gtlcecore:depleted_reactor_thorium_dual")
        .EUt(8)
        .duration(172800)
        .addData("FRheat", 2)

    gtr.fission_reactor("gtlcecore:reactor_thorium_quad")
        .itemInputs("gtlcecore:reactor_thorium_quad")
        .itemOutputs("gtlcecore:depleted_reactor_thorium_quad")
        .EUt(10)
        .duration(216000)
        .addData("FRheat", 3)

    gtr.fission_reactor("gtlcecore:reactor_uranium_simple")
        .itemInputs("gtlcecore:reactor_uranium_simple")
        .itemOutputs("gtlcecore:depleted_reactor_uranium_simple")
        .EUt(3)
        .duration(112000)
        .addData("FRheat", 4)

    gtr.fission_reactor("gtlcecore:reactor_uranium_dual")
        .itemInputs("gtlcecore:reactor_uranium_dual")
        .itemOutputs("gtlcecore:depleted_reactor_uranium_dual")
        .EUt(4)
        .duration(144000)
        .addData("FRheat", 5)

    gtr.fission_reactor("gtlcecore:reactor_uranium_quad")
        .itemInputs("gtlcecore:reactor_uranium_quad")
        .itemOutputs("gtlcecore:depleted_reactor_uranium_quad")
        .EUt(5)
        .duration(180000)
        .addData("FRheat", 6)

    gtr.fission_reactor("gtlcecore:reactor_mox_simple")
        .itemInputs("gtlcecore:reactor_mox_simple")
        .itemOutputs("gtlcecore:depleted_reactor_mox_simple")
        .EUt(1)
        .duration(78400)
        .addData("FRheat", 6)

    gtr.fission_reactor("gtlcecore:reactor_mox_dual")
        .itemInputs("gtlcecore:reactor_mox_dual")
        .itemOutputs("gtlcecore:depleted_reactor_mox_dual")
        .EUt(2)
        .duration(100800)
        .addData("FRheat", 7)

    gtr.fission_reactor("gtlcecore:reactor_mox_quad")
        .itemInputs("gtlcecore:reactor_mox_quad")
        .itemOutputs("gtlcecore:depleted_reactor_mox_quad")
        .EUt(3)
        .duration(128000)
        .addData("FRheat", 8)

    gtr.fission_reactor("gtlcecore:reactor_naquadah_simple")
        .itemInputs("gtlcecore:reactor_naquadah_simple")
        .itemOutputs("gtlcecore:depleted_reactor_naquadah_simple")
        .EUt(3)
        .duration(160000)
        .addData("FRheat", 7)

    gtr.fission_reactor("gtlcecore:reactor_naquadah_dual")
        .itemInputs("gtlcecore:reactor_naquadah_dual")
        .itemOutputs("gtlcecore:depleted_reactor_naquadah_dual")
        .EUt(5)
        .duration(240000)
        .addData("FRheat", 8)

    gtr.fission_reactor("gtlcecore:reactor_naquadah_quad")
        .itemInputs("gtlcecore:reactor_naquadah_quad")
        .itemOutputs("gtlcecore:depleted_reactor_naquadah_quad")
        .EUt(7)
        .duration(360000)
        .addData("FRheat", 9)
    ...
    gtr.assembler("gtmthings:ulv_huge_item_import_bus")
        .inputFluids("gtceu:soldering_alloy 144")
        .itemInputs("gtceu:ulv_input_bus", "gtlcecore:primitive_robot_arm", "gtceu:bronze_crate", "4x #gtceu:circuits/ulv", "4x gtceu:wrought_iron_plate")
    ...
    gtr.assembler("gtmthings:ulv_huge_item_export_bus")
        .inputFluids("gtceu:soldering_alloy 144")
        .itemInputs("gtceu:ulv_output_bus", "gtlcecore:primitive_robot_arm", "gtceu:bronze_crate", "4x #gtceu:circuits/ulv", "4x gtceu:wrought_iron_plate")
    ...
    gtr.atomic_energy_excitation("gtceu:concentration_mixing_hyper_fuel_1")
        .notConsumable("gtceu:white_dwarf_mtter_nanoswarm")
        .itemInputs("4x gtlcecore:resonating_gem", "16x gtceu:hassium_dust")
    ...
    gtr.atomic_energy_excitation("gtceu:concentration_mixing_hyper_fuel_2")
        .notConsumable("gtceu:black_dwarf_mtter_nanoswarm")
        .itemInputs("16x gtlcecore:draconium_dust", "18x gtceu:starmetal_dust")
    ...
    gtr.assembler("gtlcecore:advanced_integrated_ore_processor")
        .itemInputs("16x gtlcecore:integrated_ore_processor", "64x gtceu:crushing_wheels", "32x #gtceu:circuits/uiv", "16x gtceu:uiv_robot_arm", "32x gtceu:uiv_conveyor_module", "8x gtceu:uiv_electric_pump", "8x gtceu:uiv_emitter", "64x gtceu:double_dalisenite_plate", "64x gtceu:double_dalisenite_plate")
        .inputFluids("gtceu:inconel_792 82944")
        .itemOutputs("gtlcecore:advanced_integrated_ore_processor")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(800)
    ...
    gtr.assembler("gtlcecore:advanced_stellar_containment_casing")
        .itemInputs("gtlcecore:stellar_containment_casing", "gtceu:uhv_field_generator", "8x gtceu:vibranium_screw", "gtceu:enderite_octal_wire", "4x gtceu:taranium_plate")
        .itemOutputs("gtlcecore:advanced_stellar_containment_casing")
        .inputFluids("gtceu:astraltitanium 144")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(280)

    gtr.assembler("gtlcecore:ultimate_stellar_containment_casing")
        .itemInputs("gtlcecore:advanced_stellar_containment_casing", "gtceu:uev_field_generator", "8x gtceu:vibramantium_screw", "gtceu:legendarium_quadruple_wire", "8x gtceu:heavy_quark_degenerate_matter_plate")
        .itemOutputs("gtlcecore:ultimate_stellar_containment_casing")
        .inputFluids("gtceu:celestialtungsten 144")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(460)

    //Component Assembly Line Casing
    gtr.assembler("gtlcecore:component_assembly_line_casing_lv")
        ...
        .inputFluids("gtceu:soldering_alloy 288")
        .itemOutputs("gtlcecore:component_assembly_line_casing_lv")
        .EUt(GTValues.VA[GTValues.LV])
        .duration(320)

    gtr.assembler("gtlcecore:component_assembly_line_casing_mv")
        ...
        .inputFluids("gtceu:soldering_alloy 432")
        .itemOutputs("gtlcecore:component_assembly_line_casing_mv")
        .EUt(GTValues.VA[GTValues.MV])
        .duration(320)

    gtr.assembler("gtlcecore:component_assembly_line_casing_hv")
        ...
        .inputFluids("gtceu:soldering_alloy 576")
        .itemOutputs("gtlcecore:component_assembly_line_casing_hv")
        .EUt(GTValues.VA[GTValues.HV])
        .duration(320)

    gtr.assembler("gtlcecore:component_assembly_line_casing_ev")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_ev")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(320)

    gtr.assembler("gtlcecore:component_assembly_line_casing_iv")
        ...
        .inputFluids("gtceu:soldering_alloy 864")
        .itemOutputs("gtlcecore:component_assembly_line_casing_iv")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(320)

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_luv")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_luv")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_iv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.LuV])
            .CWUt(128))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_zpm")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_zpm")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_luv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.ZPM])
            .CWUt(192))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_uv")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_uv")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_zpm"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UV])
            .CWUt(256))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_uhv")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_uhv")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_uv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(384))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_uev")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_uev")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_uhv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(512))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_uiv")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_uiv")
        .EUt(GTValues.VA[GTValues.UIV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_uev"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UIV])
            .CWUt(1024))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_uxv")
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_uxv")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_uiv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UXV])
            .CWUt(2048))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_opv")
        .itemInputs("gtceu:infinity_frame",
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_opv")
        .EUt(GTValues.VA[GTValues.OpV])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_uxv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.OpV])
            .CWUt(8192))

    gtr.assembly_line("gtlcecore:component_assembly_line_casing_max")
        .itemInputs("gtceu:eternity_frame",
            "24x gtceu:double_transcendentmetal_plate",
            "4x gtlcecore:max_field_generator",
            "6x gtlcecore:max_electric_pump",
            "8x gtlcecore:max_robot_arm",
            "10x gtlcecore:max_sensor",
            "16x gtlcecore:max_conveyor_module",
        ...
        .itemOutputs("gtlcecore:component_assembly_line_casing_max")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(600)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_opv"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.MAX])
            .CWUt(16384))

    gtr.assembler("gtlcecore:hsss_reinforced_borosilicate_glass")
        .itemInputs("4x gtceu:laminated_glass", "4x gtceu:double_hsss_plate", "32x gtceu:fine_borosilicate_glass_wire")
        .itemOutputs("2x gtlcecore:hsss_reinforced_borosilicate_glass")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(600)

    gtr.assembly_line("gtlcecore:component_assembly_line")
        .itemInputs("16x gtlcecore:advanced_assembly_line",
            "16x gtceu:assembly_line_casing",
            "32x gtlcecore:advanced_assembly_line_unit",
        ...
        .itemOutputs("gtlcecore:component_assembly_line")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(4200)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:component_assembly_line_casing_ev"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UHV])
            .CWUt(512))
    ...
    gtr.component_assembly_line("gtceu:uhv_electric_motor")
        .circuit(1)
        .itemInputs("48x gtlcecore:magnetic_long_netherite_rod", "6x gtceu:europium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uev_electric_motor")
        .circuit(1)
        .itemInputs("48x gtlcecore:magnetic_long_netherite_rod", "6x gtceu:mithril_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uiv_field_generator")
        .itemInputs("144x gtceu:double_adamantium_plate", "96x #gtceu:circuits/uiv", "96x gtceu:uiv_emitter", "48x gtlcecore:unstable_star", "48x gtceu:adamantium_frame", "12x gtceu:neutronium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uiv_emitter")
        .circuit(6)
        .itemInputs("96x #gtceu:circuits/uiv", "48x gtceu:uiv_electric_motor", "48x gtlcecore:unstable_star", "48x gtceu:adamantium_frame", "12x gtceu:neutronium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uiv_sensor")
        .circuit(7)
        .itemInputs("96x #gtceu:circuits/uiv", "96x gtceu:double_infuscolium_plate", "48x gtceu:uiv_electric_motor", "48x gtlcecore:unstable_star", "48x gtceu:adamantium_frame", "12x gtceu:neutronium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uxv_field_generator")
        .itemInputs("144x gtceu:double_vibranium_plate", "96x #gtceu:circuits/uxv", "96x gtceu:uxv_emitter", "96x gtlcecore:unstable_star", "48x gtceu:vibranium_frame", "12x gtceu:taranium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uxv_emitter")
        .circuit(6)
        .itemInputs("96x #gtceu:circuits/uxv", "48x gtceu:uxv_electric_motor", "96x gtlcecore:unstable_star", "48x gtceu:vibranium_frame", "12x gtceu:taranium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:uxv_sensor")
        .circuit(7)
        .itemInputs("96x #gtceu:circuits/uxv", "96x gtceu:double_hastelloyk_243_plate", "48x gtceu:uxv_electric_motor", "96x gtlcecore:unstable_star", "48x gtceu:vibranium_frame", "12x gtceu:taranium_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:opv_field_generator")
        .itemInputs("144x gtceu:double_draconium_plate", "96x #gtceu:circuits/opv", "96x gtceu:opv_emitter", "192x gtlcecore:unstable_star", "48x gtceu:draconium_frame", "12x gtceu:crystalmatrix_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:opv_emitter")
        .circuit(6)
        .itemInputs("96x #gtceu:circuits/opv", "48x gtceu:opv_electric_motor", "192x gtlcecore:unstable_star", "48x gtceu:draconium_frame", "12x gtceu:crystalmatrix_hex_cable")
    ...
    gtr.component_assembly_line("gtceu:opv_sensor")
        .circuit(7)
        .itemInputs("96x #gtceu:circuits/opv", "96x gtceu:double_vibramantium_plate", "48x gtceu:opv_electric_motor", "192x gtlcecore:unstable_star", "48x gtceu:draconium_frame", "12x gtceu:crystalmatrix_hex_cable")
    ...
    gtr.component_assembly_line("gtlcecore:max_electric_motor")
        .circuit(1)
        ...
        .itemOutputs("64x gtlcecore:max_electric_motor")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_electric_pump")
        .circuit(3)
        .itemInputs("96x gtceu:double_transcendentmetal_plate", "48x gtlcecore:max_electric_motor", "48x gtceu:cosmicneutronium_hex_cable")
        ...
        .itemOutputs("64x gtlcecore:max_electric_pump")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_conveyor_module")
        .circuit(5)
        .itemInputs("96x gtlcecore:max_electric_motor", "96x gtceu:double_transcendentmetal_plate", "48x gtceu:cosmicneutronium_hex_cable")
        ...
        .itemOutputs("64x gtlcecore:max_conveyor_module")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_electric_piston")
        .circuit(2)
        .itemInputs("48x gtlcecore:max_electric_motor", "192x gtceu:double_transcendentmetal_plate", "48x gtceu:cosmicneutronium_hex_cable")
        ...
        .itemOutputs("64x gtlcecore:max_electric_piston")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_robot_arm")
        .circuit(4)
        .itemInputs("192x #gtceu:circuits/uxv", "96x #gtceu:circuits/opv", "192x gtlcecore:max_electric_motor", "48x gtlcecore:max_electric_piston", "48x #gtceu:circuits/amx", "96x gtceu:cosmicneutronium_hex_cable")
        ...
        .itemOutputs("64x gtlcecore:max_robot_arm")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_field_generator")
        .itemInputs("288x gtceu:double_chaos_plate", "96x #gtceu:circuits/max", "96x gtlcecore:max_emitter", "192x gtlcecore:nuclear_star", "48x gtceu:infinity_frame", "3072x gtceu:fine_cosmic_wire", "96x gtceu:cosmicneutronium_hex_cable")
        ...
        .itemOutputs("64x gtlcecore:max_field_generator")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_emitter")
        .circuit(6)
        .itemInputs("96x #gtceu:circuits/max", "48x gtlcecore:max_electric_motor", "192x gtlcecore:nuclear_star", "48x gtceu:infinity_frame", "3072x gtceu:cosmic_foil", "96x gtceu:cosmicneutronium_hex_cable")
        ...
        .itemOutputs("64x gtlcecore:max_emitter")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)

    gtr.component_assembly_line("gtlcecore:max_sensor")
        .circuit(7)
        .itemInputs("96x #gtceu:circuits/max", "192x gtceu:transcendentmetal_plate", "48x gtlcecore:max_electric_motor", "192x gtlcecore:nuclear_star", "48x gtceu:infinity_frame", "96x gtceu:cosmicneutronium_hex_cable")
        .inputFluids("gtceu:super_mutated_living_solder 1769472", "gtceu:soldering_alloy 3538944", "gtceu:black_dwarf_mtter 110592", "gtceu:white_dwarf_mtter 110592", "gtceu:shirabon 110592", "gtceu:infinity 27648")
        .itemOutputs("64x gtlcecore:max_sensor")
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(1200)
        .addData("CATier", 14)
    ...
    gtr.assembly_line("gtlcecore:isa_mill")
        .itemInputs("gtceu:luv_machine_hull",
            "2x gtlcecore:inconel_625_gearbox",
        ...
        .itemOutputs("gtlcecore:isa_mill")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(2400)
    ...
    gtr.assembly_line("gtlcecore:flotation_cell_regulator")
        .itemInputs("gtceu:luv_machine_hull",
            "2x gtlcecore:flotation_cell",
        ...
        .itemOutputs("gtlcecore:flotation_cell_regulator")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(2400)
    ...
    gtr.assembler("gtlcecore:inconel_625_casing")
        ...
        .itemOutputs("2x gtlcecore:inconel_625_casing")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(480)

    gtr.assembler("gtlcecore:inconel_625_pipe")
        ...
        .itemOutputs("2x gtlcecore:inconel_625_pipe")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(480)

    gtr.assembler("gtlcecore:inconel_625_gearbox")
        ...
        .itemOutputs("2x gtlcecore:inconel_625_gearbox")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(600)

    gtr.assembler("gtlcecore:hastelloy_n_75_casing")
        ...
        .itemOutputs("2x gtlcecore:hastelloy_n_75_casing")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(500)

    gtr.assembler("gtlcecore:hastelloy_n_75_gearbox")
        ...
        .itemOutputs("2x gtlcecore:hastelloy_n_75_gearbox")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(280)

    gtr.assembler("gtlcecore:hastelloy_n_75_pipe")
        .itemInputs("gtceu:watertight_steel_frame", "6x gtceu:double_hastelloy_n_75_plate", "4x gtceu:tungsten_steel_small_fluid_pipe")
        .inputFluids("gtceu:soldering_alloy 1152")
        .itemOutputs("2x gtlcecore:hastelloy_n_75_pipe")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(480)

    gtr.assembler("gtlcecore:flotation_cell")
        .itemInputs("7x gtceu:hastelloy_n_75_plate", "gtceu:assembly_line_grating", "gtceu:iv_electric_pump")
        .itemOutputs("gtlcecore:flotation_cell")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(400)

    gtr.assembler("gtlcecore:red_steel_casing")
        .circuit(6)
        .itemInputs("gtceu:hsla_steel_frame", "2x gtceu:titanium_carbide_plate", "4x gtceu:double_red_steel_plate")
        .itemOutputs("2x gtlcecore:red_steel_casing")
        .EUt(GTValues.VA[GTValues.HV])
        .duration(600)

    gtr.assembler("gtlcecore:vacuum_drying_furnace")
        .itemInputs("gtceu:hsse_frame", "4x gtlcecore:iv_dehydrator", "2x gtceu:double_titanium_tungsten_carbide_plate", "4x #gtceu:circuits/iv", "2x gtceu:iv_electric_piston", "3x gtceu:iridium_gear", "6x gtceu:small_titanium_gear", "24x gtceu:tantalloy_61_screw")
        .inputFluids("gtceu:platinum 1152")
        .itemOutputs("gtlcecore:vacuum_drying_furnace")
        .EUt(GTValues.VA[GTValues.HV])
        .duration(600)

    gtr.forming_press("gtlcecore:grindball_soapstone")
        .notConsumable("gtceu:ball_casting_mold")
        .itemInputs("16x gtceu:soapstone_dust", "2x gtceu:soldering_alloy_ingot")
        .itemOutputs("gtlcecore:grindball_soapstone")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(800)

    gtr.forming_press("gtlcecore:grindball_aluminium")
        .notConsumable("gtceu:ball_casting_mold")
        .itemInputs("16x gtceu:aluminium_dust", "2x gtceu:soldering_alloy_ingot")
        .itemOutputs("gtlcecore:grindball_aluminium")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(800)
    ...
    gtr.extruder("gtlcecore:special_ceramics")
        .itemInputs("2x gtceu:special_ceramics_dust")
        .notConsumable("gtceu:plate_extruder_mold")
        .itemOutputs("gtlcecore:special_ceramics")
        .EUt(GTValues.VA[GTValues.HV])
        .duration(20)

    gtr.circuit_assembler("gtlcecore:hui_circuit_1")
        ...
        .itemOutputs("gtlcecore:hui_circuit_1")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(320)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:hui_circuit_2")
        .itemInputs("gtlcecore:hui_circuit_1", "8x gtceu:blue_topaz_plate", "16x gtceu:nand_memory_chip", "8x gtceu:platinum_single_wire")
        .inputFluids("gtceu:polyethylene 288", "gtceu:vanadium 288", "gtceu:bronze 144", "gtceu:annealed_copper 144")
        .itemOutputs("gtlcecore:hui_circuit_2")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:hui_circuit_3")
        .itemInputs("gtlcecore:hui_circuit_2", "8x gtceu:sodalite_plate", "gtceu:raw_crystal_chip", "8x gtceu:niobium_titanium_single_wire")
        .inputFluids("gtceu:polyvinyl_chloride 288", "gtceu:yttrium 288", "gtceu:black_steel 144", "gtceu:eglin_steel 144")
        .itemOutputs("gtlcecore:hui_circuit_3")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:hui_circuit_4")
        .itemInputs("gtlcecore:hui_circuit_3", "8x gtceu:red_garnet_plate", "16x gtceu:qbit_cpu_chip", "8x gtceu:vanadium_gallium_single_wire")
        .inputFluids("gtceu:polytetrafluoroethylene 288", "gtceu:lutetium 288", "gtceu:tantalloy_61 144", "gtceu:hastelloy_n 144")
        .itemOutputs("gtlcecore:hui_circuit_4")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:hui_circuit_5")
        .itemInputs("gtlcecore:hui_circuit_4", "8x gtceu:opal_plate", "gtceu:neuro_processing_unit", "8x gtceu:yttrium_barium_cuprate_single_wire")
        .inputFluids("gtceu:polybenzimidazole 288", "gtceu:cerium 288", "gtceu:indalloy_140 144", "gtceu:lafium 144")
        .itemOutputs("gtlcecore:hui_circuit_5")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:improved_superconductor_coil")
        .itemInputs("gtceu:superconducting_coil", "2x gtlcecore:special_ceramics", "gtlcecore:hui_circuit_1")
        .inputFluids("gtceu:mar_m_200_steel 1152", "gtceu:europium 144")
        .itemOutputs("gtlcecore:improved_superconductor_coil")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:compressed_fusion_coil")
        .itemInputs("gtceu:fusion_coil", "gtlcecore:inverter", "gtlcecore:hui_circuit_2")
        .inputFluids("gtceu:tanmolyium 1152", "gtceu:americium 144")
        .itemOutputs("gtlcecore:compressed_fusion_coil")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:advanced_compressed_fusion_coil")
        .itemInputs("gtlcecore:compressed_fusion_coil", "gtceu:quantum_star", "gtlcecore:hui_circuit_3")
        .inputFluids("gtceu:artherium_sn 1152", "gtceu:mithril 144")
        .itemOutputs("gtlcecore:advanced_compressed_fusion_coil")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:compressed_fusion_coil_mk2_prototype")
        .itemInputs("gtlcecore:advanced_fusion_coil", "gtceu:gravi_star", "gtlcecore:hui_circuit_4")
        .inputFluids("gtceu:dalisenite 1152", "gtceu:bohrium 144")
        .itemOutputs("gtlcecore:compressed_fusion_coil_mk2_prototype")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:compressed_fusion_coil_mk2")
        .itemInputs("gtlcecore:fusion_coil_mk2", "gtlcecore:unstable_star", "gtlcecore:hui_circuit_5")
        .inputFluids("gtceu:cinobite 1152", "gtceu:vibranium 144")
        .itemOutputs("gtlcecore:compressed_fusion_coil_mk2")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:luv_compressed_fusion_reactor")
        .itemInputs("gtceu:luv_fusion_reactor", "gtlcecore:improved_superconductor_coil", "16x gtlcecore:hui_circuit_1", "16x gtceu:double_osmiridium_plate")
        .inputFluids("gtceu:niobium_titanium 864", "gtceu:indalloy_140 1152", "gtceu:soldering_alloy 2304", "gtceu:polybenzimidazole 2304")
        .itemOutputs("gtlcecore:luv_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:zpm_compressed_fusion_reactor")
        .itemInputs("gtceu:zpm_fusion_reactor", "gtlcecore:compressed_fusion_coil", "16x gtlcecore:hui_circuit_2", "16x gtceu:double_europium_plate")
        .inputFluids("gtceu:vanadium_gallium 864", "gtceu:indalloy_140 1152", "gtceu:soldering_alloy 2304", "gtceu:polybenzimidazole 2304")
        .itemOutputs("gtlcecore:zpm_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:uv_compressed_fusion_reactor")
        .itemInputs("gtceu:uv_fusion_reactor", "gtlcecore:advanced_compressed_fusion_coil", "16x gtlcecore:hui_circuit_3", "16x gtceu:double_americium_plate")
        ...
        .itemOutputs("gtlcecore:uv_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:uhv_compressed_fusion_reactor")
        .itemInputs("gtlcecore:uhv_fusion_reactor", "gtlcecore:compressed_fusion_coil_mk2_prototype", "16x gtlcecore:hui_circuit_4", "16x gtceu:double_orichalcum_plate")
        .inputFluids("gtceu:europium 864", "gtceu:indalloy_140 1152", "gtceu:soldering_alloy 2304", "gtceu:polybenzimidazole 2304")
        .itemOutputs("gtlcecore:uhv_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtlcecore:uev_compressed_fusion_reactor")
        .itemInputs("gtlcecore:uev_fusion_reactor", "gtlcecore:compressed_fusion_coil_mk2", "16x gtlcecore:hui_circuit_5", "16x gtceu:double_seaborgium_plate")
        .inputFluids("gtceu:mithril 864", "gtceu:indalloy_140 1152", "gtceu:soldering_alloy 2304", "gtceu:polybenzimidazole 2304")
        .itemOutputs("gtlcecore:uev_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:advanced_fusion_coil")
        .itemInputs("gtlcecore:improved_superconductor_coil", "2x gtceu:luv_field_generator", "gtceu:iv_electric_pump", "4x gtceu:neutron_reflector", "gtlcecore:hui_circuit_2", "4x #gtceu:circuits/luv", "gtceu:naquadah_normal_fluid_pipe", "4x gtceu:duranium_plate")
        .inputFluids("gtceu:yttrium_barium_cuprate 576")
        .itemOutputs("gtlcecore:advanced_fusion_coil")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:fusion_coil_mk2")
        .itemInputs("gtlcecore:compressed_fusion_coil_mk2_prototype", "2x gtceu:zpm_field_generator", "gtceu:luv_electric_pump", "4x gtceu:neutron_reflector", "gtlcecore:hui_circuit_3", "4x #gtceu:circuits/zpm", "gtceu:naquadah_large_fluid_pipe", "4x gtceu:dubnium_plate")
        .inputFluids("gtceu:yttrium_barium_cuprate 576")
        .itemOutputs("gtlcecore:fusion_coil_mk2")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:fusion_casing_mk4")
        .itemInputs("gtceu:uhv_machine_casing", "gtlcecore:advanced_fusion_coil", "2x gtlcecore:uhv_voltage_coil", "2x gtlcecore:hui_circuit_4", "gtceu:uv_field_generator", "6x gtceu:orichalcum_plate")
        .inputFluids("gtceu:polybenzimidazole 1152")
        .itemOutputs("2x gtlcecore:fusion_casing_mk4")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembler("gtlcecore:fusion_casing_mk5")
        .itemInputs("gtceu:uev_machine_casing", "gtlcecore:fusion_coil_mk2", "2x gtlcecore:uev_voltage_coil", "2x gtlcecore:hui_circuit_5", "gtceu:uhv_field_generator", "6x gtceu:seaborgium_plate")
        .inputFluids("gtceu:polybenzimidazole 2304")
        .itemOutputs("2x gtlcecore:fusion_casing_mk5")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(100)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.assembly_line("gtlcecore:uhv_fusion_reactor")
        .itemInputs("gtlcecore:advanced_fusion_coil", "4x #gtceu:circuits/uev", "gtceu:gravi_star", "gtceu:double_orichalcum_plate", "2x gtceu:uv_field_generator", "64x gtlcecore:nm_chip", "32x gtceu:ruthenium_trinium_americium_neutronate_single_wire")
        .inputFluids("gtceu:soldering_alloy 1152", "gtceu:europium 1152")
        .itemOutputs("gtlcecore:uhv_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(1000)
    ...
    gtr.assembly_line("gtlcecore:uev_fusion_reactor")
        .itemInputs("gtlcecore:fusion_coil_mk2", "4x #gtceu:circuits/uiv", "gtlcecore:unstable_star", "gtceu:double_seaborgium_plate", "2x gtceu:uhv_field_generator", "64x gtlcecore:nm_chip", "64x gtlcecore:nm_chip", "32x gtceu:enderite_single_wire")
        .inputFluids("gtceu:soldering_alloy 1152", "gtceu:mithril 1152")
        .itemOutputs("gtlcecore:uev_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(1000)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:uhv_fusion_reactor"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.UEV])
            .CWUt(600))

    gtr.assembly_line("gtlcecore:mega_distillery")
        .itemInputs("16x gtceu:distillation_tower", "8x gtceu:tungsten_steel_huge_fluid_pipe", "16x gtceu:uhv_electric_pump", "4x gtceu:uev_sensor", "4x #gtceu:circuits/uiv", "32x gtceu:annealed_copper_hex_wire", "32x gtceu:watertight_steel_plate")
        .inputFluids("gtceu:soldering_alloy 1152", "gtceu:indalloy_140 1152", "gtceu:stainless_steel 2304", "gtceu:polyvinyl_chloride 2880")
        .itemOutputs("gtlcecore:mega_distillery")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(800)
    ...
    gtr.assembly_line("gtlcecore:nano_core")
        .itemInputs("16x gtlcecore:opv_buffer", "16x gtceu:cosmicneutronium_nanoswarm", "16x gtlcecore:suprachronal_assembly_line", "8x gtlcecore:component_assembly_line_casing_opv", "32x #gtceu:circuits/opv", "16x gtceu:cosmicneutronium_plate")
        ...
        .itemOutputs("gtlcecore:nano_core")
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(800)
        .stationResearch(b => b.researchStack(Registries.getItemStack("gtlcecore:nano_forge_3"))
            .dataStack(Registries.getItemStack("gtceu:data_module"))
            .EUt(GTValues.VA[GTValues.OpV])
            .CWUt(1200))
    ...
    gtr.mixer("gtceu:actinium_trinium_hydroxides_dust")
        .itemInputs("58x gtceu:actinium_trinium_hydroxides_dust", "6x gtceu:radium_dust", "1x gtlcecore:protonated_fullerene_sieving_matrix")
        .inputFluids("minecraft:water 2000")
        .itemOutputs("1x gtlcecore:saturated_fullerene_sieving_matrix")
    ...
    gtr.chemical_reactor("gtlcecore:saturated_fullerene_sieving_matrix")
        .itemInputs("1x gtlcecore:saturated_fullerene_sieving_matrix")
    ...
    gtr.assembler("gtlcecore:protonated_fullerene_sieving_matrix")
        ...
        .itemOutputs("1x gtlcecore:protonated_fullerene_sieving_matrix")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(350)
    ...
    gtr.compressor("gtlcecore:diamond_compressed_block")
        .itemInputs("8x minecraft:diamond_block")
        .itemOutputs("gtlcecore:diamond_compressed_block")
        .EUt(GTValues.VA[GTValues.HV])
        .duration(300)
    ...
    gtr.assembler("gtlcecore:digestion_tank")
        ...
        .itemOutputs("gtlcecore:digestion_tank")
        .EUt(120)
        .duration(400)

    gtr.assembler("gtlcecore:dissolving_tank")
        ...
        .itemOutputs("gtlcecore:dissolving_tank")
        .EUt(120)
        .duration(400)

...
ServerEvents.recipes((event) => {
    ...
    gtr.lightning_processor("minecraft:reinforced_deepslate")
        .itemInputs("minecraft:deepslate", "gtceu:echo_shard_block", "4x gtlcecore:echobone")
        .inputFluids("gtceu:echo_shard 1440")
        .itemOutputs("minecraft:reinforced_deepslate")
        .duration(200)
        .EUt(480)

    gtr.lightning_processor("gtlcecore:echobone")
        .itemInputs("minecraft:bone")
        .inputFluids("gtceu:echo_shard 144")
        .itemOutputs("gtlcecore:echobone")
        .EUt(480)
        .duration(400)
    ...
    gtr.lightning_processor("minecraft:dragon_egg")
        .itemInputs("minecraft:egg", "64x gtlcecore:warped_ender_pearl")

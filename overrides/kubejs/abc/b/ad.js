ServerEvents.recipes(event => {
    ...
    gtr.assembler("ad_astra:rocket_nose_cone")
        .itemInputs("gtceu:stainless_steel_frame", "minecraft:lightning_rod", "gtlcecore:ultimate_control_circuit", "gtceu:exquisite_glass_gem", "gtceu:computer_monitor_cover", "2x gtceu:double_aluminium_plate")

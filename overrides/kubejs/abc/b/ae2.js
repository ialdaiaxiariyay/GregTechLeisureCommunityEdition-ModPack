...
ServerEvents.recipes((event) => {
    ...
    gtr.forming_press("gtlcecore:fishbig_fabric")
        .itemInputs("64x gtceu:magnetohydrodynamicallyconstrainedstarmatter_foil", "64x gtceu:shirabon_foil", "64x gtlcecore:two_way_foil", "64x gtceu:cosmic_foil", "64x gtceu:cosmicneutronium_foil", "64x gtceu:eternity_foil")
        .itemOutputs("gtlcecore:fishbig_fabric")
        .duration(200)
        .EUt(GTValues.VA[GTValues.MAX] * 65536)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)

    gtr.assembler("gtlcecore:fishbig_frame")
        .circuit(6)
        ...
        .itemOutputs("gtlcecore:fishbig_frame")
        .duration(200)
        .EUt(GTValues.VA[GTValues.MAX] * 65536)
        .cleanroom(GTLCleanroomType.LAW_CLEANROOM)
